...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(point) => "Je beschikbare punten: ${point}";

  static String m3(state) => "Bluetooth-adapter is ${state}";

  static String m4(author) => "Door: ${author}";

  static String m5(fieldName) => "${fieldName} mag niet leeg zijn.";

  static String m6(fieldName) =>
      "${fieldName} mag niet korter zijn dan 3 tekens.";

  static String m7(currency) => "Valuta gewijzigd naar ${currency}";

  static String m8(number) => "${number} tekens resterend";
  ...
  static String m13(count) => "${count} artikelen";

  static String m14(country) => "${country} wordt niet ondersteund";

  static String m15(currency) => "${currency} wordt niet ondersteund";

  static String m16(day) => "${day} dagen geleden";

  static String m17(total) => "~${total} km";

  static String m18(timeLeft) => "Eindigt over ${timeLeft}";

  static String m19(captcha) => "Voer ${captcha} in om te bevestigen:";

  static String m20(message) => "Fout: ${message}";

  static String m21(message) => "Fout: ${message}";

  static String m22(time) => "Verloopt over ${time}";

  static String m23(total) => ">${total} km";

  static String m24(hour) => "${hour} uur geleden";
  ...
  static String m28(size) => "Maximale bestandsgrootte: ${size} MB";
  ...
  static String m31(minute) => "${minute} minuten geleden";

  static String m32(month) => "${month} maanden geleden";

  static String m33(store) => "Meer van ${store}";

  static String m34(number) => "Moet worden gekocht in groepen van ${number}";

  static String m35(itemCount) => "${itemCount} items";

  static String m36(price) => "Opties totaal: ${price}";

  static String m37(amount) => "Betaal ${amount}";

  static String m38(name) =>
      "${name} is succesvol aan de winkelwagen toegevoegd";

  static String m39(total) => "Aantal: ${total}";

  static String m40(name) => "Geld ontvangen van ${name}";

  static String m41(count) =>
      "Wilt u ${count} item(s) van uw verlanglijst verwijderen?";

  static String m42(percent) => "Aanbieding ${percent}%";

  static String m43(keyword) => "Zoekresultaten voor: \'${keyword}\'";

  static String m44(keyword, count) => "${keyword} (${count} artikel)";

  static String m45(keyword, count) => "${keyword} (${count} artikelen)";

  static String m46(second) => "${second} seconden geleden";

  static String m47(totalCartQuantity) =>
      "Winkelwagen, ${totalCartQuantity} items";

  static String m48(numberOfUnitsSold) => "Verkocht: ${numberOfUnitsSold}";

  static String m49(fieldName) => "Het veld ${fieldName} is verplicht";

  static String m50(total) => "${total} producten";

  static String m51(name) => "Geld overmaken naar ${name}";
  ...
  static String m53(date) => "Geldig tot ${date}";

  static String m54(number) => "Versie ${number}";

  static String m55(balance) => "Saldo portemonnee: ${balance}";

  static String m56(message) => "Waarschuwing: ${message}";
  ...
  static String m58(length) => "We hebben ${length} producten gevonden";

  static String m59(week) => "Week ${week}";

  static String m60(name) => "Welkom ${name}";

  static String m61(year) => "${year} jaar geleden";

  static String m62(count) => "U selecteert ${count} item(s)";

  static String m63(total) => "U bent toegewezen aan bestelling #${total}";

  static String m64(point) => "Je hebt ${point} punten";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "accountSetup":
            MessageLookupByLibrary.simpleMessage("Account instellen"),
        ...
        "addANewPost":
            MessageLookupByLibrary.simpleMessage("Nieuw bericht toevoegen"),
        "addASlug":
            MessageLookupByLibrary.simpleMessage("Voeg een URL-slug toe"),
        "addAnAttr":
        ...
        "additionalInformation":
            MessageLookupByLibrary.simpleMessage("Extra informatie"),
        "additionalServices":
        ...
        "areYouWantToExit":
            MessageLookupByLibrary.simpleMessage("Wilt u de app afsluiten?"),
        ...
        "availablePoints": m2,
        "averageRating":
            MessageLookupByLibrary.simpleMessage("Gemiddelde beoordeling"),
        ...
        "bagsCollections":
            MessageLookupByLibrary.simpleMessage("Tassencollecties"),
        ...
        "basicInformation":
            MessageLookupByLibrary.simpleMessage("Basisinformatie"),
        "becomeAVendor":
            MessageLookupByLibrary.simpleMessage("Word een verkoper"),
        ...
        "bookingCancelled":
            MessageLookupByLibrary.simpleMessage("Reservering geannuleerd"),
        "bookingConfirm": MessageLookupByLibrary.simpleMessage("Bevestigd"),
        "bookingError": MessageLookupByLibrary.simpleMessage(
            "Er is iets misgegaan. Probeer het later opnieuw."),
        "bookingHistory":
            MessageLookupByLibrary.simpleMessage("Reserveringsgeschiedenis"),
        "bookingNow": MessageLookupByLibrary.simpleMessage("Nu reserveren"),
        "bookingSuccess":
            MessageLookupByLibrary.simpleMessage("Succesvol gereserveerd"),
        "bookingSummary":
            MessageLookupByLibrary.simpleMessage("Reserveringsoverzicht"),
        "bookingUnavailable":
            MessageLookupByLibrary.simpleMessage("Reserveren niet mogelijk"),
        ...
        "callToVendor":
            MessageLookupByLibrary.simpleMessage("Bel winkeleigenaar"),
        "canNotCreateOrder":
        ...
        "cartDiscount":
            MessageLookupByLibrary.simpleMessage("Winkelwagenkorting"),
        ...
        "chineseSimplified":
            MessageLookupByLibrary.simpleMessage("Vereenvoudigd Chinees"),
        "chineseTraditional":
            MessageLookupByLibrary.simpleMessage("Traditioneel Chinees"),
        "chooseBranch": MessageLookupByLibrary.simpleMessage("Kies filiaal"),
        "chooseCategory":
            MessageLookupByLibrary.simpleMessage("Kies categorie"),
        "chooseFromGallery":
            MessageLookupByLibrary.simpleMessage("Kies uit galerij"),
        "chooseFromServer":
            MessageLookupByLibrary.simpleMessage("Kies van server"),
        "choosePlan":
            MessageLookupByLibrary.simpleMessage("Kies een abonnement"),
        ...
        "chooseYourPaymentMethod":
            MessageLookupByLibrary.simpleMessage("Kies je betaalmethode"),
        "city": MessageLookupByLibrary.simpleMessage("Stad"),
        "cityIsRequired":
            MessageLookupByLibrary.simpleMessage("Stad is verplicht"),
        ...
        "clearConversation":
            MessageLookupByLibrary.simpleMessage("Gesprek wissen"),
        ...
        "codExtraFee":
            MessageLookupByLibrary.simpleMessage("Rembours extra kosten"),
        "color": MessageLookupByLibrary.simpleMessage("Kleur"),
        "comment": MessageLookupByLibrary.simpleMessage("Reactie"),
        "commentFirst":
            MessageLookupByLibrary.simpleMessage("Schrijf eerst je reactie"),
        ...
        "continueToPayment":
            MessageLookupByLibrary.simpleMessage("Doorgaan naar betaling"),
        "continueToReview":
            MessageLookupByLibrary.simpleMessage("Doorgaan naar beoordeling"),
        "continueToSelectItem": MessageLookupByLibrary.simpleMessage(
            "Ga door met het selecteren van het item"),
        "continueToShipping":
            MessageLookupByLibrary.simpleMessage("Doorgaan naar verzending"),
        ...
        "countryCodeIsRequired":
            MessageLookupByLibrary.simpleMessage("Landcode is verplicht"),
        "countryIsNotSupported": m14,
        "countryIsRequired":
            MessageLookupByLibrary.simpleMessage("Land is verplicht"),
        ...
        "couponInvalid":
            MessageLookupByLibrary.simpleMessage("Je kortingscode is ongeldig"),
        ...
        "createReviewSuccess":
            MessageLookupByLibrary.simpleMessage("Bedankt voor uw beoordeling"),
        ...
        "dateBooking":
            MessageLookupByLibrary.simpleMessage("Reserveringsdatum"),
        ...
        "dateWiseClose":
            MessageLookupByLibrary.simpleMessage("Datum verstandig sluiten"),
        "daysAgo": m16,
        ...
        "deliveryDetails":
            MessageLookupByLibrary.simpleMessage("Bezorggegevens"),
        ...
        "doYouWantToExitApp":
            MessageLookupByLibrary.simpleMessage("Wil je de app afsluiten?"),
        "doYouWantToLeaveWithoutSubmit": MessageLookupByLibrary.simpleMessage(
            "Wilt u vertrekken zonder uw beoordeling in te dienen?"),
        "doYouWantToLogout":
            MessageLookupByLibrary.simpleMessage("Wilt u uitloggen?"),
        ...
        "dontHaveAccount":
            MessageLookupByLibrary.simpleMessage("Heb je nog geen account?"),
        "download": MessageLookupByLibrary.simpleMessage("Download"),
        "downloadApp": MessageLookupByLibrary.simpleMessage("App downloaden"),
        "downloadingImages":
            MessageLookupByLibrary.simpleMessage("Afbeeldingen downloaden..."),
        "draft": MessageLookupByLibrary.simpleMessage("Concept"),
        "driverAssigned":
            MessageLookupByLibrary.simpleMessage("Bezorger toegewezen"),
        ...
        "emailIsRequired":
            MessageLookupByLibrary.simpleMessage("E-mail is verplicht"),
        "emailSubscription":
            MessageLookupByLibrary.simpleMessage("E-mailabonnement"),
        ...
        "enableForLogin":
            MessageLookupByLibrary.simpleMessage("Inschakelen voor inloggen"),
        ...
        "enterVoucherCode":
            MessageLookupByLibrary.simpleMessage("Voer vouchercode in"),
        "enterYourEmail":
            MessageLookupByLibrary.simpleMessage("Voer je e-mailadres in"),
        "enterYourEmailOrUsername": MessageLookupByLibrary.simpleMessage(
            "Voer je e-mailadres of gebruikersnaam in"),
        "enterYourFirstName":
            MessageLookupByLibrary.simpleMessage("Vul je voornaam in"),
        "enterYourLastName":
            MessageLookupByLibrary.simpleMessage("Vul je achternaam in"),
        "enterYourMobile":
        ...
        "expectedDeliveryDate":
            MessageLookupByLibrary.simpleMessage("Verwachte bezorgdatum"),
        ...
        "featureProducts":
            MessageLookupByLibrary.simpleMessage("Aanbevolen producten"),
        ...
        "fileUploadFailed":
            MessageLookupByLibrary.simpleMessage("Bestand uploaden mislukt!"),
        ...
        "finishSetup":
            MessageLookupByLibrary.simpleMessage("Installatie voltooien"),
        ...
        "firstNameIsRequired":
            MessageLookupByLibrary.simpleMessage("Voornaam is verplicht"),
        "firstRenewal":
        ...
        "generalSetting":
            MessageLookupByLibrary.simpleMessage("Algemene instellingen"),
        "generatingLink":
            MessageLookupByLibrary.simpleMessage("Link genereren..."),
        "german": MessageLookupByLibrary.simpleMessage("Duits"),
        "getNotification":
            MessageLookupByLibrary.simpleMessage("Meldingen ontvangen"),
        "getNotified":
            MessageLookupByLibrary.simpleMessage("Ontvang meldingen!"),
        "getPasswordLink":
            MessageLookupByLibrary.simpleMessage("Wachtwoordlink opvragen"),
        ...
        "goBackToAddress":
            MessageLookupByLibrary.simpleMessage("Terug naar adres"),
        "goBackToReview":
            MessageLookupByLibrary.simpleMessage("Terug naar beoordeling"),
        "goBackToShipping":
            MessageLookupByLibrary.simpleMessage("Terug naar verzending"),
        ...
        "informationTable":
            MessageLookupByLibrary.simpleMessage("Informatietabel"),
        ...
        "isEverythingSet":
            MessageLookupByLibrary.simpleMessage("Is alles ingesteld...?"),
        ...
        "languageSuccess":
            MessageLookupByLibrary.simpleMessage("Taal succesvol bijgewerkt"),
        "lao": MessageLookupByLibrary.simpleMessage("Lao"),
        "lastName": MessageLookupByLibrary.simpleMessage("Achternaam"),
        "lastNameIsRequired":
            MessageLookupByLibrary.simpleMessage("Achternaam is verplicht"),
        "lastTransactions":
        ...
        "markAsUnread":
            MessageLookupByLibrary.simpleMessage("Markeer als ongelezen"),
        ...
        "mobileIsRequired":
            MessageLookupByLibrary.simpleMessage("Mobiel nummer is verplicht"),
        ...
        "noBackHistoryItem":
            MessageLookupByLibrary.simpleMessage("Geen vorig item"),
        ...
        "noForwardHistoryItem":
            MessageLookupByLibrary.simpleMessage("Geen volgend item"),
        ...
        "orderConfirmation":
            MessageLookupByLibrary.simpleMessage("Orderbevestiging"),
        ...
        "orderIdWithoutColon":
            MessageLookupByLibrary.simpleMessage("Bestelnummer"),
        ...
        "orderStatusChargeBack":
            MessageLookupByLibrary.simpleMessage("Terugbetaling"),
        ...
        "orderStatusPendingPayment":
            MessageLookupByLibrary.simpleMessage("Wachtend op betaling"),
        "orderStatusProcessed":
            MessageLookupByLibrary.simpleMessage("Verwerkt"),
        "orderStatusProcessing":
            MessageLookupByLibrary.simpleMessage("In behandeling"),
        "orderStatusRefunded":
            MessageLookupByLibrary.simpleMessage("Terugbetaald"),
        "orderStatusReversed":
            MessageLookupByLibrary.simpleMessage("Teruggedraaid"),
        "orderStatusShipped": MessageLookupByLibrary.simpleMessage("Verzonden"),
        "orderStatusVoided":
            MessageLookupByLibrary.simpleMessage("Ongeldig gemaakt"),
        ...
        "orderSuccessTitle2":
            MessageLookupByLibrary.simpleMessage("Je account"),
        "orderSummary":
            MessageLookupByLibrary.simpleMessage("Bestellingsoverzicht"),
        ...
        "passwordIsRequired":
            MessageLookupByLibrary.simpleMessage("Het wachtwoord is verplicht"),
        "passwordsDoNotMatch": MessageLookupByLibrary.simpleMessage(
            "Wachtwoorden komen niet overeen"),
        "pasteYourImageUrl":
            MessageLookupByLibrary.simpleMessage("Plak uw afbeeldings-URL"),
        "payByWallet":
        ...
        "paymentSuccessful":
            MessageLookupByLibrary.simpleMessage("Betaling succesvol"),
        ...
        "phoneEmpty":
            MessageLookupByLibrary.simpleMessage("Telefoonnummer is leeg"),
        "phoneHintFormat":
            MessageLookupByLibrary.simpleMessage("Formaat: +31612345678"),
        "phoneIsRequired":
            MessageLookupByLibrary.simpleMessage("Telefoonnummer is verplicht"),
        "phoneNumber": MessageLookupByLibrary.simpleMessage("Telefoonnummer"),
        "phoneNumberVerification":
            MessageLookupByLibrary.simpleMessage("Telefoonnummerverificatie"),
        ...
        "placeMyOrder":
            MessageLookupByLibrary.simpleMessage("Plaats mijn bestelling"),
        "playAll": MessageLookupByLibrary.simpleMessage("Alles afspelen"),
        "pleaseAddPrice":
            MessageLookupByLibrary.simpleMessage("Voeg een prijs toe"),
        ...
        "pleaseFillCode":
            MessageLookupByLibrary.simpleMessage("Vul je code in"),
        ...
        "pleaseInput":
            MessageLookupByLibrary.simpleMessage("Vul alle velden in"),
        ...
        "pointMsgEnter":
            MessageLookupByLibrary.simpleMessage("Voer kortingspunt in"),
        ...
        "postImageFeature":
            MessageLookupByLibrary.simpleMessage("Afbeeldingsfunctie"),
        "postManagement":
            MessageLookupByLibrary.simpleMessage("Berichtenbeheer"),
        ...
        "printerNotFound":
            MessageLookupByLibrary.simpleMessage("Printer niet gevonden"),
        "printerSelection":
        ...
        "productAdded":
            MessageLookupByLibrary.simpleMessage("Product toegevoegd"),
        ...
        "productReview":
            MessageLookupByLibrary.simpleMessage("Productbeoordeling"),
        ...
        "readyToPick":
            MessageLookupByLibrary.simpleMessage("Klaar om te verzamelen"),
        ...
        "refundRequest":
            MessageLookupByLibrary.simpleMessage("Verzoek om terugbetaling"),
        "refundRequested":
        ...
        "regenerateResponse":
            MessageLookupByLibrary.simpleMessage("Antwoord opnieuw genereren"),
        "registerAs": MessageLookupByLibrary.simpleMessage("Registreer als"),
        "registerAsVendor":
            MessageLookupByLibrary.simpleMessage("Registreer als verkoper"),
        ...
        "registerFailed":
            MessageLookupByLibrary.simpleMessage("Registratie mislukt"),
        ...
        "requestBooking":
            MessageLookupByLibrary.simpleMessage("Reservering aanvragen"),
        ...
        "resetYourPassword":
            MessageLookupByLibrary.simpleMessage("Reset je wachtwoord"),
        ...
        "reviewApproval":
            MessageLookupByLibrary.simpleMessage("Beoordeling goedkeuring"),
        ...
        "saveAddressSuccess":
            MessageLookupByLibrary.simpleMessage("Je adres is opgeslagen"),
        "saveForLater":
            MessageLookupByLibrary.simpleMessage("Bewaren voor later"),
        ...
        "searchByName":
            MessageLookupByLibrary.simpleMessage("Zoeken op naam..."),
        ...
        "searchInput":
            MessageLookupByLibrary.simpleMessage("Vul je zoekopdracht in"),
        "searchOrderId":
            MessageLookupByLibrary.simpleMessage("Zoek bestelnummer..."),
        ...
        "shareProductData":
            MessageLookupByLibrary.simpleMessage("Productgegevens delen"),
        "shareProductLink":
            MessageLookupByLibrary.simpleMessage("Productlink delen"),
        ...
        "showAllMyOrdered":
            MessageLookupByLibrary.simpleMessage("Toon al mijn bestellingen"),
        ...
        "stateIsRequired":
            MessageLookupByLibrary.simpleMessage("Provincie is verplicht"),
        ...
        "storeInformation":
            MessageLookupByLibrary.simpleMessage("Winkelinformatie"),
        "storeListBanner":
        ...
        "storeLocatorSearchPlaceholder":
            MessageLookupByLibrary.simpleMessage("Voer adres of plaats in"),
        "storeLogo": MessageLookupByLibrary.simpleMessage("Winkellogo"),
        "storeMobileBanner":
            MessageLookupByLibrary.simpleMessage("Mobiele banner winkel"),
        "storeSettings":
            MessageLookupByLibrary.simpleMessage("Winkelinstellingen"),
        "storeSliderBanner":
            MessageLookupByLibrary.simpleMessage("Slider banner winkel"),
        "storeStaticBanner":
            MessageLookupByLibrary.simpleMessage("Statische banner winkel"),
        "storeVacation":
            MessageLookupByLibrary.simpleMessage("Winkel gesloten"),
        ...
        "streetIsRequired":
            MessageLookupByLibrary.simpleMessage("Straatnaam is verplicht"),
        ...
        "submitYourPost":
            MessageLookupByLibrary.simpleMessage("Verzend uw bericht"),
        ...
        "thisIsCustomerRole":
            MessageLookupByLibrary.simpleMessage("Dit is de klantrol"),
        "thisIsVendorRole":
            MessageLookupByLibrary.simpleMessage("Dit is de verkopersrol"),
        ...
        "transferConfirm":
            MessageLookupByLibrary.simpleMessage("Overboekingsbevestiging"),
        "transferErrorMessage": MessageLookupByLibrary.simpleMessage(
            "U kunt niet overmaken naar deze gebruiker"),
        "transferFailed":
            MessageLookupByLibrary.simpleMessage("Overboeking mislukt"),
        "transferMoneyTo": m51,
        "transferSuccess":
            MessageLookupByLibrary.simpleMessage("Overboeking succesvol"),
        ...
        "typeYourMessage":
            MessageLookupByLibrary.simpleMessage("Typ je bericht hier..."),
        ...
        "uploadProduct":
            MessageLookupByLibrary.simpleMessage("Product uploaden"),
        ...
        "vendorAdmin":
            MessageLookupByLibrary.simpleMessage("Verkopersbeheerder"),
        "vendorInfo":
            MessageLookupByLibrary.simpleMessage("Verkopersinformatie"),
        "verificationCode":
        ...
        "waitForPost":
            MessageLookupByLibrary.simpleMessage("Wachten op plaatsen product"),
        "waiting": MessageLookupByLibrary.simpleMessage("Wachten"),
        "waitingForConfirmation":
            MessageLookupByLibrary.simpleMessage("Wachten op bevestiging"),
        "walletBalance":
            MessageLookupByLibrary.simpleMessage("Portemonnee-saldo"),
        ...
        "weFoundBlogs":
            MessageLookupByLibrary.simpleMessage("Blog(s) gevonden"),
        "weFoundProducts": m58,
        ...
        "womanCollections":
            MessageLookupByLibrary.simpleMessage("Damescollecties"),
        "writeComment":
            MessageLookupByLibrary.simpleMessage("Schrijf je reactie"),
        "writeYourNote":
        ...
        "youCanOnlyPurchase":
            MessageLookupByLibrary.simpleMessage("Je kunt alleen kopen"),
        ...
        "youHaveNoPost":
            MessageLookupByLibrary.simpleMessage("U heeft geen berichten"),
        "youHavePoints": m64,
        ...
        "yourBagIsEmpty":
            MessageLookupByLibrary.simpleMessage("Je winkelwagen is leeg"),
        "yourBookingDetail":
            MessageLookupByLibrary.simpleMessage("Je reserveringsgegevens"),
        "yourEarningsThisMonth":
            MessageLookupByLibrary.simpleMessage("Je verdiensten deze maand"),
        "yourNote": MessageLookupByLibrary.simpleMessage("Je notitie"),
        "yourOrderHasBeenAdded":
            MessageLookupByLibrary.simpleMessage("Uw bestelling is toegevoegd"),
        "yourOrderIsConfirmed":
            MessageLookupByLibrary.simpleMessage("Uw bestelling is bevestigd!"),
        "yourOrderIsEmpty":
            MessageLookupByLibrary.simpleMessage("Uw bestelling is leeg"),
        ...
        "yourUsernameEmail":
            MessageLookupByLibrary.simpleMessage("Je gebruikersnaam of e-mail"),
        "zipCode": MessageLookupByLibrary.simpleMessage("Postcode"),
        "zipCodeIsRequired":
            MessageLookupByLibrary.simpleMessage("Postcode is verplicht")
      };
}
