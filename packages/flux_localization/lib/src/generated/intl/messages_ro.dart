...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(point) => "Punctele tale disponibile: ${point}";

  static String m3(state) => "Adaptorul Bluetooth este ${state}";

  static String m4(author) => "Autor: ${author}";

  static String m5(fieldName) => "${fieldName} nu poate fi gol.";

  static String m6(fieldName) =>
      "Lungimea ${fieldName} nu poate fi mai mică de 3.";

  static String m7(currency) => "Moneda a fost schimbată în ${currency}";

  static String m8(number) => "${number} caractere rămase";
  ...
  static String m12(count) => "${count} produs";

  static String m13(count) => "${count} produse";

  static String m14(country) => "Țara ${country} nu este acceptată";

  static String m15(currency) => "${currency} nu este acceptată";

  static String m16(day) => "acum ${day} zile";

  static String m17(total) => "~${total} km";

  static String m18(timeLeft) => "Se termină în ${timeLeft}";

  static String m19(captcha) => "Introdu ${captcha} pentru a confirma:";

  static String m20(message) => "Eroare: ${message}";

  static String m21(message) => "Eroare: ${message}";

  static String m22(time) => "Expiră în ${time}";

  static String m23(total) => ">${total} km";

  static String m24(hour) => "acum ${hour} ore";
  ...
  static String m28(size) => "Dimensiune maximă fișier: ${size} MB";
  ...
  static String m31(minute) => "acum ${minute} minute";

  static String m32(month) => "acum ${month} luni";

  static String m33(store) => "Mai multe de la ${store}";

  static String m34(number) => "Trebuie cumpărat în grupuri de ${number}";

  static String m35(itemCount) => "${itemCount} articole";

  static String m36(price) => "Total opțiuni: ${price}";

  static String m37(amount) => "Plătește ${amount}";

  static String m38(name) => "${name} a fost adăugat în coș cu succes";

  static String m39(total) => "Cantitate: ${total}";

  static String m40(name) => "A primit bani de la ${name}";

  static String m41(count) =>
      "Vrei să elimini ${count} produs(e) din lista ta de dorințe?";

  static String m42(percent) => "Reducere ${percent}%";

  static String m43(keyword) => "Rezultatele căutării pentru: „${keyword}";

  static String m44(keyword, count) => "${keyword} (${count} articol)";

  static String m45(keyword, count) => "${keyword} (${count} articole)";

  static String m46(second) => "acum ${second} secunde";

  static String m47(totalCartQuantity) =>
      "Coș de cumpărături, ${totalCartQuantity} articole";

  static String m48(numberOfUnitsSold) => "Vândut: ${numberOfUnitsSold}";

  static String m49(fieldName) => "Câmpul ${fieldName} este obligatoriu";

  static String m50(total) => "${total} produse";

  static String m51(name) => "Transferă bani către ${name}";
  ...
  static String m53(date) => "Valabil până la ${date}";

  static String m54(number) => "Versiunea ${number}";

  static String m55(balance) => "Sold portofel: ${balance}";

  static String m56(message) => "Atenție: ${message}";
  ...
  static String m58(length) => "Am găsit ${length} produse";

  static String m59(week) => "Săptămâna ${week}";

  static String m60(name) => "Bun venit, ${name}";

  static String m61(year) => "acum ${year} ani";

  static String m62(count) => "Selectezi ${count} produs(e)";

  static String m63(total) => "Ai fost atribuit comenzii #${total}";

  static String m64(point) => "Ai ${point} puncte";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "accountSetup":
            MessageLookupByLibrary.simpleMessage("Configurare cont"),
        ...
        "addANewPost":
            MessageLookupByLibrary.simpleMessage("Adaugă o postare nouă"),
        ...
        "addNewBlog":
            MessageLookupByLibrary.simpleMessage("Adaugă un blog nou"),
        "addNewPost":
            MessageLookupByLibrary.simpleMessage("Creează postare nouă"),
        ...
        "addToQuoteRequest":
            MessageLookupByLibrary.simpleMessage("Adaugă la cererea de ofertă"),
        "addToWishlist":
        ...
        "addingYourImage":
            MessageLookupByLibrary.simpleMessage("Adăugarea imaginii tale"),
        ...
        "allowCameraAccess":
            MessageLookupByLibrary.simpleMessage("Permiți accesul la cameră?"),
        "almostSoldOut":
        ...
        "bagsCollections":
            MessageLookupByLibrary.simpleMessage("Colecții de genți"),
        "balance": MessageLookupByLibrary.simpleMessage("Sold"),
        "bank": MessageLookupByLibrary.simpleMessage("Bancă"),
        "bannerListType":
            MessageLookupByLibrary.simpleMessage("Tip listă banner"),
        ...
        "becomeAVendor":
            MessageLookupByLibrary.simpleMessage("Devino vânzător"),
        "bengali": MessageLookupByLibrary.simpleMessage("Bengaleză"),
        "billingAddress":
            MessageLookupByLibrary.simpleMessage("Adresă de facturare"),
        ...
        "blockUser":
            MessageLookupByLibrary.simpleMessage("Blochează utilizatorul"),
        ...
        "changePrinter":
            MessageLookupByLibrary.simpleMessage("Schimbă imprimanta"),
        "changedCurrencyTo": m7,
        "characterRemain": m8,
        "chat": MessageLookupByLibrary.simpleMessage("Chat"),
        "chatGPT": MessageLookupByLibrary.simpleMessage("Chat GPT"),
        "chatListScreen":
            MessageLookupByLibrary.simpleMessage("Lista de conversații"),
        ...
        "chooseFromGallery":
            MessageLookupByLibrary.simpleMessage("Alege din galerie"),
        "chooseFromServer":
            MessageLookupByLibrary.simpleMessage("Alege de pe server"),
        ...
        "chooseYourPaymentMethod":
            MessageLookupByLibrary.simpleMessage("Alege metoda de plată"),
        "city": MessageLookupByLibrary.simpleMessage("Oraș"),
        "cityIsRequired":
            MessageLookupByLibrary.simpleMessage("Orașul este obligatoriu"),
        "clear": MessageLookupByLibrary.simpleMessage("Șterge"),
        "clearCart": MessageLookupByLibrary.simpleMessage("Golește coșul"),
        "clearCartAndAddNew":
            MessageLookupByLibrary.simpleMessage("Golește coșul și adaugă nou"),
        "clearConversation":
        ...
        "confirmAccountDeletion":
            MessageLookupByLibrary.simpleMessage("Confirmă ștergerea contului"),
        ...
        "continueShopping":
            MessageLookupByLibrary.simpleMessage("Continuă cumpărăturile"),
        "continueToPayment":
            MessageLookupByLibrary.simpleMessage("Continuă spre plată"),
        "continueToReview":
            MessageLookupByLibrary.simpleMessage("Continuă spre verificare"),
        "continueToSelectItem": MessageLookupByLibrary.simpleMessage(
            "Continuă să selectezi produsul"),
        "continueToShipping":
            MessageLookupByLibrary.simpleMessage("Continuă spre livrare"),
        ...
        "countryIsRequired":
            MessageLookupByLibrary.simpleMessage("Țara este obligatorie"),
        ...
        "createProduct":
            MessageLookupByLibrary.simpleMessage("Creează un produs"),
        ...
        "createVariants":
            MessageLookupByLibrary.simpleMessage("Creează toate variantele"),
        ...
        "currentPassword":
            MessageLookupByLibrary.simpleMessage("Parola actuală"),
        "currentlyWeOnlyHave":
            MessageLookupByLibrary.simpleMessage("În prezent avem doar"),
        ...
        "delivering":
            MessageLookupByLibrary.simpleMessage("În curs de livrare"),
        ...
        "disablePurchase":
            MessageLookupByLibrary.simpleMessage("Dezactivează achiziția"),
        ...
        "doNotAnyTransactions":
            MessageLookupByLibrary.simpleMessage("Nu ai încă nicio tranzacție"),
        "doYouWantToExitApp":
            MessageLookupByLibrary.simpleMessage("Vrei să ieși din aplicație?"),
        "doYouWantToLeaveWithoutSubmit": MessageLookupByLibrary.simpleMessage(
            "Vrei să pleci fără să trimiți recenzia?"),
        "doYouWantToLogout":
            MessageLookupByLibrary.simpleMessage("Dorești să te deconectezi?"),
        ...
        "downloadApp":
            MessageLookupByLibrary.simpleMessage("Descarcă aplicația"),
        "downloadingImages":
            MessageLookupByLibrary.simpleMessage("Se descarcă imaginile..."),
        "draft": MessageLookupByLibrary.simpleMessage("Schiță"),
        "driverAssigned":
            MessageLookupByLibrary.simpleMessage("Șofer atribuit"),
        ...
        "emailAlreadyInUse":
            MessageLookupByLibrary.simpleMessage("E-mailul este deja folosit!"),
        ...
        "emptyComment":
            MessageLookupByLibrary.simpleMessage("Comentariul nu poate fi gol"),
        ...
        "emptyWishlist":
            MessageLookupByLibrary.simpleMessage("Lista de dorințe este goală"),
        ...
        "enableForWallet":
            MessageLookupByLibrary.simpleMessage("Activează pentru Portofel"),
        "enableVacationMode":
            MessageLookupByLibrary.simpleMessage("Activează modul vacanță"),
        ...
        "enterVoucherCode":
            MessageLookupByLibrary.simpleMessage("Introdu codul voucherului"),
        "enterYourEmail":
        ...
        "enterYourFirstName":
            MessageLookupByLibrary.simpleMessage("Introdu prenumele tău"),
        ...
        "enterYourPassword":
            MessageLookupByLibrary.simpleMessage("Introdu parola"),
        ...
        "expectedDeliveryDate":
            MessageLookupByLibrary.simpleMessage("Data estimată de livrare"),
        ...
        "failedToGenerateLink":
            MessageLookupByLibrary.simpleMessage("Nu s-a putut genera linkul"),
        ...
        "finishSetup":
            MessageLookupByLibrary.simpleMessage("Finalizează configurarea"),
        ...
        "firstNameIsRequired":
            MessageLookupByLibrary.simpleMessage("Prenumele este obligatoriu"),
        "firstRenewal": MessageLookupByLibrary.simpleMessage("Prima reînnoire"),
        "fixedCartDiscount":
            MessageLookupByLibrary.simpleMessage("Discount fix pentru coș"),
        "fixedProductDiscount":
            MessageLookupByLibrary.simpleMessage("Discount fix pentru produs"),
        "forThisProduct":
        ...
        "goBackToShipping":
            MessageLookupByLibrary.simpleMessage("Înapoi la livrare"),
        ...
        "imageGenerate":
            MessageLookupByLibrary.simpleMessage("Generare imagine"),
        "imageNetwork":
        ...
        "informationTable":
            MessageLookupByLibrary.simpleMessage("Tabel informații"),
        ...
        "instantlyClose":
            MessageLookupByLibrary.simpleMessage("Închide instant"),
        ...
        "invalidYearOfBirth":
            MessageLookupByLibrary.simpleMessage("An de naștere invalid"),
        "invoice": MessageLookupByLibrary.simpleMessage("Factură fiscală"),
        "isEverythingSet":
            MessageLookupByLibrary.simpleMessage("Este totul configurat...?"),
        ...
        "iwantToCreateAccount":
            MessageLookupByLibrary.simpleMessage("Vreau să creez un cont"),
        ...
        "listBannerType":
            MessageLookupByLibrary.simpleMessage("Tip listă banner"),
        "listBannerVideo":
            MessageLookupByLibrary.simpleMessage("Listă video banner"),
        "listMessages":
        ...
        "loginCanceled":
            MessageLookupByLibrary.simpleMessage("Autentificare anulată"),
        ...
        "loginToYourAccount":
            MessageLookupByLibrary.simpleMessage("Conectare la cont"),
        "logout": MessageLookupByLibrary.simpleMessage("Deconectare"),
        "malay": MessageLookupByLibrary.simpleMessage("Malaeză"),
        "manCollections":
            MessageLookupByLibrary.simpleMessage("Colecție pentru bărbați"),
        "manageApiKey":
            MessageLookupByLibrary.simpleMessage("Gestionează cheia API"),
        "manageStock":
            MessageLookupByLibrary.simpleMessage("Gestionează stocul"),
        "map": MessageLookupByLibrary.simpleMessage("Hartă"),
        "marathi": MessageLookupByLibrary.simpleMessage("Marathi"),
        "markAsRead":
            MessageLookupByLibrary.simpleMessage("Marchează ca citit"),
        "markAsShipped":
            MessageLookupByLibrary.simpleMessage("Marchează ca expediat"),
        "markAsUnread":
        ...
        "nearbyPlaces":
            MessageLookupByLibrary.simpleMessage("Locuri în apropiere"),
        "needHelp":
        ...
        "noBackHistoryItem":
            MessageLookupByLibrary.simpleMessage("Nu există istoric anterior"),
        ...
        "noFavoritesYet":
            MessageLookupByLibrary.simpleMessage("Nu ai produse favorite încă"),
        "noFileToDownload": MessageLookupByLibrary.simpleMessage(
            "Nu există fișier de descărcat"),
        "noForwardHistoryItem":
            MessageLookupByLibrary.simpleMessage("Nu există istoric ulterior"),
        ...
        "orLoginWith":
            MessageLookupByLibrary.simpleMessage("sau conectează-te cu"),
        "orderConfirmation":
        ...
        "orderIdWithoutColon":
            MessageLookupByLibrary.simpleMessage("ID Comandă"),
        ...
        "orderStatusCanceledReversal":
            MessageLookupByLibrary.simpleMessage("Anulare inversată"),
        "orderStatusCancelled": MessageLookupByLibrary.simpleMessage("Anulat"),
        "orderStatusChargeBack":
            MessageLookupByLibrary.simpleMessage("Returnare plată"),
        "orderStatusCompleted":
            MessageLookupByLibrary.simpleMessage("Finalizat"),
        ...
        "orderStatusProcessed":
            MessageLookupByLibrary.simpleMessage("Procesat"),
        "orderStatusProcessing":
            MessageLookupByLibrary.simpleMessage("În procesare"),
        "orderStatusRefunded":
            MessageLookupByLibrary.simpleMessage("Rambursat"),
        ...
        "orderSuccessTitle1":
            MessageLookupByLibrary.simpleMessage("Ai plasat comanda cu succes"),
        "orderSuccessTitle2":
        ...
        "orderTracking":
            MessageLookupByLibrary.simpleMessage("Urmărirea comenzii"),
        ...
        "passwordIsRequired":
            MessageLookupByLibrary.simpleMessage("Parola este obligatorie"),
        "passwordsDoNotMatch":
        ...
        "payByWallet":
            MessageLookupByLibrary.simpleMessage("Plătește prin portofel"),
        ...
        "pleaseAddPrice":
            MessageLookupByLibrary.simpleMessage("Te rugăm să adaugi prețul"),
        ...
        "pleaseChooseCategory":
            MessageLookupByLibrary.simpleMessage("Te rugăm să alegi categoria"),
        "pleaseEnterProductName": MessageLookupByLibrary.simpleMessage(
            "Te rugăm să introduci numele produsului"),
        "pleaseFillCode":
            MessageLookupByLibrary.simpleMessage("Te rugăm să introduci codul"),
        ...
        "pointMsgMaximumDiscountPoint":
            MessageLookupByLibrary.simpleMessage("Punct maxim de reducere"),
        ...
        "postImageFeature":
            MessageLookupByLibrary.simpleMessage("Caracteristică imagine"),
        "postManagement":
            MessageLookupByLibrary.simpleMessage("Gestionare postări"),
        ...
        "printReceipt":
            MessageLookupByLibrary.simpleMessage("Tipărește chitanța"),
        ...
        "productOverview":
            MessageLookupByLibrary.simpleMessage("Prezentare produs"),
        "productRating":
            MessageLookupByLibrary.simpleMessage("Evaluare produs"),
        "productReview":
            MessageLookupByLibrary.simpleMessage("Recenzie produs"),
        ...
        "pullToLoadMore":
            MessageLookupByLibrary.simpleMessage("Trage pentru mai mult"),
        "qRCodeMsgSuccess": MessageLookupByLibrary.simpleMessage(
            "Codul QR a fost salvat cu succes."),
        "qRCodeSaveFailure":
            MessageLookupByLibrary.simpleMessage("Nu s-a putut salva codul QR"),
        ...
        "rateProduct":
            MessageLookupByLibrary.simpleMessage("Evaluează produsul"),
        "rateTheApp":
        ...
        "refundRequest":
            MessageLookupByLibrary.simpleMessage("Cerere de rambursare"),
        "refundRequested":
            MessageLookupByLibrary.simpleMessage("Rambursare solicitată"),
        "refunds": MessageLookupByLibrary.simpleMessage("Rambursări"),
        "regenerateResponse":
            MessageLookupByLibrary.simpleMessage("Regenerează răspunsul"),
        "registerAs":
        ...
        "requestBooking":
            MessageLookupByLibrary.simpleMessage("Solicită rezervare"),
        ...
        "reviewApproval":
            MessageLookupByLibrary.simpleMessage("Aprobare recenzie"),
        "reviewPendingApproval": MessageLookupByLibrary.simpleMessage(
            "Recenzia ta a fost trimisă și așteaptă aprobarea!"),
        "reviewSent":
            MessageLookupByLibrary.simpleMessage("Recenzia ta a fost trimisă!"),
        ...
        "saveAddressSuccess":
            MessageLookupByLibrary.simpleMessage("Adresa ta a fost salvată"),
        "saveForLater":
            MessageLookupByLibrary.simpleMessage("Salvează pentru mai târziu"),
        ...
        "searchByName":
            MessageLookupByLibrary.simpleMessage("Caută după nume..."),
        ...
        "selectAddress":
            MessageLookupByLibrary.simpleMessage("Selectează adresa"),
        "selectAll": MessageLookupByLibrary.simpleMessage("Selectează tot"),
        "selectDates":
            MessageLookupByLibrary.simpleMessage("Selectează datele"),
        "selectFileCancelled": MessageLookupByLibrary.simpleMessage(
            "Selectarea fișierului a fost anulată!"),
        "selectImage":
            MessageLookupByLibrary.simpleMessage("Selectează imagine"),
        "selectItem":
            MessageLookupByLibrary.simpleMessage("Selectează produsul"),
        "selectNone": MessageLookupByLibrary.simpleMessage("Nu selecta nimic"),
        "selectPrinter":
            MessageLookupByLibrary.simpleMessage("Selectează imprimanta"),
        "selectRole": MessageLookupByLibrary.simpleMessage("Selectează rolul"),
        "selectStore":
            MessageLookupByLibrary.simpleMessage("Selectează magazin"),
        "selectTheColor":
            MessageLookupByLibrary.simpleMessage("Selectează culoarea"),
        "selectTheFile":
            MessageLookupByLibrary.simpleMessage("Selectează fișierul"),
        "selectThePoint":
            MessageLookupByLibrary.simpleMessage("Selectează punctele"),
        "selectTheQuantity":
            MessageLookupByLibrary.simpleMessage("Selectează cantitatea"),
        "selectTheSize":
            MessageLookupByLibrary.simpleMessage("Selectează mărimea"),
        "selectVoucher":
            MessageLookupByLibrary.simpleMessage("Selectează voucherul"),
        ...
        "sendTo":
            MessageLookupByLibrary.simpleMessage("Trimite către (e-mail)"),
        ...
        "shippingMethod":
            MessageLookupByLibrary.simpleMessage("Metoda de livrare"),
        ...
        "shortDescription":
            MessageLookupByLibrary.simpleMessage("Descriere scurtă"),
        "showAllMyOrdered":
        ...
        "startExploring":
            MessageLookupByLibrary.simpleMessage("Începe să explorezi"),
        "startShopping":
            MessageLookupByLibrary.simpleMessage("Începe cumpărăturile"),
        "state": MessageLookupByLibrary.simpleMessage("Județ"),
        "stateIsRequired":
            MessageLookupByLibrary.simpleMessage("Județul este obligatoriu"),
        ...
        "stockQuantity":
            MessageLookupByLibrary.simpleMessage("Cantitate în stoc"),
        ...
        "storeInformation":
            MessageLookupByLibrary.simpleMessage("Informații magazin"),
        "storeListBanner":
        ...
        "storeMobileBanner":
            MessageLookupByLibrary.simpleMessage("Banner mobil magazin"),
        "storeSettings": MessageLookupByLibrary.simpleMessage("Setări magazin"),
        "storeSliderBanner":
            MessageLookupByLibrary.simpleMessage("Banner slider magazin"),
        "storeStaticBanner":
            MessageLookupByLibrary.simpleMessage("Banner static magazin"),
        "storeVacation":
            MessageLookupByLibrary.simpleMessage("Vacanță magazin"),
        ...
        "streetIsRequired":
            MessageLookupByLibrary.simpleMessage("Strada este obligatorie"),
        ...
        "submitYourPost":
            MessageLookupByLibrary.simpleMessage("Trimite postarea ta"),
        ...
        "thisIsCustomerRole":
            MessageLookupByLibrary.simpleMessage("Acesta este rolul de client"),
        ...
        "transactionCancelled":
            MessageLookupByLibrary.simpleMessage("Tranzacție anulată"),
        "transactionDetail":
            MessageLookupByLibrary.simpleMessage("Detalii tranzacție"),
        "transactionFailded":
            MessageLookupByLibrary.simpleMessage("Tranzacția a eșuat"),
        "transactionFailed":
            MessageLookupByLibrary.simpleMessage("Tranzacție eșuată"),
        "transactionFee":
            MessageLookupByLibrary.simpleMessage("Taxa de tranzacție"),
        "transactionResult":
            MessageLookupByLibrary.simpleMessage("Rezultat tranzacție"),
        "transfer": MessageLookupByLibrary.simpleMessage("Transfer"),
        "transferConfirm":
            MessageLookupByLibrary.simpleMessage("Confirmare transfer"),
        "transferErrorMessage": MessageLookupByLibrary.simpleMessage(
            "Nu poți transfera către acest utilizator"),
        "transferFailed":
            MessageLookupByLibrary.simpleMessage("Transferul a eșuat"),
        "transferMoneyTo": m51,
        "transferSuccess":
            MessageLookupByLibrary.simpleMessage("Transfer reușit"),
        "tuesday": MessageLookupByLibrary.simpleMessage("Marți"),
        "turkish": MessageLookupByLibrary.simpleMessage("Turcă"),
        "turnOnBle":
            MessageLookupByLibrary.simpleMessage("Activează Bluetooth"),
        "typeAMessage":
            MessageLookupByLibrary.simpleMessage("Scrie un mesaj..."),
        "typeYourMessage":
            MessageLookupByLibrary.simpleMessage("Scrie mesajul tău aici..."),
        ...
        "unblockUser":
            MessageLookupByLibrary.simpleMessage("Deblochează utilizatorul"),
        ...
        "updateInfo":
            MessageLookupByLibrary.simpleMessage("Actualizează informațiile"),
        "updatePassword":
            MessageLookupByLibrary.simpleMessage("Actualizează parola"),
        "updateStatus":
            MessageLookupByLibrary.simpleMessage("Actualizează starea"),
        "updateSuccess":
            MessageLookupByLibrary.simpleMessage("Actualizare reușită!"),
        "updateUserInfor":
        ...
        "useThisImage":
            MessageLookupByLibrary.simpleMessage("Folosește această imagine"),
        ...
        "vacationMessage":
            MessageLookupByLibrary.simpleMessage("Mesaj vacanță"),
        ...
        "vendorInfo":
            MessageLookupByLibrary.simpleMessage("Informații vânzător"),
        "verificationCode":
        ...
        "viewOnGoogleMaps":
            MessageLookupByLibrary.simpleMessage("Vezi pe Google Maps"),
        "viewOrder": MessageLookupByLibrary.simpleMessage("Vezi comanda"),
        "viewRecentTransactions":
            MessageLookupByLibrary.simpleMessage("Vezi tranzacțiile recente"),
        ...
        "waitingForConfirmation":
            MessageLookupByLibrary.simpleMessage("În așteptarea confirmării"),
        ...
        "weWillSendYouNotification":
            MessageLookupByLibrary.simpleMessage("Abonează-te la notificări."),
        ...
        "withdrawAmount":
            MessageLookupByLibrary.simpleMessage("Sumă de retras"),
        "withdrawRequest":
            MessageLookupByLibrary.simpleMessage("Cerere de retragere"),
        "withdrawal": MessageLookupByLibrary.simpleMessage("Retragere"),
        "womanCollections":
            MessageLookupByLibrary.simpleMessage("Colecție pentru femei"),
        "writeComment":
            MessageLookupByLibrary.simpleMessage("Scrie un comentariu"),
        ...
        "youCanOnlyPurchase":
            MessageLookupByLibrary.simpleMessage("Poți cumpăra doar"),
        ...
        "youHaveNoPost":
            MessageLookupByLibrary.simpleMessage("Nu ai nicio postare"),
        "youHavePoints": m64,
        "youMightAlsoLike":
            MessageLookupByLibrary.simpleMessage("S-ar putea să îți placă și"),
        ...
        "yourBookingDetail":
            MessageLookupByLibrary.simpleMessage("Detaliile rezervării tale"),
        ...
        "yourOrderHasBeenAdded":
            MessageLookupByLibrary.simpleMessage("Comanda ta a fost adăugată"),
        "yourOrderIsConfirmed":
            MessageLookupByLibrary.simpleMessage("Comanda ta este confirmată!"),
        "yourOrderIsEmpty":
            MessageLookupByLibrary.simpleMessage("Comanda ta este goală"),
