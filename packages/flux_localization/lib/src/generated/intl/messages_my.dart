...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(point) => "သင်၏ရရှိနိုင်သောအချက်များ- ${point}";

  static String m3(state) => "Bluetooth Adapter သည် ${state}";

  static String m4(author) => "ရေးသားသူ- ${author}";

  static String m5(fieldName) => "${fieldName} ကို ဗလာမဖြစ်ရပါ။";

  static String m6(fieldName) => " အလျား${fieldName} သည် 3 ထက် မနည်းရပါ။";

  static String m7(currency) => "ငွေကြေးကို ${currency}သို့ ပြောင်းခဲ့သည်";

  static String m8(number) => " စာလုံး${number} လုံး ကျန်ပါသည်။";

  static String m9(priceRate, pointRate) => "${priceRate} = ${pointRate} မှတ်";

  static String m10(count) => " ပစ္စည်း${count} ခု";

  static String m11(count) => " ပစ္စည်း${count} ခု";

  static String m12(count) => " ပစ္စည်း${count} ခု";

  static String m13(count) => " ပစ္စည်း${count} ခု";

  static String m14(country) => "${country} နိုင်ငံကို ပံ့ပိုးမထားပါ။";

  static String m15(currency) => "${currency} ကို မပံ့ပိုးပါ။";

  static String m16(day) => "${day} ရက်အကြာ";

  static String m17(total) => "~${total} km";

  static String m18(timeLeft) => " ${timeLeft}တွင် ပြီးဆုံးသည် ";

  static String m19(captcha) => "အတည်ပြုရန် ${captcha} ကိုထည့်ပါ-";

  static String m20(message) => "အမှား- ${message}";

  static String m21(message) => "အမှား- ${message}";

  static String m22(time) => " ${time}တွင် သက်တမ်းကုန်မည် ";

  static String m23(total) => ">${total} km";

  static String m24(hour) => "${hour} နာရီအကြာ";
  ...
  static String m28(size) => "အများဆုံး ဖိုင်အရွယ်အစား- ${size} MB";
  ...
  static String m31(minute) => "${minute} မိနစ်အကြာ";

  static String m32(month) => "${month} လအကြာက";

  static String m33(store) => " ${store}မှ နောက်ထပ်";

  static String m34(number) => " ${number}အုပ်စုဖြင့် ဝယ်ယူရမည်";

  static String m35(itemCount) => "ပစ္စည်း ${itemCount} ခု";

  static String m36(price) => "ရွေးချယ်စရာများ စုစုပေါင်း- ${price}";

  static String m37(amount) => " ${amount}ပေးချေပါ";
  ...
  static String m40(name) => " ${name}ထံမှ ငွေလက်ခံရရှိသည် ";

  static String m41(count) =>
      "သင့်ဆန္ဒစာရင်းမှ အရာ ${count} ခုကို ဖယ်ရှားလိုပါသလား။";

  static String m42(percent) => "${percent}% လျှော့စျေး";

  static String m43(keyword) => "ရှာဖွေမှုရလဒ်များ- \'${keyword}\'";

  static String m44(keyword, count) => "${keyword} (ပစ္စည်း${count} ခု)";

  static String m45(keyword, count) => "${keyword} (ပစ္စည်း${count} ခု)";

  static String m46(second) => "${second} စက္ကန့်အကြာ";

  static String m47(totalCartQuantity) =>
      "စျေးခြင်း၊ ပစ္စည်း ${totalCartQuantity} ခု";

  static String m48(numberOfUnitsSold) => "ရောင်းသည်- ${numberOfUnitsSold}";

  static String m49(fieldName) => " ${fieldName} အကွက် လိုအပ်သည်။";

  static String m50(total) => " ထုတ်ကုန်${total} ခု";

  static String m51(name) => " ${name}သို့ ငွေလွှဲပါ ";
  ...
  static String m53(date) => " ${date}အထိ အကျုံးဝင်သည် ";

  static String m54(number) => "ဗားရှင်း ${number}";

  static String m55(balance) => "ပိုက်ဆံအိတ်လက်ကျန်- ${balance}";

  static String m56(message) => "သတိပေးချက်: ${message}";
  ...
  static String m58(length) => "ပစ္စည်း ${length} ခုတွေ့ရှိပါသည်";

  static String m59(week) => "အပတ် ${week}";

  static String m60(name) => "ကြိုဆိုပါတယ် ${name}";

  static String m61(year) => "${year} နှစ်အကြာက";

  static String m62(count) => "သင်သည် အရာ ${count} ခုကို ရွေးနေသည်";

  static String m63(total) => "You have assigned to order #${total}";

  static String m64(point) => "သင့်တွင် ပွိုင့် ${point} ရှိပါသည်";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addAnAttr":
            MessageLookupByLibrary.simpleMessage("ရည်ညွှန်းချက်တစ်ခုထည့်ပါ။"),
        ...
        "addToCart":
            MessageLookupByLibrary.simpleMessage("စျေးခြင်းထဲသို့ထည့်ရန်"),
        ...
        "addingYourImage":
            MessageLookupByLibrary.simpleMessage("သင့်ဓာတ်ပုံထည့်ရန်"),
        "additionalInformation":
            MessageLookupByLibrary.simpleMessage("နောက်ထပ်အချက်အလက်များ"),
        "additionalServices":
        ...
        "almostSoldOut":
            MessageLookupByLibrary.simpleMessage("ရောင်းခါနီးပြီ။"),
        ...
        "backToShop":
            MessageLookupByLibrary.simpleMessage("ဆိုင်သို့ပြန်သွားရန်"),
        "backToWallet":
            MessageLookupByLibrary.simpleMessage("Wallet သို့ပြန်သွားမည်။"),
        "bagsCollections":
            MessageLookupByLibrary.simpleMessage("အိတ်အမျိုးအစားများ"),
        ...
        "bannerType":
            MessageLookupByLibrary.simpleMessage("ဆိုင်းဘုတ်အမျိုးအစား"),
        "bannerYoutubeURL":
            MessageLookupByLibrary.simpleMessage("ဆိုင်းဘုတ် Youtube URL"),
        "basicInformation":
        ...
        "billingAddress":
            MessageLookupByLibrary.simpleMessage("ငွေတောင်းခံမည့်လိပ်စာ"),
        ...
        "bookingConfirm":
            MessageLookupByLibrary.simpleMessage("အတည်ပြုခဲ့သည်။"),
        "bookingError": MessageLookupByLibrary.simpleMessage(
            "တစ်ခုခုမှားသွားသည်။ နောက်မှ ထပ်စမ်းကြည့်ပါ။"),
        "bookingHistory":
            MessageLookupByLibrary.simpleMessage("ဘွတ်ကင်မှတ်တမ်း"),
        "bookingNow":
            MessageLookupByLibrary.simpleMessage("အခုပဲ ကြိုတင်မှာယူလိုက်ပါ။"),
        ...
        "chatViaWhatApp":
            MessageLookupByLibrary.simpleMessage("WhatsApp မှတဆင့်စကားပြောပါ။"),
        "chatWithBot":
        ...
        "chooseFromGallery":
            MessageLookupByLibrary.simpleMessage("Gallery မှရွေးချယ်ပါ။"),
        "chooseFromServer":
            MessageLookupByLibrary.simpleMessage("Server မှရွေးချယ်ပါ။"),
        ...
        "continueToPayment":
            MessageLookupByLibrary.simpleMessage("ငွေပေးချေမှုသို့ဆက်သွားရန်"),
        "continueToReview":
            MessageLookupByLibrary.simpleMessage("သုံးသပ်ချက်သို့ဆက်သွားရန်"),
        "continueToSelectItem": MessageLookupByLibrary.simpleMessage(
            "အကြောင်းအရာကို ရွေးချယ်ရန် ဆက်လက်လုပ်ဆောင်ပါ။"),
        "continueToShipping":
            MessageLookupByLibrary.simpleMessage("ပို့ဆောင်မှုသို့ဆက်သွားရန်"),
        "continues": MessageLookupByLibrary.simpleMessage("ဆက်ရန်"),
        "conversations":
            MessageLookupByLibrary.simpleMessage("ဆွေးနွေးချက်များ"),
        "convertPoint": m9,
        ...
        "couponInvalid":
            MessageLookupByLibrary.simpleMessage("ကူပွန်ကုဒ်မှားယွင်းနေပါသည်"),
        "couponMsgSuccess": MessageLookupByLibrary.simpleMessage(
            "ဂုဏ်ယူပါသည်! ကူပွန်ကုဒ်အောင်မြင်စွာအသုံးပြုပြီးပါပြီ"),
        "createAnAccount":
            MessageLookupByLibrary.simpleMessage("အကောင့်ဖွင့်ရန်"),
        ...
        "createProduct":
            MessageLookupByLibrary.simpleMessage("ပစ္စည်းဖန်တီးရန်"),
        ...
        "darkTheme":
            MessageLookupByLibrary.simpleMessage("အနက်ရောင်သို့ပြောင်းရန်"),
        ...
        "dateBooking":
            MessageLookupByLibrary.simpleMessage("စာရင်းသွင်းမည့်ရက်စွဲ"),
        "dateDESC":
        ...
        "deliveredTo":
            MessageLookupByLibrary.simpleMessage("သို့ ပို့ဆောင်ပေးခဲ့ပါသည်။"),
        ...
        "didntReceiveCode":
            MessageLookupByLibrary.simpleMessage("ကုဒ်ကို မရဘူးလား? "),
        ...
        "doYouWantToExitApp":
            MessageLookupByLibrary.simpleMessage("အက်ပ်မှထွက်လိုပါသလား?"),
        ...
        "emailIsRequired":
            MessageLookupByLibrary.simpleMessage("အီးမေးလ်ဖြည့်ရန်လိုအပ်ပါသည်"),
        "emailSubscription":
        ...
        "enterYourPassword":
            MessageLookupByLibrary.simpleMessage("စကားဝှက်ထည့်ရန်"),
        ...
        "fileUploadFailed":
            MessageLookupByLibrary.simpleMessage("ဖိုင်အပ်လုဒ် မအောင်မြင်ပါ။"),
        ...
        "fixedCartDiscount":
            MessageLookupByLibrary.simpleMessage("ပုံသေလှည်း လျှော့စျေး"),
        "fixedProductDiscount":
            MessageLookupByLibrary.simpleMessage("ပုံသေထုတ်ကုန်လျှော့စျေး"),
        ...
        "getNotification":
            MessageLookupByLibrary.simpleMessage("အကြောင်းကြားချက်ရယူရန်"),
        "getNotified": MessageLookupByLibrary.simpleMessage("အကြောင်းကြားပါ။"),
        "getPasswordLink":
            MessageLookupByLibrary.simpleMessage("စကားဝှက်လင့်ခ်ရယူရန်"),
        ...
        "goBackToAddress":
            MessageLookupByLibrary.simpleMessage("လိပ်စာသို့ပြန်သွားရန်"),
        "goBackToReview":
            MessageLookupByLibrary.simpleMessage("သုံးသပ်ချက်သို့ပြန်သွားရန်"),
        "goBackToShipping":
            MessageLookupByLibrary.simpleMessage("ပို့ဆောင်မှုသို့ပြန်သွားရန်"),
        ...
        "inStock":
            MessageLookupByLibrary.simpleMessage("ပစ္စည်းလက်ကျန်ရှိပါသည်"),
        "incorrectPassword":
        ...
        "itemTotal":
            MessageLookupByLibrary.simpleMessage("ပစ္စည်းစုစုပေါင်း- "),
        "items": MessageLookupByLibrary.simpleMessage("ပစ္စည်းများ"),
        "itsOrdered":
            MessageLookupByLibrary.simpleMessage("အော်ဒါတင်ပြီးပါပြီ"),
        "iwantToCreateAccount":
            MessageLookupByLibrary.simpleMessage("အကောင့်ဖွင့်လိုပါသည်"),
        ...
        "loginFailed":
            MessageLookupByLibrary.simpleMessage("လော့ဂ်အင်မအောင်မြင်ပါ!"),
        "loginInvalid": MessageLookupByLibrary.simpleMessage(
            "သင်သည် ဤအက်ပ်ကို အသုံးပြုရန် ခွင့်မပြုပါ။"),
        "loginRequired":
            MessageLookupByLibrary.simpleMessage("အကောင့်ဝင်ရန် လိုအပ်ပါသည်။"),
        ...
        "loginToYourAccount":
            MessageLookupByLibrary.simpleMessage("သင့်အကောင့်သို့ဝင်ရန်"),
        "logout": MessageLookupByLibrary.simpleMessage("အကောင့်ထွက်ရန်"),
        "malay": MessageLookupByLibrary.simpleMessage("မလေး"),
        "manCollections":
            MessageLookupByLibrary.simpleMessage("အမျိုးသားဝတ်အမျိုးအစားများ"),
        "manageApiKey":
            MessageLookupByLibrary.simpleMessage("API ကီးကို စီမံပါ။"),
        "manageStock":
            MessageLookupByLibrary.simpleMessage("စတော့ကို စီမံခန့်ခွဲပါ။"),
        ...
        "maybeLater":
            MessageLookupByLibrary.simpleMessage("နောက်မှဖြစ်နိုင်တယ်။"),
        ...
        "messageTo":
            MessageLookupByLibrary.simpleMessage("သို့ Message ပို့ပါ။"),
        "minAmountForPayment": m30,
        "minimumQuantityIs":
            MessageLookupByLibrary.simpleMessage("အနိမ့်ဆုံးပမာဏဖြစ်သည်။"),
        "minutesAgo": m31,
        ...
        "myPoints":
            MessageLookupByLibrary.simpleMessage("ကျွန်ုပ်၏ပွိုင့်များ"),
        "myProducts":
            MessageLookupByLibrary.simpleMessage("ကျွန်ုပ်၏ပစ္စည်းများ"),
        "myProductsEmpty": MessageLookupByLibrary.simpleMessage(
            "သင့်တွင်ပစ္စည်းများမရှိသေးပါ။ တစ်ခုဖန်တီးကြည့်ပါ!"),
        "myRating":
            MessageLookupByLibrary.simpleMessage("ကျွန်ုပ်၏ အဆင့်သတ်မှတ်ချက်"),
        "myReviews":
            MessageLookupByLibrary.simpleMessage("ကျွန်ုပ်၏ သုံးသပ်ချက်များ"),
        "myWallet":
        ...
        "noBackHistoryItem":
            MessageLookupByLibrary.simpleMessage("နောက်ကြောင်းပြန်ရန်မရှိပါ"),
        ...
        "noData":
            MessageLookupByLibrary.simpleMessage("နောက်ထပ်အချက်အလက်မရှိတော့ပါ"),
        "noFavoritesYet":
            MessageLookupByLibrary.simpleMessage("အကြိုက်ဆုံးစာရင်း မရှိသေးပါ"),
        "noFileToDownload":
            MessageLookupByLibrary.simpleMessage("ဖိုင်ဒေါင်းလုပ်မလုပ်ထားပါ."),
        "noForwardHistoryItem":
            MessageLookupByLibrary.simpleMessage("ရှေ့သို့သွားရန်မရှိပါ"),
        "noInternetConnection":
            MessageLookupByLibrary.simpleMessage("အင်တာနက်ဆက်သွယ်မှုမရှိပါ"),
        "noListingNearby":
            MessageLookupByLibrary.simpleMessage("အနီးနားတွင် စာရင်းမရှိပါ။"),
        ...
        "noResultFound":
            MessageLookupByLibrary.simpleMessage("ရလဒ်များမတွေ့ပါ။"),
        "noReviews":
            MessageLookupByLibrary.simpleMessage("သုံးသပ်ချက်မရှိသေးပါ"),
        "noSlotAvailable":
            MessageLookupByLibrary.simpleMessage("အပေါက်မရရှိနိုင်ပါ။"),
        ...
        "orderDate":
            MessageLookupByLibrary.simpleMessage("အော်ဒါတင်သည့်ရက်စွဲ"),
        ...
        "orderStatusCancelled":
            MessageLookupByLibrary.simpleMessage("ပယ်ဖျက်ထားသည်"),
        "orderStatusChargeBack":
            MessageLookupByLibrary.simpleMessage("Charge Back"),
        "orderStatusCompleted":
            MessageLookupByLibrary.simpleMessage("ပြီးဆုံးပါပြီ"),
        "orderStatusDenied":
        ...
        "orderStatusOnHold":
            MessageLookupByLibrary.simpleMessage("ဆိုင်းငံ့ထား"),
        "orderStatusPending":
            MessageLookupByLibrary.simpleMessage("စောင့်ဆိုင်းနေသည်"),
        ...
        "orderSuccessTitle2":
            MessageLookupByLibrary.simpleMessage("သင့်အကောင့်"),
        "orderSummary":
        ...
        "outOfStock":
            MessageLookupByLibrary.simpleMessage("ကုန်ပစ္စည်းကုန်နေပါသည်"),
        ...
        "phoneNumberVerification":
            MessageLookupByLibrary.simpleMessage("ဖုန်းနံပါတ် အတည်ပြုခြင်း။"),
        ...
        "productRating":
            MessageLookupByLibrary.simpleMessage("သင့်အဆင့်သတ်မှတ်ချက်"),
        "productReview": MessageLookupByLibrary.simpleMessage(
            "ထုတ်ကုန်ပြန်လည်သုံးသပ်ခြင်း။"),
        "productType":
            MessageLookupByLibrary.simpleMessage("ပစ္စည်းအမျိုးအစား"),
        ...
        "pullToLoadMore":
            MessageLookupByLibrary.simpleMessage("နောက်ထပ်ကြည့်ရန်ဆွဲချပါ"),
        ...
        "rateThisApp":
            MessageLookupByLibrary.simpleMessage("ဤအက်ပ်ကိုအဆင့်သတ်မှတ်ပါ"),
        ...
        "recentSearches":
            MessageLookupByLibrary.simpleMessage("မကြာသေးမီကရှာဖွေမှုများ"),
        ...
        "releaseToLoadMore":
            MessageLookupByLibrary.simpleMessage("နောက်ထပ်ကြည့်ရန်လွှတ်ပါ"),
        "remove": MessageLookupByLibrary.simpleMessage("ဖယ်ရှားရန်"),
        "removeFromWishList":
            MessageLookupByLibrary.simpleMessage("ဆန္ဒစာရင်းမှ ဖယ်ရှားပါ။"),
        "removeWishlist":
            MessageLookupByLibrary.simpleMessage("ဆန္ဒစာရင်းမှ ဖယ်ရှားပါ။"),
        "removeWishlistContent": m41,
        "requestBooking":
            MessageLookupByLibrary.simpleMessage("Booking တောင်းပါ။"),
        ...
        "resetPassword":
            MessageLookupByLibrary.simpleMessage("စကားဝှက်ပြန်လည်သတ်မှတ်ရန်"),
        ...
        "reviewApproval":
            MessageLookupByLibrary.simpleMessage("ပြန်လည်သုံးသပ်အတည်ပြုချက်"),
        ...
        "saveAddress":
            MessageLookupByLibrary.simpleMessage("လိပ်စာသိမ်းဆည်းရန်"),
        "saveAddressSuccess": MessageLookupByLibrary.simpleMessage(
            "သင့်လိပ်စာကို သိမ်းဆည်းပြီးပါပြီ"),
        "saveForLater":
            MessageLookupByLibrary.simpleMessage("နောက်မှသိမ်းဆည်းပါ။"),
        "saveQRCode":
        ...
        "searchForItems":
            MessageLookupByLibrary.simpleMessage("ပစ္စည်းရှာဖွေရန်"),
        "searchInput":
            MessageLookupByLibrary.simpleMessage("ရှာဖွေလိုသည်ကိုရိုက်ထည့်ပါ"),
        ...
        "searchingAddress":
            MessageLookupByLibrary.simpleMessage("လိပ်စာရှာဖွေနေပါသည်"),
        "secondsAgo": m46,
        ...
        "selectImage":
            MessageLookupByLibrary.simpleMessage("Image ကို ရွေးပါ။"),
        "selectItem":
            MessageLookupByLibrary.simpleMessage("အကြောင်းအရာကို ရွေးပါ။"),
        ...
        "selectTheColor":
            MessageLookupByLibrary.simpleMessage("အရောင်ရွေးချယ်ပါ"),
        "selectTheFile":
            MessageLookupByLibrary.simpleMessage("ဖိုင်ကိုရွေးချယ်ပါ။"),
        "selectThePoint":
            MessageLookupByLibrary.simpleMessage("အမှတ်များရွေးချယ်ပါ။"),
        "selectTheQuantity":
            MessageLookupByLibrary.simpleMessage("အရေအတွက်ရွေးချယ်ပါ"),
        "selectTheSize":
            MessageLookupByLibrary.simpleMessage("အရွယ်အစားရွေးချယ်ပါ"),
        "selectVoucher":
        ...
        "shareProductData":
            MessageLookupByLibrary.simpleMessage("ထုတ်ကုန်ဒေတာကို မျှဝေပါ။"),
        "shareProductLink":
            MessageLookupByLibrary.simpleMessage("ထုတ်ကုန်လင့်ခ်ကို မျှဝေပါ။"),
        ...
        "shippingAddress":
            MessageLookupByLibrary.simpleMessage("ပို့ဆောင်ရမည့်လိပ်စာ"),
        "shippingFee": MessageLookupByLibrary.simpleMessage("ပို့ဆောင်ခ"),
        "shippingMethod":
            MessageLookupByLibrary.simpleMessage("ပို့ဆောင်မှုနည်းလမ်း"),
        ...
        "shortDescription":
            MessageLookupByLibrary.simpleMessage("အတိုချုံးဖော်ပြချက်"),
        "showAllMyOrdered":
            MessageLookupByLibrary.simpleMessage("အော်ဒါအားလုံးပြရန်"),
        "showDetails":
            MessageLookupByLibrary.simpleMessage("အသေးစိတ်ကို ပြပါ။"),
        "showGallery":
            MessageLookupByLibrary.simpleMessage("ဓာတ်ပုံပြခန်းပြရန်"),
        ...
        "signInWithEmail":
            MessageLookupByLibrary.simpleMessage("အီးမေးလ်ဖြင့်အကောင့်ဝင်ရန်"),
        ...
        "storeSettings":
            MessageLookupByLibrary.simpleMessage("စတိုးဆိုင် ဆက်တင်များ"),
        ...
        "streetIsRequired":
            MessageLookupByLibrary.simpleMessage("လမ်းအမည်ဖြည့်ရန်လိုအပ်ပါသည်"),
        ...
        "thisDateIsNotAvailable":
            MessageLookupByLibrary.simpleMessage("ဤရက်စွဲကို မရရှိနိုင်ပါ။"),
        ...
        "trackingNumberIs":
            MessageLookupByLibrary.simpleMessage("ခြေရာခံနံပါတ်"),
        "trackingPage":
            MessageLookupByLibrary.simpleMessage("ခြေရာခံစာမျက်နှာ"),
        ...
        "updateFailed":
            MessageLookupByLibrary.simpleMessage("အပ်ဒိတ် မအောင်မြင်ပါ။"),
        "updateInfo": MessageLookupByLibrary.simpleMessage("အပ်ဒိတ်အချက်အလက်"),
        "updatePassword":
            MessageLookupByLibrary.simpleMessage("Update password"),
        "updateStatus":
            MessageLookupByLibrary.simpleMessage("အခြေအနေကို အပ်ဒိတ်လုပ်ပါ။"),
        "updateSuccess":
            MessageLookupByLibrary.simpleMessage("အပ်ဒိတ် အောင်မြင်ပါပြီ။"),
        ...
        "uploadProduct":
            MessageLookupByLibrary.simpleMessage("ထုတ်ကုန်ကို တင်ပါ။"),
        ...
        "vendorAdmin":
            MessageLookupByLibrary.simpleMessage("ရောင်းသူစီမံခန့်ခွဲသူ"),
        "vendorInfo":
            MessageLookupByLibrary.simpleMessage("ရောင်းချသူ အချက်အလက်"),
        "verificationCode":
        ...
        "womanCollections":
            MessageLookupByLibrary.simpleMessage("အမျိုးသမီးဝတ်အမျိုးအစားများ"),
        "writeComment":
            MessageLookupByLibrary.simpleMessage("သင့်မှတ်ချက်ရေးရန်"),
        "writeYourNote":
            MessageLookupByLibrary.simpleMessage("သင့်မှတ်စုရေးပါ"),
        "yearsAgo": m61,
        ...
        "youCanOnlyPurchase":
            MessageLookupByLibrary.simpleMessage("သင်သာဝယ်ယူနိုင်သည်။"),
        ...
        "yourEarningsThisMonth":
            MessageLookupByLibrary.simpleMessage("ဤလတွင် သင့်ဝင်ငွေများ"),
