...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(captcha) => "输入${captcha}以确认：";
  ...
  static String m26(message) => "请求数据时应用出现问题，请联系管理员解决：${message}";
  ...
  static String m34(number) => "必须以${number}为一组购买";
  ...
  static String m38(name) => "${name}已添加到购物车";

  static String m39(total) => "数量：${total}";

  static String m40(name) => "已收到来自${name}的款项";

  static String m41(count) => "是否要从愿望清单中删除 ${count} 件商品？";

  static String m42(percent) => "促销 ${percent}%";

  static String m43(keyword) => "\"${keyword}\"的搜索结果";

  static String m44(keyword, count) => "${keyword}（${count}个结果）";
  ...
  static String m50(total) => "${total}件商品";
  ...
  static String m58(length) => "我们找到了${length}件商品";
  ...
  static String m62(count) => "您正在选择 ${count} 个项目";

  static String m63(total) => "您已分配到订单#${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "accountIsPendingApproval":
            MessageLookupByLibrary.simpleMessage("账户正在等待审批"),
        ...
        "audioDetected":
            MessageLookupByLibrary.simpleMessage("检测到音频，是否添加到音频播放器？"),
        ...
        "canNotLaunch":
            MessageLookupByLibrary.simpleMessage("无法启动应用，请确保config.dart中的配置正确"),
        ...
        "cantPickDateInThePast":
            MessageLookupByLibrary.simpleMessage("不能选择过去的日期"),
        ...
        "commentSuccessfully":
            MessageLookupByLibrary.simpleMessage("评论成功，请等待审核通过"),
        ...
        "confirmClearCartWhenTopUp":
            MessageLookupByLibrary.simpleMessage("充值时购物车将被清空"),
        "confirmClearTheCart":
            MessageLookupByLibrary.simpleMessage("确定要清空购物车吗？"),
        "confirmDelete":
            MessageLookupByLibrary.simpleMessage("您确定要删除吗？此操作无法撤销。"),
        ...
        "createNewPostSuccessfully":
            MessageLookupByLibrary.simpleMessage("帖子已成功创建为草稿。请查看管理后台"),
        ...
        "createReviewSuccessMsg":
            MessageLookupByLibrary.simpleMessage("感谢您的反馈，这对我们改进服务非常有帮助"),
        ...
        "deleteAccountMsg":
            MessageLookupByLibrary.simpleMessage("您确定要删除您的账户吗？请阅读账户删除会产生的影响。"),
        ...
        "deliveryNotificationError":
            MessageLookupByLibrary.simpleMessage("无数据。\n此订单已被删除"),
        ...
        "doYouWantToLeaveWithoutSubmit":
            MessageLookupByLibrary.simpleMessage("确定不提交评价就离开吗？"),
        ...
        "doesNotSupportApplePay":
            MessageLookupByLibrary.simpleMessage("不支持Apple Pay。请检查您的钱包和卡"),
        ...
        "emailDeleteDescription":
            MessageLookupByLibrary.simpleMessage("删除您的账户后将取消所有邮件列表的订阅。"),
        "emailDoesNotExist":
            MessageLookupByLibrary.simpleMessage("该邮箱账户不存在，请重试"),
        ...
        "emptyCartSubtitle":
            MessageLookupByLibrary.simpleMessage("看起来您还没有添加任何商品到购物车。开始购物吧！"),
        "emptyCartSubtitle02":
            MessageLookupByLibrary.simpleMessage("您的购物车还是空的哦。\n\n准备好开始购物了吗？"),
        "emptyComment": MessageLookupByLibrary.simpleMessage("评论不能为空"),
        "emptySearch":
            MessageLookupByLibrary.simpleMessage("您还没有搜索任何商品。让我们现在开始 - 我们会帮助您"),
        ...
        "emptyWishlistSubtitle":
            MessageLookupByLibrary.simpleMessage("点击商品旁边的心形图标收藏。我们会为您保存在这里！"),
        "emptyWishlistSubtitle02":
            MessageLookupByLibrary.simpleMessage("您的收藏夹还没有任何商品。\n赶快收藏喜欢的商品吧！"),
        ...
        "endDateCantBeAfterFirstDate":
            MessageLookupByLibrary.simpleMessage("请选择结束日期"),
        "endsIn": m18,
        ...
        "failedToLoadAppConfig":
            MessageLookupByLibrary.simpleMessage("加载应用配置失败。请重试或重新启动应用。"),
        ...
        "myProductsEmpty":
            MessageLookupByLibrary.simpleMessage("您没有任何商品。尝试创建一个！"),
        ...
        "noAddressHaveBeenSaved":
            MessageLookupByLibrary.simpleMessage("还没有保存任何地址"),
        ...
        "noCameraPermissionIsGranted":
            MessageLookupByLibrary.simpleMessage("未授予相机权限。请在设备的设置中授予它。"),
        ...
        "notifyLatestOffer":
            MessageLookupByLibrary.simpleMessage("通知最新优惠和商品可用性"),
        ...
        "paymentDetailsChangedSuccessfully":
            MessageLookupByLibrary.simpleMessage("支付信息已更新"),
        "paymentMethod": MessageLookupByLibrary.simpleMessage("支付方式"),
        "paymentMethodIsNotSupported":
            MessageLookupByLibrary.simpleMessage("不支持此支付方式"),
        ...
        "phoneNumberVerification":
            MessageLookupByLibrary.simpleMessage("手机号码验证"),
        ...
        "pleaseSignInBeforeUploading":
            MessageLookupByLibrary.simpleMessage("请在上传文件前先登录您的账户"),
        "point": MessageLookupByLibrary.simpleMessage("积分"),
        "pointMsgConfigNotFound":
            MessageLookupByLibrary.simpleMessage("服务器未找到积分配置"),
        "pointMsgEnter": MessageLookupByLibrary.simpleMessage("请输入积分"),
        "pointMsgMaximumDiscountPoint":
            MessageLookupByLibrary.simpleMessage("最大优惠积分"),
        "pointMsgNotEnough":
            MessageLookupByLibrary.simpleMessage("您的积分不足，当前总积分为"),
        "pointMsgOverMaximumDiscountPoint":
            MessageLookupByLibrary.simpleMessage("您已达到最大优惠积分"),
        "pointMsgOverTotalBill":
            MessageLookupByLibrary.simpleMessage("总优惠值超过账单总额"),
        "pointMsgRemove": MessageLookupByLibrary.simpleMessage("积分已移除"),
        "pointMsgSuccess": MessageLookupByLibrary.simpleMessage("积分使用成功"),
        "pointRewardMessage":
            MessageLookupByLibrary.simpleMessage("将积分应用到购物车的优惠规则"),
        ...
        "posAddressToolTip":
            MessageLookupByLibrary.simpleMessage("此地址将保存到您的本地设备，不会作为用户地址使用"),
        ...
        "productCreateReview":
            MessageLookupByLibrary.simpleMessage("商品审核通过后将显示"),
        "productExpired":
        ...
        "productNeedAtLeastOneVariation":
            MessageLookupByLibrary.simpleMessage("商品变体类型至少需要一个变体"),
        ...
        "quantityProductExceedInStock":
            MessageLookupByLibrary.simpleMessage("当前数量超过库存数量"),
        ...
        "requestTooMany":
            MessageLookupByLibrary.simpleMessage("您在短时间内请求次数过多，请稍后再试"),
        ...
        "searchEmptyDataMessage":
            MessageLookupByLibrary.simpleMessage("抱歉，没有找到相关结果"),
        ...
        "thisPlatformNotSupportWebview":
            MessageLookupByLibrary.simpleMessage("此平台不支持网页浏览"),
        ...
        "transferErrorMessage":
            MessageLookupByLibrary.simpleMessage("无法转账给此用户"),
        ...
        "whichLanguageDoYouPrefer":
            MessageLookupByLibrary.simpleMessage("您更喜欢哪种语言？"),
        ...
        "youHaveBeenSaveAddressYourLocal":
            MessageLookupByLibrary.simpleMessage("您的地址已保存到本地"),
        ...
        "youNeedToLoginCheckout":
            MessageLookupByLibrary.simpleMessage("需要登录才能结账"),
        "youNotBeAsked": MessageLookupByLibrary.simpleMessage("下次将不再询问"),
        "yourAccountIsUnderReview":
            MessageLookupByLibrary.simpleMessage("您的账户正在审核中。如需帮助，请联系管理员。"),
        "yourAddressExistYourLocal":
            MessageLookupByLibrary.simpleMessage("您的地址已存在于本地"),
        ...
        "yourOrderIsEmptyMsg":
            MessageLookupByLibrary.simpleMessage("您的购物车还是空的。\n开始购物吧！"),
