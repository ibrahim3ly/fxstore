...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(point) => "Sinu saadaval olevad punktid: ${point}";

  static String m3(state) => "Bluetooth-adapter on ${state}";

  static String m4(author) => "Autor: ${author}";

  static String m7(currency) => "Valuuta muudetud ${currency}";

  static String m8(number) => "${number} tähemärki jäänud";

  static String m9(priceRate, pointRate) =>
      "${priceRate} = ${pointRate} punkti";

  static String m10(count) => "${count} ese";

  static String m11(count) => "${count} eset";

  static String m12(count) => "${count} toode";

  static String m13(count) => "${count} toodet";

  static String m14(country) => "${country} pole toetatud";

  static String m15(currency) => "${currency} pole toetatud";

  static String m16(day) => "${day} päeva tagasi";

  static String m17(total) => "~${total} km";

  static String m18(timeLeft) => "Lõppeb ${timeLeft} pärast";

  static String m19(captcha) => "Sisesta kinnitamiseks ${captcha}:";

  static String m20(message) => "Viga: ${message}";

  static String m21(message) => "Viga: ${message}";

  static String m22(time) => "Aegub ${time} pärast";

  static String m23(total) => ">${total} km";

  static String m24(hour) => "${hour} tundi tagasi";
  ...
  static String m28(size) => "Maksimaalne faili suurus: ${size} MB";

  static String m30(currency, amount) =>
      "Selle makseviisi kasutamiseks on miinimumsumma ${currency} ${amount}";

  static String m31(minute) => "${minute} minutit tagasi";

  static String m32(month) => "${month} kuud tagasi";

  static String m33(store) => "Rohkem poest ${store}";

  static String m34(number) => "Peab ostma ${number} kaupa";

  static String m35(itemCount) => "${itemCount} toodet";

  static String m36(price) => "Valikute kogusumma: ${price}";

  static String m37(amount) => "Maksa ${amount}";

  static String m38(name) => "${name} on lisatud ostukorvi";

  static String m39(total) => "Kogus: ${total}";

  static String m40(name) => "Sai raha kasutajalt ${name}";

  static String m42(percent) => "Müügil ${percent}%";

  static String m43(keyword) => "Otsingutulemused: \'${keyword}\'";

  static String m44(keyword, count) => "${keyword} (${count} ese)";

  static String m45(keyword, count) => "${keyword} (${count} eset)";

  static String m46(second) => "${second} sekundit tagasi";

  static String m47(totalCartQuantity) =>
      "Ostukorv, ${totalCartQuantity} toodet";

  static String m48(numberOfUnitsSold) => "Müüdud: ${numberOfUnitsSold}";

  static String m49(fieldName) => "Väli ${fieldName} on kohustuslik";

  static String m50(total) => "${total} toodet";

  static String m51(name) => "Kanna raha üle kasutajale ${name}";
  ...
  static String m53(date) => "Kehtib kuni ${date}";

  static String m55(balance) => "Rahakoti saldo: ${balance}";

  static String m56(message) => "Hoiatus: ${message}";
  ...
  static String m58(length) => "Leidsime ${length} toodet";

  static String m59(week) => "Nädal ${week}";

  static String m60(name) => "Tere tulemast, ${name}";

  static String m61(year) => "${year} aastat tagasi";

  static String m63(total) => "Oled määratud tellimusele #${total}";

  static String m64(point) => "Sul on ${point} punkti";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "accountApprovalTitle":
            MessageLookupByLibrary.simpleMessage("Konto kinnitamisel"),
        ...
        "addToCartSuccessfully":
            MessageLookupByLibrary.simpleMessage("Edukalt ostukorvi lisatud"),
        "addToOrder": MessageLookupByLibrary.simpleMessage("Lisa tellimusse"),
        "addToQuoteRequest":
            MessageLookupByLibrary.simpleMessage("Lisa hinnapäringusse"),
        "addToWishlist":
            MessageLookupByLibrary.simpleMessage("Lisa soovinimekirja"),
        "added": MessageLookupByLibrary.simpleMessage("Lisatud"),
        "addedSuccessfully":
            MessageLookupByLibrary.simpleMessage("Edukalt lisatud"),
        "addingYourImage":
            MessageLookupByLibrary.simpleMessage("Lisa oma pilt"),
        ...
        "allowCameraAccess":
            MessageLookupByLibrary.simpleMessage("Lubada kaamera juurdepääs?"),
        "almostSoldOut":
        ...
        "approvedRequests":
            MessageLookupByLibrary.simpleMessage("Kinnitatud taotlused"),
        ...
        "backToWallet":
            MessageLookupByLibrary.simpleMessage("Tagasi rahakotti"),
        "bagsCollections":
            MessageLookupByLibrary.simpleMessage("Kottide kollektsioonid"),
        "balance": MessageLookupByLibrary.simpleMessage("Saldo"),
        "bank": MessageLookupByLibrary.simpleMessage("Pank"),
        "bannerListType":
            MessageLookupByLibrary.simpleMessage("Bannerite loendi tüüp"),
        "bannerType": MessageLookupByLibrary.simpleMessage("Banneri tüüp"),
        "bannerYoutubeURL":
            MessageLookupByLibrary.simpleMessage("Banneri YouTube\'i URL"),
        ...
        "byAppointmentOnly":
            MessageLookupByLibrary.simpleMessage("Ainult broneeringuga"),
        "byAuthor": m4,
        ...
        "callToVendor":
            MessageLookupByLibrary.simpleMessage("Helista poe omanikule"),
        "canNotCreateOrder":
        ...
        "canNotGetShipping":
            MessageLookupByLibrary.simpleMessage("Tarneviise ei saa hankida"),
        ...
        "cartDiscount":
            MessageLookupByLibrary.simpleMessage("Ostukorvi allahindlus"),
        ...
        "chatViaWhatApp":
            MessageLookupByLibrary.simpleMessage("Vestle WhatsAppi kaudu"),
        "chatWithBot": MessageLookupByLibrary.simpleMessage("Vestlusrobot"),
        "chatWithStoreOwner":
            MessageLookupByLibrary.simpleMessage("Vestle poe omanikuga"),
        ...
        "chooseYourPaymentMethod":
            MessageLookupByLibrary.simpleMessage("Vali oma makseviis"),
        "city": MessageLookupByLibrary.simpleMessage("Linn"),
        "cityIsRequired":
            MessageLookupByLibrary.simpleMessage("Linn on kohustuslik"),
        ...
        "codExtraFee":
            MessageLookupByLibrary.simpleMessage("Lunamaksu lisatasu"),
        ...
        "continueToPayment":
            MessageLookupByLibrary.simpleMessage("Jätka makseni"),
        "continueToReview":
            MessageLookupByLibrary.simpleMessage("Jätka ülevaateni"),
        "continueToShipping":
            MessageLookupByLibrary.simpleMessage("Jätka tarneni"),
        ...
        "countryCodeIsRequired":
            MessageLookupByLibrary.simpleMessage("Riigikood on kohustuslik"),
        "countryIsNotSupported": m14,
        "countryIsRequired":
            MessageLookupByLibrary.simpleMessage("Riik on kohustuslik"),
        ...
        "couponInvalid":
            MessageLookupByLibrary.simpleMessage("Sinu sooduskood on kehtetu"),
        ...
        "dateWiseClose":
            MessageLookupByLibrary.simpleMessage("Sulge kuupäeva järgi"),
        "daysAgo": m16,
        ...
        "deliveryDetails":
            MessageLookupByLibrary.simpleMessage("Tarne üksikasjad"),
        ...
        "doYouWantToLogout":
            MessageLookupByLibrary.simpleMessage("Kas soovid välja logida?"),
        ...
        "dontHaveAccount":
            MessageLookupByLibrary.simpleMessage("Kas sul pole kontot?"),
        ...
        "emailAddressInvalid":
            MessageLookupByLibrary.simpleMessage("E-posti aadress on vigane"),
        ...
        "emailIsRequired":
            MessageLookupByLibrary.simpleMessage("E-post on kohustuslik"),
        "emailSubscription":
            MessageLookupByLibrary.simpleMessage("E-posti tellimus"),
        ...
        "emptyWishlist":
            MessageLookupByLibrary.simpleMessage("Soovinimekiri on tühi"),
        "emptyWishlistSubtitle": MessageLookupByLibrary.simpleMessage(
            "Klõpsa toote kõrval olevat südant, et see lemmikutesse lisada. Salvestame need sulle siia!"),
        ...
        "enableVacationMode":
            MessageLookupByLibrary.simpleMessage("Luba puhkuserežiim"),
        ...
        "enterSentCode":
            MessageLookupByLibrary.simpleMessage("Sisesta saadetud kood"),
        "enterVoucherCode":
            MessageLookupByLibrary.simpleMessage("Sisesta soodustuskood"),
        "enterYourEmail":
            MessageLookupByLibrary.simpleMessage("Sisesta oma e-post"),
        "enterYourEmailOrUsername": MessageLookupByLibrary.simpleMessage(
            "Sisesta oma e-post või kasutajanimi"),
        "enterYourFirstName":
            MessageLookupByLibrary.simpleMessage("Sisesta oma eesnimi"),
        "enterYourLastName":
            MessageLookupByLibrary.simpleMessage("Sisesta oma perekonnanimi"),
        ...
        "enterYourUsername":
            MessageLookupByLibrary.simpleMessage("Sisesta oma kasutajanimi"),
        "error": m20,
        ...
        "errorMsg": m21,
        "errorOnGettingPost":
            MessageLookupByLibrary.simpleMessage("Viga postituse laadimisel!"),
        ...
        "expectedDeliveryDate":
            MessageLookupByLibrary.simpleMessage("Eeldatav tarnekuupäev"),
        ...
        "failedToLoadImage":
            MessageLookupByLibrary.simpleMessage("Pildi laadimine ebaõnnestus"),
        ...
        "finishSetup":
            MessageLookupByLibrary.simpleMessage("Lõpeta seadistamine"),
        ...
        "firstNameIsRequired":
            MessageLookupByLibrary.simpleMessage("Eesnimi on kohustuslik"),
        ...
        "generatingLink":
            MessageLookupByLibrary.simpleMessage("Lingi genereerimine..."),
        "german": MessageLookupByLibrary.simpleMessage("Saksa"),
        "getNotification":
            MessageLookupByLibrary.simpleMessage("Saa teavitusi"),
        "getNotified": MessageLookupByLibrary.simpleMessage("Saa teavitusi!"),
        "getPasswordLink":
            MessageLookupByLibrary.simpleMessage("Hangi parooli link"),
        ...
        "goBackToAddress":
            MessageLookupByLibrary.simpleMessage("Tagasi aadressini"),
        "goBackToReview":
            MessageLookupByLibrary.simpleMessage("Tagasi ülevaateni"),
        "goBackToShipping":
            MessageLookupByLibrary.simpleMessage("Tagasi tarneni"),
        ...
        "informationTable": MessageLookupByLibrary.simpleMessage("Info tabel"),
        ...
        "invalidPhoneNumber":
            MessageLookupByLibrary.simpleMessage("Vale telefoninumber"),
        "invalidSMSCode":
            MessageLookupByLibrary.simpleMessage("Vale SMS-kinnituskood"),
        "invalidYearOfBirth":
            MessageLookupByLibrary.simpleMessage("Vale sünniaasta"),
        "invoice": MessageLookupByLibrary.simpleMessage("Arve"),
        "isEverythingSet":
            MessageLookupByLibrary.simpleMessage("Kas kõik on seadistatud...?"),
        ...
        "languageSuccess":
            MessageLookupByLibrary.simpleMessage("Keel on edukalt muudetud"),
        ...
        "latestProducts":
            MessageLookupByLibrary.simpleMessage("Uusimad tooted"),
        ...
        "loadingLink":
            MessageLookupByLibrary.simpleMessage("Lingi laadimine..."),
        ...
        "loginToContinue":
            MessageLookupByLibrary.simpleMessage("Jätkamiseks logi sisse"),
        "loginToReview":
            MessageLookupByLibrary.simpleMessage("Arvustamiseks logi sisse"),
        "loginToYourAccount":
            MessageLookupByLibrary.simpleMessage("Logi oma kontole"),
        "logout": MessageLookupByLibrary.simpleMessage("Logi välja"),
        "malay": MessageLookupByLibrary.simpleMessage("Malai"),
        "manCollections":
            MessageLookupByLibrary.simpleMessage("Meeste kollektsioonid"),
        ...
        "mobileVerification":
            MessageLookupByLibrary.simpleMessage("Mobiilne kinnitamine"),
        ...
        "multipleSellersDetected":
            MessageLookupByLibrary.simpleMessage("Leitud mitu müüjat"),
        ...
        "mustSelectOneItem":
            MessageLookupByLibrary.simpleMessage("Pead valima 1 üksuse"),
        ...
        "noPaymentMethodsAvailable":
            MessageLookupByLibrary.simpleMessage("Maksemeetodid pole saadaval"),
        ...
        "noResultFound":
            MessageLookupByLibrary.simpleMessage("Tulemusi ei leitud"),
        "noReviews": MessageLookupByLibrary.simpleMessage("Arvustusi pole"),
        "noSlotAvailable":
            MessageLookupByLibrary.simpleMessage("Ühtegi vaba kohta pole"),
        "noStoreNearby":
            MessageLookupByLibrary.simpleMessage("Läheduses pole poode!"),
        "noSuggestionSearch":
            MessageLookupByLibrary.simpleMessage("Soovitusi pole"),
        ...
        "orderDetail":
            MessageLookupByLibrary.simpleMessage("Tellimuse üksikasjad"),
        "orderHistory":
        ...
        "orderStatusCanceledReversal":
            MessageLookupByLibrary.simpleMessage("Tühistatud tagasipööramine"),
        "orderStatusCancelled":
            MessageLookupByLibrary.simpleMessage("Tühistatud"),
        "orderStatusChargeBack":
            MessageLookupByLibrary.simpleMessage("Tagasimakse"),
        ...
        "orderStatusFailed":
            MessageLookupByLibrary.simpleMessage("Ebaõnnestunud"),
        ...
        "orderStatusPendingPayment":
            MessageLookupByLibrary.simpleMessage("Ootel makse"),
        "orderStatusProcessed":
            MessageLookupByLibrary.simpleMessage("Töödeldud"),
        "orderStatusProcessing":
            MessageLookupByLibrary.simpleMessage("Töötlemisel"),
        "orderStatusRefunded":
            MessageLookupByLibrary.simpleMessage("Tagastatud"),
        "orderStatusReversed":
            MessageLookupByLibrary.simpleMessage("Tagasi pööratud"),
        ...
        "ourBankDetails":
            MessageLookupByLibrary.simpleMessage("Meie pangaandmed"),
        ...
        "passwordIsRequired":
            MessageLookupByLibrary.simpleMessage("Parool on kohustuslik"),
        "passwordsDoNotMatch":
            MessageLookupByLibrary.simpleMessage("Paroolid ei ühti"),
        "pasteYourImageUrl":
            MessageLookupByLibrary.simpleMessage("Kleebi oma pildi URL"),
        ...
        "paymentMethodIsNotSupported":
            MessageLookupByLibrary.simpleMessage("See makseviis pole toetatud"),
        ...
        "phoneHintFormat":
            MessageLookupByLibrary.simpleMessage("Formaat: +372XXXXXXXX"),
        ...
        "pleaseAddPrice":
            MessageLookupByLibrary.simpleMessage("Palun lisa hind"),
        ...
        "pleaseChooseBranch":
            MessageLookupByLibrary.simpleMessage("Vali filiaal"),
        "pleaseChooseCategory":
            MessageLookupByLibrary.simpleMessage("Palun vali kategooria"),
        "pleaseEnterProductName":
            MessageLookupByLibrary.simpleMessage("Palun sisesta toote nimi"),
        "pleaseFillCode":
            MessageLookupByLibrary.simpleMessage("Palun sisesta oma kood"),
        ...
        "pointMsgEnter":
            MessageLookupByLibrary.simpleMessage("Palun sisesta sooduspunkt"),
        "pointMsgMaximumDiscountPoint":
            MessageLookupByLibrary.simpleMessage("Maksimaalne sooduspunkt"),
        ...
        "pointMsgRemove":
            MessageLookupByLibrary.simpleMessage("Sooduspunkt on eemaldatud"),
        ...
        "postImageFeature":
            MessageLookupByLibrary.simpleMessage("Pildi funktsioon"),
        "postManagement":
            MessageLookupByLibrary.simpleMessage("Postituste haldamine"),
        ...
        "priceHighToLow":
            MessageLookupByLibrary.simpleMessage("Hind: Kõrgest madalani"),
        "priceLowToHigh":
            MessageLookupByLibrary.simpleMessage("Hind: Madalast kõrgeni"),
        ...
        "productNameCanNotEmpty":
            MessageLookupByLibrary.simpleMessage("Toote nimi ei saa olla tühi"),
        "productNeedAtLeastOneVariation": MessageLookupByLibrary.simpleMessage(
            "Toote tüüp vajab vähemalt ühte varianti"),
        "productNeedNameAndPrice": MessageLookupByLibrary.simpleMessage(
            "Lihtne toote tüüp vajab nime ja tavahinda"),
        "productOutOfStock":
            MessageLookupByLibrary.simpleMessage("See toode on läbi müüdud"),
        "productOverview":
        ...
        "pullToLoadMore":
            MessageLookupByLibrary.simpleMessage("Tõmba, et laadida rohkem"),
        ...
        "readyToPick":
            MessageLookupByLibrary.simpleMessage("Valmis komplekteerimiseks"),
        ...
        "recentSearches":
            MessageLookupByLibrary.simpleMessage("Viimased otsingud"),
        "recentView":
            MessageLookupByLibrary.simpleMessage("Sinu hiljutised vaatamised"),
        "recentlyViewed":
        ...
        "releaseToLoadMore":
            MessageLookupByLibrary.simpleMessage("Vabasta, et laadida rohkem"),
        ...
        "reviewApproval":
            MessageLookupByLibrary.simpleMessage("Arvustuse heakskiitmine"),
        "reviewPendingApproval": MessageLookupByLibrary.simpleMessage(
            "Sinu arvustus on saadetud ja ootab heakskiitu!"),
        "reviewSent":
            MessageLookupByLibrary.simpleMessage("Sinu arvustus on saadetud!"),
        ...
        "saveForLater":
            MessageLookupByLibrary.simpleMessage("Salvesta hilisemaks"),
        ...
        "searchByCountryNameOrDialCode": MessageLookupByLibrary.simpleMessage(
            "Otsi riigi nime või suunakoodiga"),
        "searchByName":
        ...
        "searchingAddress":
            MessageLookupByLibrary.simpleMessage("Otsin aadressi"),
        "secondsAgo": m46,
        ...
        "selectFileCancelled":
            MessageLookupByLibrary.simpleMessage("Faili valimine tühistatud!"),
        ...
        "selectVoucher":
            MessageLookupByLibrary.simpleMessage("Vali soodustuskood"),
        ...
        "shortDescription":
            MessageLookupByLibrary.simpleMessage("Lühikirjeldus"),
        "showAllMyOrdered":
            MessageLookupByLibrary.simpleMessage("Näita kõiki minu tellimusi"),
        ...
        "signInWithEmail":
            MessageLookupByLibrary.simpleMessage("Logi sisse e-postiga"),
        ...
        "speechNotAvailable":
            MessageLookupByLibrary.simpleMessage("Kõnetuvastus pole saadaval"),
        "startExploring":
        ...
        "stateIsRequired":
            MessageLookupByLibrary.simpleMessage("Maakond on kohustuslik"),
        ...
        "storeLocatorSearchPlaceholder":
            MessageLookupByLibrary.simpleMessage("Sisesta aadress või linn"),
        ...
        "storeSliderBanner":
            MessageLookupByLibrary.simpleMessage("Poe liuguribanner"),
        "storeStaticBanner":
        ...
        "streetIsRequired":
            MessageLookupByLibrary.simpleMessage("Tänava nimi on kohustuslik"),
        ...
        "submitYourPost":
            MessageLookupByLibrary.simpleMessage("Esita oma postitus"),
        ...
        "thisProductNotSupport":
            MessageLookupByLibrary.simpleMessage("See toode pole toetatud"),
        ...
        "transactionDetail":
            MessageLookupByLibrary.simpleMessage("Tehingu üksikasjad"),
        "transactionFailded":
        ...
        "turnOnBle":
            MessageLookupByLibrary.simpleMessage("Lülita Bluetooth sisse"),
        "typeAMessage":
        ...
        "unblockUser":
            MessageLookupByLibrary.simpleMessage("Eemalda kasutaja blokeering"),
        ...
        "updateFailed":
            MessageLookupByLibrary.simpleMessage("Uuendamine ebaõnnestus!"),
        ...
        "usernameInvalid":
            MessageLookupByLibrary.simpleMessage("Kasutajanimi on vigane"),
        "usernameIsRequired":
            MessageLookupByLibrary.simpleMessage("Kasutajanimi on kohustuslik"),
        "vacationMessage":
        ...
        "verificationCode":
            MessageLookupByLibrary.simpleMessage("Kinnituskood (6 numbrit)"),
        ...
        "waitForLoad":
            MessageLookupByLibrary.simpleMessage("Ootan piltide laadimist"),
        "waitForPost":
            MessageLookupByLibrary.simpleMessage("Ootan toote lisamist"),
        ...
        "weNeedCameraAccessTo": MessageLookupByLibrary.simpleMessage(
            "Vajame kaamera juurdepääsu QR-koodi või triipkoodi skannimiseks."),
        "weSentAnOTPTo":
            MessageLookupByLibrary.simpleMessage("Kinnituskood on saadetud"),
        ...
        "whichLanguageDoYouPrefer":
            MessageLookupByLibrary.simpleMessage("Millist keelt eelistad?"),
        ...
        "withdrawAmount":
            MessageLookupByLibrary.simpleMessage("Väljavõetav summa"),
        "withdrawRequest":
            MessageLookupByLibrary.simpleMessage("Väljavõtmise taotlus"),
        "withdrawal": MessageLookupByLibrary.simpleMessage("Väljavõtmine"),
        "womanCollections":
            MessageLookupByLibrary.simpleMessage("Naiste kollektsioonid"),
        "writeComment":
            MessageLookupByLibrary.simpleMessage("Kirjuta oma kommentaar"),
        "writeYourNote":
            MessageLookupByLibrary.simpleMessage("Kirjuta oma märkus"),
        "yearsAgo": m61,
        "yes": MessageLookupByLibrary.simpleMessage("Jah"),
        "youCanOnlyOrderSingleStore": MessageLookupByLibrary.simpleMessage(
            "Saad osta ainult ühest poest."),
        "youCanOnlyPurchase":
            MessageLookupByLibrary.simpleMessage("Saad osta ainult"),
        ...
        "youHaveNoPost":
            MessageLookupByLibrary.simpleMessage("Sul pole postitusi"),
        "youHavePoints": m64,
        "youMightAlsoLike":
            MessageLookupByLibrary.simpleMessage("Sulle võib meeldida ka"),
        ...
        "yourBookingDetail":
            MessageLookupByLibrary.simpleMessage("Sinu broneeringu üksikasjad"),
        "yourEarningsThisMonth":
            MessageLookupByLibrary.simpleMessage("Sinu teenistus sel kuul"),
        "yourNote": MessageLookupByLibrary.simpleMessage("Sinu märkus"),
        "yourOrderHasBeenAdded":
            MessageLookupByLibrary.simpleMessage("Sinu tellimus on lisatud"),
        "yourOrderIsConfirmed": MessageLookupByLibrary.simpleMessage(
            "Sinu tellimus on kinnitatud!"),
        "yourOrderIsEmpty":
            MessageLookupByLibrary.simpleMessage("Sinu tellimus on tühi"),
        ...
        "yourProductIsUnderReview":
            MessageLookupByLibrary.simpleMessage("Sinu toode on ülevaatamisel"),
        "yourUsernameEmail": MessageLookupByLibrary.simpleMessage(
            "Sinu kasutajanimi või e-post"),
        "zipCode": MessageLookupByLibrary.simpleMessage("Postiindeks"),
        "zipCodeIsRequired":
            MessageLookupByLibrary.simpleMessage("Postiindeks on kohustuslik")
      };
}
