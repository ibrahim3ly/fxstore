...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(state) => "מתאם בלוטות\' הוא ${state}";

  static String m4(author) => "מאת: ${author}";

  static String m5(fieldName) => "${fieldName} אינו יכול להיות ריק";

  static String m6(fieldName) => "${fieldName} חייב להכיל לפחות 3 תווים";

  static String m7(currency) => "המטבע שונה ל-${currency}";

  static String m8(number) => "נותרו ${number} תווים";
  ...
  static String m12(count) => "פריט ${count}";

  static String m13(count) => "${count} פריטים";

  static String m14(country) => "המדינה ${country} אינה נתמכת";

  static String m15(currency) => "${currency} אינו נתמך";

  static String m16(day) => "לפני ${day} ימים";

  static String m17(total) => "~${total} ק\"מ";

  static String m18(timeLeft) => "מסתיים בעוד ${timeLeft}";

  static String m19(captcha) => "הזן ${captcha} לאישור:";

  static String m20(message) => "שגיאה: ${message}";

  static String m21(message) => "שגיאה: ${message}";

  static String m22(time) => "יפוג בעוד ${time}";

  static String m23(total) => "יותר מ-${total} ק\"מ";

  static String m24(hour) => "לפני ${hour} שעות";

  static String m25(currentBalance) => "נותרו לך רק ${currentBalance} בארנק";
  ...
  static String m28(size) => "גודל קובץ מקסימלי: ${size} מגה בייט";
  ...
  static String m31(minute) => "לפני ${minute} דקות";

  static String m32(month) => "לפני ${month} חודשים";

  static String m33(store) => "עוד מ-${store}";

  static String m34(number) => "חייב להירכש בקבוצות של ${number}";

  static String m35(itemCount) => "${itemCount} פריטים";

  static String m36(price) => "סה״כ אפשרויות: ${price}";

  static String m37(amount) => "שלם ${amount}";

  static String m38(name) => "${name} נוסף לעגלה בהצלחה";

  static String m39(total) => "כמות: ${total}";

  static String m40(name) => "התקבל תשלום מ-${name}";

  static String m41(count) =>
      "האם ברצונך להסיר ${count} פריטים מרשימת המשאלות?";

  static String m42(percent) => "הנחה ${percent}%";

  static String m43(keyword) => "תוצאות חיפוש עבור: \'${keyword}\'";

  static String m44(keyword, count) => "${keyword} (${count} פריט)";

  static String m45(keyword, count) => "${keyword} (${count} פריטים)";

  static String m46(second) => "לפני ${second} שניות";

  static String m47(totalCartQuantity) =>
      "עגלת קניות, ${totalCartQuantity} פריטים";

  static String m48(numberOfUnitsSold) => "נמכר: ${numberOfUnitsSold}";

  static String m49(fieldName) => "השדה ${fieldName} נדרש";

  static String m50(total) => "${total} מוצרים";

  static String m51(name) => "העבר כסף אל ${name}";
  ...
  static String m53(date) => "תקף עד ${date}";

  static String m54(number) => "גרסה ${number}";

  static String m55(balance) => "יתרת ארנק: ${balance}";

  static String m56(message) => "אזהרה: ${message}";

  static String m57(defaultCurrency) =>
      "המטבע שנבחר כרגע אינו זמין עבור תכונת הארנק, אנא שנה אותו ל-${defaultCurrency}";

  static String m58(length) => "מצאנו ${length} מוצרים";

  static String m59(week) => "שבוע ${week}";

  static String m60(name) => "ברוך הבא ${name}";

  static String m61(year) => "לפני ${year} שנים";

  static String m62(count) => "אתה בוחר ${count} פריטים";

  static String m63(total) => "הוקצית להזמנה מספר ${total}";

  static String m64(point) => "יש לך ${point} נקודות";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "accountApprovalTitle":
            MessageLookupByLibrary.simpleMessage("ממתין לאישור"),
        ...
        "addToCartMaximum":
            MessageLookupByLibrary.simpleMessage("חרגת מהכמות המרבית"),
        "addToCartSuccessfully":
            MessageLookupByLibrary.simpleMessage("נוסף לעגלה בהצלחה"),
        ...
        "addingYourImage": MessageLookupByLibrary.simpleMessage("הוספת תמונה"),
        ...
        "agreeWithPrivacy":
            MessageLookupByLibrary.simpleMessage("פרטיות ותנאים"),
        ...
        "audioDetected": MessageLookupByLibrary.simpleMessage(
            "זוהה קובץ אודיו. האם ברצונך להוסיף לנגן האודיו?"),
        ...
        "bagsCollections": MessageLookupByLibrary.simpleMessage("אוספי תיקים"),
        "balance": MessageLookupByLibrary.simpleMessage("יתרה"),
        "bank": MessageLookupByLibrary.simpleMessage("בנק"),
        "bannerListType":
            MessageLookupByLibrary.simpleMessage("סוג רשימת באנר"),
        "bannerType": MessageLookupByLibrary.simpleMessage("סוג באנר"),
        "bannerYoutubeURL":
            MessageLookupByLibrary.simpleMessage("כתובת יוטיוב לבאנר"),
        ...
        "bleHasNotBeenEnabled":
            MessageLookupByLibrary.simpleMessage("בלוטות\' לא הופעל"),
        "bleState": m3,
        ...
        "canNotCreateOrder":
            MessageLookupByLibrary.simpleMessage("לא ניתן ליצור הזמנה"),
        "canNotCreateUser":
        ...
        "canNotGetToken":
            MessageLookupByLibrary.simpleMessage("לא ניתן לקבל מידע טוקן."),
        "canNotLaunch": MessageLookupByLibrary.simpleMessage(
            "לא ניתן להפעיל את האפליקציה. וודא שההגדרות ב-config.dart נכונות"),
        "canNotLoadThisLink":
            MessageLookupByLibrary.simpleMessage("לא ניתן לטעון קישור זה"),
        ...
        "cantPickDateInThePast":
            MessageLookupByLibrary.simpleMessage("תאריך בעבר אינו מותר"),
        ...
        "chatListScreen":
            MessageLookupByLibrary.simpleMessage("מסך רשימת צ\'אט"),
        "chatViaFacebook":
            MessageLookupByLibrary.simpleMessage("צ\'אט דרך פייסבוק מסנג\'ר"),
        "chatViaWhatApp":
            MessageLookupByLibrary.simpleMessage("צ\'אט דרך וואטסאפ"),
        "chatWithBot": MessageLookupByLibrary.simpleMessage("שוחח עם הבוט"),
        "chatWithStoreOwner":
            MessageLookupByLibrary.simpleMessage("שוחח עם בעל החנות"),
        "checkConfirmLink": MessageLookupByLibrary.simpleMessage(
            "בדוק בדוא״ל שלך את קישור האישור"),
        "checking": MessageLookupByLibrary.simpleMessage("בודק..."),
        "checkout": MessageLookupByLibrary.simpleMessage("לקופה"),
        "chinese": MessageLookupByLibrary.simpleMessage("סינית"),
        "chineseSimplified":
            MessageLookupByLibrary.simpleMessage("סינית מפושטת"),
        "chineseTraditional":
            MessageLookupByLibrary.simpleMessage("סינית מסורתית"),
        ...
        "chooseYourPaymentMethod":
            MessageLookupByLibrary.simpleMessage("בחר את אמצעי התשלום שלך"),
        ...
        "confirmAccountDeletion":
            MessageLookupByLibrary.simpleMessage("אשר מחיקת חשבון"),
        "confirmClearCartWhenTopUp":
            MessageLookupByLibrary.simpleMessage("העגלה תתרוקן בעת הטעינה."),
        ...
        "confirmPasswordIsRequired":
            MessageLookupByLibrary.simpleMessage("נדרש אימות סיסמה"),
        ...
        "continueToReview":
            MessageLookupByLibrary.simpleMessage("המשך לביקורת"),
        "continueToSelectItem":
            MessageLookupByLibrary.simpleMessage("המשך לבחירת פריט"),
        "continueToShipping":
            MessageLookupByLibrary.simpleMessage("המשך למשלוח"),
        ...
        "countryCodeIsRequired":
            MessageLookupByLibrary.simpleMessage("נדרש קוד מדינה"),
        "countryIsNotSupported": m14,
        "countryIsRequired":
            MessageLookupByLibrary.simpleMessage("שדה מדינה נדרש"),
        ...
        "couponInvalid":
            MessageLookupByLibrary.simpleMessage("קוד הקופון שלך אינו תקין"),
        "couponMsgSuccess":
            MessageLookupByLibrary.simpleMessage("הקופון הופעל בהצלחה"),
        ...
        "createReviewSuccess":
            MessageLookupByLibrary.simpleMessage("תודה על הביקורת שלך"),
        "createReviewSuccessMsg": MessageLookupByLibrary.simpleMessage(
            "אנו מעריכים מאוד את המשוב שלך ואת תרומתך לשיפור השירות שלנו"),
        "createVariants":
            MessageLookupByLibrary.simpleMessage("צור את כל הווריאנטים"),
        ...
        "deliveryManagement":
            MessageLookupByLibrary.simpleMessage("ניהול משלוחים"),
        ...
        "downloadingImages":
            MessageLookupByLibrary.simpleMessage("מוריד תמונות..."),
        ...
        "emailAddressInvalid":
            MessageLookupByLibrary.simpleMessage("כתובת הדוא\"ל אינה תקינה"),
        "emailAlreadyInUse":
            MessageLookupByLibrary.simpleMessage("כתובת הדוא\"ל כבר בשימוש!"),
        "emailDeleteDescription": MessageLookupByLibrary.simpleMessage(
            "מחיקת חשבונך תבטל את הרישום שלך מכל רשימות התפוצה."),
        "emailDoesNotExist": MessageLookupByLibrary.simpleMessage(
            "חשבון הדוא״ל שהזנת אינו קיים. אנא נסה שוב."),
        "emailIsRequired":
            MessageLookupByLibrary.simpleMessage("שדה דוא״ל נדרש"),
        "emailSubscription":
            MessageLookupByLibrary.simpleMessage("מנוי אימייל"),
        ...
        "emptyUsername":
            MessageLookupByLibrary.simpleMessage("שם משתמש/דוא״ל ריק"),
        "emptyWishlist":
            MessageLookupByLibrary.simpleMessage("רשימת המשאלות ריקה"),
        ...
        "enableForCheckout":
            MessageLookupByLibrary.simpleMessage("אפשר לתשלום"),
        ...
        "enableVacationMode":
            MessageLookupByLibrary.simpleMessage("הפעל מצב חופשה"),
        ...
        "enterVoucherCode":
            MessageLookupByLibrary.simpleMessage("הכנס קוד שובר"),
        "enterYourEmail":
            MessageLookupByLibrary.simpleMessage("הזן את הדוא״ל שלך"),
        "enterYourEmailOrUsername": MessageLookupByLibrary.simpleMessage(
            "הזן את הדוא\"ל או שם המשתמש שלך"),
        "enterYourFirstName":
            MessageLookupByLibrary.simpleMessage("הזן את שמך הפרטי"),
        "enterYourLastName":
        ...
        "featureNotAvailable":
            MessageLookupByLibrary.simpleMessage("תכונה זו אינה זמינה"),
        "featureProducts":
        ...
        "fingerprintsTouchID":
            MessageLookupByLibrary.simpleMessage("טביעות אצבע וזיהוי מגע"),
        ...
        "firstNameIsRequired":
            MessageLookupByLibrary.simpleMessage("שדה שם פרטי נדרש"),
        "firstRenewal": MessageLookupByLibrary.simpleMessage("חידוש ראשון"),
        "fixedCartDiscount":
            MessageLookupByLibrary.simpleMessage("הנחת עגלה קבועה"),
        "fixedProductDiscount":
            MessageLookupByLibrary.simpleMessage("הנחת מוצר קבועה"),
        ...
        "generatingLink":
            MessageLookupByLibrary.simpleMessage("מייצר קישור..."),
        ...
        "getPasswordLink":
            MessageLookupByLibrary.simpleMessage("קבל קישור לאיפוס סיסמה"),
        ...
        "incorrectPassword":
            MessageLookupByLibrary.simpleMessage("סיסמה שגויה"),
        ...
        "invalidSMSCode":
            MessageLookupByLibrary.simpleMessage("קוד אימות SMS לא תקין"),
        "invalidYearOfBirth":
            MessageLookupByLibrary.simpleMessage("שנת לידה לא חוקית"),
        "invoice": MessageLookupByLibrary.simpleMessage("חשבונית"),
        "isEverythingSet":
            MessageLookupByLibrary.simpleMessage("האם הכל מוגדר...?"),
        ...
        "lastNameIsRequired":
            MessageLookupByLibrary.simpleMessage("שדה שם משפחה נדרש"),
        "lastTransactions":
            MessageLookupByLibrary.simpleMessage("עסקאות אחרונות"),
        "latestProducts":
            MessageLookupByLibrary.simpleMessage("מוצרים אחרונים"),
        ...
        "listBannerType":
            MessageLookupByLibrary.simpleMessage("סוג רשימת באנר"),
        "listBannerVideo":
            MessageLookupByLibrary.simpleMessage("רשימת סרטוני באנר"),
        ...
        "loginToComment":
            MessageLookupByLibrary.simpleMessage("אנא התחבר כדי להגיב"),
        "loginToContinue":
            MessageLookupByLibrary.simpleMessage("אנא התחבר כדי להמשיך"),
        "loginToReview":
            MessageLookupByLibrary.simpleMessage("אנא התחבר כדי לכתוב ביקורת"),
        "loginToYourAccount":
        ...
        "manCollections": MessageLookupByLibrary.simpleMessage("אוספי גברים"),
        ...
        "mobileIsRequired":
            MessageLookupByLibrary.simpleMessage("נדרש מספר נייד"),
        "mobileNumberInUse":
            MessageLookupByLibrary.simpleMessage("מספר הנייד כבר בשימוש!"),
        "mobileVerification":
        ...
        "mustSelectOneItem":
            MessageLookupByLibrary.simpleMessage("חובה לבחור פריט אחד"),
        ...
        "noAddressHaveBeenSaved":
            MessageLookupByLibrary.simpleMessage("טרם נשמרו כתובות"),
        "noBackHistoryItem":
            MessageLookupByLibrary.simpleMessage("אין פריט היסטוריה אחורה"),
        ...
        "noConversation":
            MessageLookupByLibrary.simpleMessage("אין שיחות עדיין"),
        ...
        "noListingNearby":
            MessageLookupByLibrary.simpleMessage("אין רישומים בקרבת מקום!"),
        ...
        "noResultFound":
            MessageLookupByLibrary.simpleMessage("לא נמצאו תוצאות"),
        ...
        "notFindResult":
            MessageLookupByLibrary.simpleMessage("מצטערים, לא נמצאו תוצאות"),
        ...
        "oneEachRecipient":
            MessageLookupByLibrary.simpleMessage("אחד לכל נמען"),
        ...
        "orderStatusCanceledReversal":
            MessageLookupByLibrary.simpleMessage("ביטול חזרה"),
        "orderStatusCancelled": MessageLookupByLibrary.simpleMessage("בוטל"),
        "orderStatusChargeBack":
            MessageLookupByLibrary.simpleMessage("חיוב חוזר"),
        ...
        "orderStatusProcessing": MessageLookupByLibrary.simpleMessage("מעבד"),
        ...
        "orderSuccessMsg2": MessageLookupByLibrary.simpleMessage(
            "תוכל להיכנס לחשבונך באמצעות דוא״ל וסיסמה שהוגדרו קודם. בחשבונך תוכל לערוך את פרטי הפרופיל שלך, לבדוק היסטוריית עסקאות ולערוך את ההרשמה לניוזלטר."),
        "orderSuccessTitle1":
            MessageLookupByLibrary.simpleMessage("ביצעת את ההזמנה בהצלחה"),
        "orderSuccessTitle2":
        ...
        "passwordIsRequired":
            MessageLookupByLibrary.simpleMessage("נדרשת סיסמה"),
        "passwordsDoNotMatch":
            MessageLookupByLibrary.simpleMessage("הסיסמאות אינן תואמות"),
        "pasteYourImageUrl":
            MessageLookupByLibrary.simpleMessage("הדבק את כתובת התמונה שלך"),
        ...
        "paymentDetailsChangedSuccessfully":
            MessageLookupByLibrary.simpleMessage("פרטי התשלום עודכנו בהצלחה"),
        ...
        "paymentSuccessful":
            MessageLookupByLibrary.simpleMessage("התשלום בוצע בהצלחה"),
        "pending": MessageLookupByLibrary.simpleMessage("ממתין"),
        "pendingReviews":
            MessageLookupByLibrary.simpleMessage("ביקורות ממתינות"),
        ...
        "phoneHintFormat":
            MessageLookupByLibrary.simpleMessage("פורמט: +972501234567"),
        "phoneIsRequired":
            MessageLookupByLibrary.simpleMessage("שדה מספר טלפון נדרש"),
        ...
        "pleaseAgreeTerms":
            MessageLookupByLibrary.simpleMessage("אנא הסכם לתנאים שלנו"),
        "pleaseAllowAccessCameraGallery": MessageLookupByLibrary.simpleMessage(
            "אנא אפשר גישה למצלמה ולגלריה"),
        "pleaseCheckInternet":
            MessageLookupByLibrary.simpleMessage("אנא בדוק את חיבור האינטרנט!"),
        "pleaseChooseBranch":
            MessageLookupByLibrary.simpleMessage("אנא בחר סניף"),
        ...
        "pleaseFillCode":
            MessageLookupByLibrary.simpleMessage("אנא הזן את הקוד שלך"),
        ...
        "pleaseInput":
            MessageLookupByLibrary.simpleMessage("אנא מלא את כל השדות"),
        ...
        "pointMsgEnter":
            MessageLookupByLibrary.simpleMessage("אנא הזן נקודות הנחה"),
        ...
        "pointMsgOverMaximumDiscountPoint":
            MessageLookupByLibrary.simpleMessage("הגעת לנקודת ההנחה המקסימלית"),
        "pointMsgOverTotalBill": MessageLookupByLibrary.simpleMessage(
            "ערך ההנחה הכולל גדול מסכום החשבון"),
        "pointMsgRemove":
            MessageLookupByLibrary.simpleMessage("נקודת ההנחה הוסרה"),
        "pointMsgSuccess":
            MessageLookupByLibrary.simpleMessage("נקודת ההנחה הוחלה בהצלחה"),
        ...
        "postFail":
            MessageLookupByLibrary.simpleMessage("יצירת הפוסט שלך נכשלה"),
        ...
        "priceLowToHigh":
            MessageLookupByLibrary.simpleMessage("מחיר: נמוך לגבוה"),
        ...
        "productCreateReview":
            MessageLookupByLibrary.simpleMessage("המוצר שלך יופיע לאחר בדיקה."),
        ...
        "pullToLoadMore":
            MessageLookupByLibrary.simpleMessage("משוך כדי לטעון עוד"),
        "qRCodeMsgSuccess":
        ...
        "ratingFirst":
            MessageLookupByLibrary.simpleMessage("אנא דרג לפני שליחת התגובה"),
        ...
        "recentView":
            MessageLookupByLibrary.simpleMessage("הצפייה האחרונה שלך"),
        ...
        "regenerateResponse":
            MessageLookupByLibrary.simpleMessage("צור תגובה מחדש"),
        ...
        "relatedLayoutTitle":
            MessageLookupByLibrary.simpleMessage("דברים שאולי תאהב"),
        "releaseToLoadMore":
            MessageLookupByLibrary.simpleMessage("שחרר כדי לטעון עוד"),
        "remove": MessageLookupByLibrary.simpleMessage("הסר"),
        "removeFromWishList":
            MessageLookupByLibrary.simpleMessage("הסר מרשימת המשאלות"),
        "removeWishlist":
            MessageLookupByLibrary.simpleMessage("הסר מרשימת המשאלות"),
        ...
        "saveAddressSuccess":
            MessageLookupByLibrary.simpleMessage("הכתובת נשמרה"),
        "saveForLater":
            MessageLookupByLibrary.simpleMessage("שמור למועד מאוחר יותר"),
        ...
        "searchInput":
            MessageLookupByLibrary.simpleMessage("אנא הקלד טקסט בשדה החיפוש"),
        "searchOrderId":
        ...
        "selectFileCancelled":
            MessageLookupByLibrary.simpleMessage("בחירת קובץ בוטלה!"),
        ...
        "shareProductData":
            MessageLookupByLibrary.simpleMessage("שתף נתוני מוצר"),
        "shareProductLink":
            MessageLookupByLibrary.simpleMessage("שתף קישור למוצר"),
        ...
        "shopSlug":
            MessageLookupByLibrary.simpleMessage("כתובת מקוצרת של החנות"),
        ...
        "signInWithEmail":
            MessageLookupByLibrary.simpleMessage("התחבר באמצעות דוא״ל"),
        ...
        "storeInformation":
            MessageLookupByLibrary.simpleMessage("מידע על החנות"),
        "storeListBanner":
            MessageLookupByLibrary.simpleMessage("באנר רשימת חנויות"),
        "storeLocation": MessageLookupByLibrary.simpleMessage("מיקום החנות"),
        "storeLocatorSearchPlaceholder":
            MessageLookupByLibrary.simpleMessage("הזן כתובת או עיר"),
        "storeLogo": MessageLookupByLibrary.simpleMessage("לוגו החנות"),
        "storeMobileBanner":
            MessageLookupByLibrary.simpleMessage("באנר נייד של החנות"),
        "storeSettings": MessageLookupByLibrary.simpleMessage("הגדרות חנות"),
        "storeSliderBanner":
            MessageLookupByLibrary.simpleMessage("באנר סליידר של החנות"),
        "storeStaticBanner":
            MessageLookupByLibrary.simpleMessage("באנר סטטי של החנות"),
        ...
        "submitYourPost":
            MessageLookupByLibrary.simpleMessage("שלח את הפוסט שלך"),
        ...
        "thisIsVendorRole":
            MessageLookupByLibrary.simpleMessage("זהו תפקיד הספק"),
        "thisPlatformNotSupportWebview": MessageLookupByLibrary.simpleMessage(
            "פלטפורמה זו אינה תומכת בתצוגת אינטרנט"),
        "thisProductNotSupport":
            MessageLookupByLibrary.simpleMessage("מוצר זה אינו נתמך"),
        ...
        "transferMoneyTo": m51,
        "transferSuccess":
            MessageLookupByLibrary.simpleMessage("העברה בוצעה בהצלחה"),
        ...
        "usernameAndPasswordRequired":
            MessageLookupByLibrary.simpleMessage("נדרשים שם משתמש וסיסמה"),
        "usernameInvalid":
            MessageLookupByLibrary.simpleMessage("שם המשתמש אינו תקין"),
        "usernameIsRequired":
        ...
        "viewRecentTransactions":
            MessageLookupByLibrary.simpleMessage("צפה בעסקאות אחרונות"),
        ...
        "waitForPost":
            MessageLookupByLibrary.simpleMessage("ממתין לפרסום המוצר"),
        ...
        "whichLanguageDoYouPrefer":
            MessageLookupByLibrary.simpleMessage("באיזו שפה תעדיף?"),
        ...
        "youCanOnlyPurchase":
            MessageLookupByLibrary.simpleMessage("ניתן לרכוש רק"),
        ...
        "youHaveBeenSaveAddressYourLocal":
            MessageLookupByLibrary.simpleMessage("שמרת את הכתובת"),
        "youHaveNoPost": MessageLookupByLibrary.simpleMessage("אין לך פוסטים"),
        "youHavePoints": m64,
        "youMightAlsoLike":
            MessageLookupByLibrary.simpleMessage("אולי תאהב גם"),
        "youNeedToLoginCheckout":
            MessageLookupByLibrary.simpleMessage("עליך להתחבר כדי לבצע רכישה"),
        ...
        "yourAddressExistYourLocal":
            MessageLookupByLibrary.simpleMessage("הכתובת שלך קיימת"),
        "yourAddressHasBeenSaved": MessageLookupByLibrary.simpleMessage(
            "הכתובת נשמרה באחסון המקומי שלך"),
        "yourApplicationIsUnderReview":
            MessageLookupByLibrary.simpleMessage("הבקשה שלך נמצאת בבדיקה."),
        "yourBagIsEmpty":
        ...
        "yourOrderIsConfirmed":
            MessageLookupByLibrary.simpleMessage("הזמנתך אושרה!"),
        "yourOrderIsEmpty": MessageLookupByLibrary.simpleMessage("הזמנתך ריקה"),
        ...
        "zipCodeIsRequired":
            MessageLookupByLibrary.simpleMessage("שדה מיקוד נדרש")
      };
}
