...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(attribute) => "${attribute} ใดๆ";

  static String m2(point) => "คะแนนที่คุณมี: ${point}";

  static String m3(state) => "อะแดปเตอร์บลูทูธ ${state}";

  static String m4(author) => "ผู้แต่ง : ${author}";

  static String m5(fieldName) => "${fieldName} ไม่สามารถว่างเปล่าได้";

  static String m6(fieldName) => "${fieldName} ความยาวต้องไม่น้อยกว่า 3";

  static String m7(currency) => "เปลี่ยนสกุลเงินเป็น ${currency}";

  static String m8(number) => "เหลืออักขระอีก ${number} ตัว";

  static String m9(priceRate, pointRate) => "${priceRate} = ${pointRate} คะแนน";

  static String m10(count) => "${count} รายการ";

  static String m11(count) => "${count} รายการ";

  static String m12(count) => "${count} รายการ";

  static String m13(count) => "${count} รายการ";

  static String m14(country) => "ไม่รองรับประเทศ ${country}";

  static String m15(currency) => "ไม่รองรับสกุลเงิน ${currency}";

  static String m16(day) => "${day} วันที่แล้ว";

  static String m17(total) => "~${total} กม.";

  static String m18(timeLeft) => "Ends in ${timeLeft}";

  static String m19(captcha) => "ป้อน ${captcha} เพื่อยืนยัน:";

  static String m20(message) => "ข้อผิดพลาด: ${message}";

  static String m21(message) => "ข้อผิดพลาด: ${message}";

  static String m22(time) => "จะหมดอายุใน ${time}";

  static String m23(total) => ">${total} กม.";

  static String m24(hour) => "${hour} ชั่วโมงที่แล้ว";
  ...
  static String m28(size) => "ขนาดไฟล์สูงสุด: ${size} MB";
  ...
  static String m31(minute) => "${minute} นาทีที่แล้ว";

  static String m32(month) => "${month} เดือนที่แล้ว";

  static String m33(store) => "สินค้าเพิ่มเติมจาก ${store}";

  static String m34(number) => "ต้องซื้อเป็นกลุ่มจำนวน ${number}";

  static String m35(itemCount) => "${itemCount} รายการ";

  static String m36(price) => "ราคารวมตัวเลือก: ${price}";

  static String m37(amount) => "ชำระเงิน ${amount}";

  static String m38(name) => " เพิ่ม${name} ลงในรถเข็นเรียบร้อยแล้ว";

  static String m39(total) => "จำนวน: ${total}";

  static String m40(name) => "ได้รับเงินจาก ${name}";

  static String m41(count) =>
      "คุณต้องการลบรายการ ${count} รายการออกจากรายการสิ่งที่อยากได้ของคุณหรือไม่?";

  static String m42(percent) => "ลด ${percent}%";

  static String m43(keyword) => "ผลการค้นหาสำหรับ: \'${keyword}\'";

  static String m44(keyword, count) => "${keyword} (${count} รายการ)";

  static String m45(keyword, count) => "${keyword} (${count} รายการ)";

  static String m46(second) => "${second} วินาทีที่แล้ว";
  ...
  static String m49(fieldName) => "ต้องกรอกช่อง ${fieldName}";

  static String m50(total) => "สินค้าทั้งหมด ${total} รายการ";

  static String m51(name) => "โอนเงินไปที่ ${name}";
  ...
  static String m53(date) => "ใช้ได้จนถึง ${date}";

  static String m54(number) => "เวอร์ชัน ${number}";

  static String m55(balance) => "ยอดเงินในกระเป๋าเงิน: ${balance}";

  static String m56(message) => "คำเตือน: ${message}";

  static String m57(defaultCurrency) =>
      "สกุลเงินที่เลือกไม่สามารถใช้กับคุณสมบัติกระเป๋าเงินได้ กรุณาเปลี่ยนเป็น ${defaultCurrency}";

  static String m58(length) => "เราพบสินค้า ${length} รายการ";

  static String m59(week) => "สัปดาห์ที่ ${week}";

  static String m60(name) => "ยินดีต้อนรับ ${name}";

  static String m61(year) => "${year} ปีที่แล้ว";

  static String m62(count) => "คุณกำลังเลือก ${count} รายการ";

  static String m63(total) => "คุณได้รับมอบหมายคำสั่งซื้อ #${total}";

  static String m64(point) => "คุณมี \$point points";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "activeFor": m0,
        "activeLongAgo":
            MessageLookupByLibrary.simpleMessage("ใช้งานมานานแล้ว"),
        ...
        "addToCartMaximum":
            MessageLookupByLibrary.simpleMessage("เกินปริมาณสูงสุด"),
        ...
        "addToQuoteRequest":
            MessageLookupByLibrary.simpleMessage("เพิ่มในคำขอใบเสนอราคา"),
        "addToWishlist":
        ...
        "addingYourImage":
            MessageLookupByLibrary.simpleMessage("กำลังเพิ่มรูปภาพของคุณ"),
        ...
        "attributeAlreadyExists":
            MessageLookupByLibrary.simpleMessage("มีคุณลักษณะนี้อยู่แล้ว"),
        ...
        "backToWallet":
            MessageLookupByLibrary.simpleMessage("กลับไปที่กระเป๋าเงิน"),
        "bagsCollections":
        ...
        "bannerYoutubeURL":
            MessageLookupByLibrary.simpleMessage("URL แบนเนอร์ Youtube"),
        "basicInformation":
            MessageLookupByLibrary.simpleMessage("ข้อมูลพื้นฐาน"),
        "becomeAVendor":
            MessageLookupByLibrary.simpleMessage("สมัครเป็นผู้ขาย"),
        "bengali": MessageLookupByLibrary.simpleMessage("เบงกาลี"),
        "billingAddress":
            MessageLookupByLibrary.simpleMessage("ที่อยู่สำหรับออกใบเสร็จ"),
        ...
        "byAppointmentOnly":
            MessageLookupByLibrary.simpleMessage("เฉพาะการนัดหมายเท่านั้น"),
        "byAuthor": m4,
        ...
        "bySignup":
            MessageLookupByLibrary.simpleMessage("การลงทะเบียนถือว่าคุณยอมรับ"),
        ...
        "canNotCreateOrder":
            MessageLookupByLibrary.simpleMessage("ไม่สามารถสร้างคำสั่งซื้อได้"),
        "canNotCreateUser":
        ...
        "canNotGetToken":
            MessageLookupByLibrary.simpleMessage("ไม่สามารถดึงข้อมูลโทเค็นได้"),
        "canNotLaunch": MessageLookupByLibrary.simpleMessage(
            "ไม่สามารถเปิดแอปนี้ได้ โปรดตรวจสอบการตั้งค่าของคุณใน config.dart ให้ถูกต้อง"),
        "canNotLoadThisLink":
            MessageLookupByLibrary.simpleMessage("ไม่สามารถโหลดลิงก์นี้ได้"),
        ...
        "chineseTraditional":
            MessageLookupByLibrary.simpleMessage("จีนตัวเต็ม"),
        ...
        "chooseFromGallery":
            MessageLookupByLibrary.simpleMessage("เลือกจากแกลเลอรี่"),
        "chooseFromServer":
        ...
        "cityIsRequired":
            MessageLookupByLibrary.simpleMessage("จำเป็นต้องระบุชื่อเมือง"),
        ...
        "clearConversation":
            MessageLookupByLibrary.simpleMessage("ล้างการสนทนา"),
        ...
        "commentFirst":
            MessageLookupByLibrary.simpleMessage("กรุณาเขียนความคิดเห็นของคุณ"),
        ...
        "confirmPasswordIsRequired":
            MessageLookupByLibrary.simpleMessage("ต้องยืนยันรหัสผ่าน"),
        ...
        "continueToPayment":
            MessageLookupByLibrary.simpleMessage("ดำเนินการชำระเงิน"),
        "continueToReview":
            MessageLookupByLibrary.simpleMessage("ดำเนินการตรวจสอบ"),
        "continueToSelectItem": MessageLookupByLibrary.simpleMessage(
            "ดำเนินการต่อเพื่อเลือกสินค้า"),
        "continueToShipping":
            MessageLookupByLibrary.simpleMessage("ดำเนินการจัดส่ง"),
        ...
        "countryIsRequired":
            MessageLookupByLibrary.simpleMessage("จำเป็นต้องระบุชื่อประเทศ"),
        ...
        "couponInvalid":
            MessageLookupByLibrary.simpleMessage("รหัสคูปองไม่ถูกต้อง"),
        ...
        "createReviewSuccess":
            MessageLookupByLibrary.simpleMessage("ขอบคุณสำหรับรีวิวของคุณ"),
        "createReviewSuccessMsg": MessageLookupByLibrary.simpleMessage(
            "ขอบคุณสำหรับข้อมูลของคุณ เราให้ความสำคัญกับความคิดเห็นของคุณในการปรับปรุงบริการของเรา"),
        "createVariants":
            MessageLookupByLibrary.simpleMessage("สร้างตัวเลือกทั้งหมด"),
        ...
        "currentlyWeOnlyHave":
            MessageLookupByLibrary.simpleMessage("ขณะนี้เรามีเพียง"),
        ...
        "doNotAnyTransactions":
            MessageLookupByLibrary.simpleMessage("คุณยังไม่มีธุรกรรมใดๆ"),
        "doYouWantToExitApp":
            MessageLookupByLibrary.simpleMessage("คุณต้องการออกจากแอปหรือไม่"),
        ...
        "downloadingImages":
            MessageLookupByLibrary.simpleMessage("กำลังดาวน์โหลดรูปภาพ..."),
        "draft": MessageLookupByLibrary.simpleMessage("ร่าง"),
        "driverAssigned":
            MessageLookupByLibrary.simpleMessage("มอบหมายคนขับแล้ว"),
        ...
        "editProductInfo":
            MessageLookupByLibrary.simpleMessage("แก้ไขข้อมูลสินค้า"),
        ...
        "emailIsRequired":
            MessageLookupByLibrary.simpleMessage("จำเป็นต้องระบุอีเมล"),
        "emailSubscription":
            MessageLookupByLibrary.simpleMessage("การสมัครรับข่าวสารทางอีเมล"),
        ...
        "emptyUsername":
            MessageLookupByLibrary.simpleMessage("ชื่อผู้ใช้ว่างเปล่า"),
        ...
        "enableForWallet":
            MessageLookupByLibrary.simpleMessage("เปิดใช้งานสำหรับกระเป๋าเงิน"),
        "enableVacationMode":
            MessageLookupByLibrary.simpleMessage("เปิดโหมดวันหยุด"),
        ...
        "enterSentCode":
            MessageLookupByLibrary.simpleMessage("ป้อนรหัสที่ถูกส่งไปยัง"),
        "enterVoucherCode":
            MessageLookupByLibrary.simpleMessage("กรอกรหัสบัตรกำนัล"),
        "enterYourEmail":
            MessageLookupByLibrary.simpleMessage("กรอกอีเมลของคุณ"),
        "enterYourEmailOrUsername":
            MessageLookupByLibrary.simpleMessage("ใส่อีเมลหรือชื่อผู้ใช้"),
        "enterYourFirstName":
            MessageLookupByLibrary.simpleMessage("ใส่ชื่อจริง"),
        "enterYourLastName": MessageLookupByLibrary.simpleMessage("ใส่นามสกุล"),
        "enterYourMobile":
            MessageLookupByLibrary.simpleMessage("กรุณาใส่เบอร์โทรศัพท์มือถือ"),
        "enterYourPassword":
            MessageLookupByLibrary.simpleMessage("กรอกรหัสผ่านของคุณ"),
        "enterYourPhone": MessageLookupByLibrary.simpleMessage(
            "กรอกหมายเลขโทรศัพท์ของคุณเพื่อเริ่มต้น"),
        "enterYourPhoneNumber":
            MessageLookupByLibrary.simpleMessage("ใส่เบอร์โทรศัพท์"),
        "enterYourUsername":
        ...
        "failToAssign":
            MessageLookupByLibrary.simpleMessage("ไม่สามารถมอบหมายผู้ใช้ได้"),
        "failedToGenerateLink":
            MessageLookupByLibrary.simpleMessage("ไม่สามารถสร้างลิงก์ได้"),
        "failedToLoadAppConfig": MessageLookupByLibrary.simpleMessage(
            "ไม่สามารถโหลดการตั้งค่าแอปพลิเคชันได้ กรุณาลองอีกครั้งหรือรีสตาร์ทแอปพลิเคชัน"),
        "failedToLoadImage":
            MessageLookupByLibrary.simpleMessage("ไม่สามารถโหลดรูปภาพได้"),
        ...
        "featureNotAvailable":
            MessageLookupByLibrary.simpleMessage("ฟีเจอร์นี้ไม่พร้อมใช้งาน"),
        ...
        "firstNameIsRequired":
            MessageLookupByLibrary.simpleMessage("จำเป็นต้องระบุชื่อ"),
        ...
        "generatingLink":
            MessageLookupByLibrary.simpleMessage("กำลังสร้างลิงก์..."),
        ...
        "goBackToAddress":
            MessageLookupByLibrary.simpleMessage("กลับไปที่ที่อยู่"),
        "goBackToReview":
            MessageLookupByLibrary.simpleMessage("กลับไปที่รีวิว"),
        "goBackToShipping":
        ...
        "invalidPhoneNumber":
            MessageLookupByLibrary.simpleMessage("เบอร์โทรศัพท์ไม่ถูกต้อง"),
        "invalidSMSCode":
            MessageLookupByLibrary.simpleMessage("รหัส SMS ไม่ถูกต้อง"),
        "invalidYearOfBirth":
        ...
        "iwantToCreateAccount":
            MessageLookupByLibrary.simpleMessage("ฉันต้องการสร้างบัญชี"),
        ...
        "languageSuccess":
            MessageLookupByLibrary.simpleMessage("อัปเดตภาษาเรียบร้อยแล้ว"),
        "lao": MessageLookupByLibrary.simpleMessage("ลาว"),
        "lastName": MessageLookupByLibrary.simpleMessage("นามสกุล"),
        "lastNameIsRequired":
            MessageLookupByLibrary.simpleMessage("จำเป็นต้องระบุนามสกุล"),
        "lastTransactions":
        ...
        "listBannerType":
            MessageLookupByLibrary.simpleMessage("ประเภทแบนเนอร์แบบรายการ"),
        "listBannerVideo":
            MessageLookupByLibrary.simpleMessage("รายการวิดีโอแบนเนอร์"),
        "listMessages":
            MessageLookupByLibrary.simpleMessage("ข้อความแจ้งเตือน"),
        ...
        "loadingLink":
            MessageLookupByLibrary.simpleMessage("กำลังโหลดลิงก์..."),
        "location": MessageLookupByLibrary.simpleMessage("ตำแหน่งที่ตั้ง"),
        "lockScreenAndSecurity":
            MessageLookupByLibrary.simpleMessage("การล็อกหน้าจอและความปลอดภัย"),
        "login": MessageLookupByLibrary.simpleMessage("เข้าสู่ระบบ"),
        "loginCanceled":
            MessageLookupByLibrary.simpleMessage("การเข้าสู่ระบบถูกยกเลิก"),
        "loginErrorServiceProvider": m26,
        "loginFailed":
            MessageLookupByLibrary.simpleMessage("เข้าสู่ระบบไม่สำเร็จ!"),
        "loginInvalid": MessageLookupByLibrary.simpleMessage(
            "คุณไม่ได้รับอนุญาตให้ใช้แอปนี้"),
        "loginRequired":
            MessageLookupByLibrary.simpleMessage("จำเป็นต้องเข้าสู่ระบบ"),
        "loginSuccess":
        ...
        "loginToYourAccount":
            MessageLookupByLibrary.simpleMessage("เข้าสู่บัญชีของคุณ"),
        "logout": MessageLookupByLibrary.simpleMessage("ออกจากระบบ"),
        "malay": MessageLookupByLibrary.simpleMessage("มาเลย์"),
        "manCollections":
            MessageLookupByLibrary.simpleMessage("คอลเลกชันผู้ชาย"),
        ...
        "mustSelectOneItem":
            MessageLookupByLibrary.simpleMessage("ต้องเลือกอย่างน้อย 1 รายการ"),
        ...
        "nearbyPlaces":
            MessageLookupByLibrary.simpleMessage("สถานที่ใกล้เคียง"),
        "needHelp":
        ...
        "noBackHistoryItem":
            MessageLookupByLibrary.simpleMessage("ไม่มีประวัติการย้อนกลับ"),
        ...
        "noFavoritesYet":
            MessageLookupByLibrary.simpleMessage("ยังไม่มีรายการโปรด"),
        "noFileToDownload":
            MessageLookupByLibrary.simpleMessage("ไม่มีไฟล์ให้ดาวน์โหลด"),
        "noForwardHistoryItem":
            MessageLookupByLibrary.simpleMessage("ไม่มีประวัติการส่งต่อ"),
        "noInternetConnection": MessageLookupByLibrary.simpleMessage(
            "ไม่มีการเชื่อมต่ออินเทอร์เน็ต"),
        "noListingNearby":
            MessageLookupByLibrary.simpleMessage("ไม่พบรายการใกล้เคียง!"),
        ...
        "notFindResult":
            MessageLookupByLibrary.simpleMessage("ขออภัย ไม่พบผลลัพธ์"),
        ...
        "orderConfirmation":
            MessageLookupByLibrary.simpleMessage("ยืนยันคำสั่งซื้อ"),
        ...
        "orderStatusProcessing":
            MessageLookupByLibrary.simpleMessage("กำลังดำเนินการ"),
        "orderStatusRefunded":
            MessageLookupByLibrary.simpleMessage("คืนเงินแล้ว"),
        ...
        "payByWallet":
            MessageLookupByLibrary.simpleMessage("ชำระด้วยกระเป๋าเงิน"),
        ...
        "pendingReviews":
            MessageLookupByLibrary.simpleMessage("กำลังรอการพิจารณา"),
        "persian": MessageLookupByLibrary.simpleMessage("เปอร์เซีย"),
        "phone": MessageLookupByLibrary.simpleMessage("โทรศัพท์"),
        "phoneEmpty":
            MessageLookupByLibrary.simpleMessage("ไม่มีเบอร์โทรศัพท์"),
        "phoneHintFormat":
            MessageLookupByLibrary.simpleMessage("รูปแบบ: +66123456789"),
        "phoneIsRequired":
            MessageLookupByLibrary.simpleMessage("จำเป็นต้องระบุเบอร์โทรศัพท์"),
        "phoneNumber": MessageLookupByLibrary.simpleMessage("หมายเลขโทรศัพท์"),
        "phoneNumberVerification":
            MessageLookupByLibrary.simpleMessage("การยืนยันหมายเลขโทรศัพท์"),
        ...
        "pleaseAgreeTerms":
            MessageLookupByLibrary.simpleMessage("โปรดยอมรับเงื่อนไขของเรา"),
        ...
        "pleaseEnterProductName":
            MessageLookupByLibrary.simpleMessage("กรุณาใส่ชื่อสินค้า"),
        "pleaseFillCode":
            MessageLookupByLibrary.simpleMessage("โปรดใส่รหัสของคุณ"),
        ...
        "pleaseInput":
            MessageLookupByLibrary.simpleMessage("โปรดกรอกข้อมูลในทุกช่อง"),
        "pleaseInputFillAllFields":
            MessageLookupByLibrary.simpleMessage("โปรดกรอกข้อมูลในทุกช่อง"),
        "pleaseSelectADate":
            MessageLookupByLibrary.simpleMessage("กรุณาเลือกวันที่จอง"),
        "pleaseSelectALocation":
            MessageLookupByLibrary.simpleMessage("กรุณาเลือกตำแหน่งที่ตั้ง"),
        ...
        "pointMsgEnter":
            MessageLookupByLibrary.simpleMessage("กรุณาใส่จุดส่วนลด"),
        "pointMsgMaximumDiscountPoint":
            MessageLookupByLibrary.simpleMessage("จุดส่วนลดสูงสุด"),
        "pointMsgNotEnough": MessageLookupByLibrary.simpleMessage(
            "คุณมีจุดส่วนลดไม่เพียงพอ จุดส่วนลดทั้งหมดของคุณคือ"),
        "pointMsgOverMaximumDiscountPoint":
            MessageLookupByLibrary.simpleMessage("คุณถึงจุดส่วนลดสูงสุดแล้ว"),
        "pointMsgOverTotalBill": MessageLookupByLibrary.simpleMessage(
            "มูลค่าส่วนลดรวมเกินกว่ายอดบิลทั้งหมด"),
        "pointMsgRemove":
            MessageLookupByLibrary.simpleMessage("จุดส่วนลดถูกลบออก"),
        "pointMsgSuccess":
            MessageLookupByLibrary.simpleMessage("ใช้จุดส่วนลดสำเร็จ"),
        ...
        "postSuccessfully":
            MessageLookupByLibrary.simpleMessage("สร้างโพสต์สำเร็จ"),
        ...
        "productNameCanNotEmpty":
            MessageLookupByLibrary.simpleMessage("ชื่อสินค้าต้องไม่ว่างเปล่า"),
        ...
        "qRCodeSaveFailure":
            MessageLookupByLibrary.simpleMessage("ไม่สามารถบันทึกรหัส QR ได้"),
        ...
        "refundRequested":
            MessageLookupByLibrary.simpleMessage("ขอคืนเงินแล้ว"),
        "refunds": MessageLookupByLibrary.simpleMessage("การคืนเงิน"),
        "regenerateResponse":
            MessageLookupByLibrary.simpleMessage("สร้างคำตอบใหม่"),
        ...
        "registerFailed":
            MessageLookupByLibrary.simpleMessage("ลงทะเบียนไม่สำเร็จ"),
        ...
        "relatedLayoutTitle":
            MessageLookupByLibrary.simpleMessage("สิ่งที่คุณอาจชอบ"),
        "releaseToLoadMore":
            MessageLookupByLibrary.simpleMessage("ปล่อยเพื่อโหลดเพิ่มเติม"),
        ...
        "reviewApproval":
            MessageLookupByLibrary.simpleMessage("การอนุมัติรีวิว"),
        "reviewPendingApproval": MessageLookupByLibrary.simpleMessage(
            "รีวิวของคุณถูกส่งแล้วและกำลังรอการอนุมัติ!"),
        "reviewSent":
            MessageLookupByLibrary.simpleMessage("รีวิวของคุณถูกส่งแล้ว!"),
        ...
        "saveToWishList":
            MessageLookupByLibrary.simpleMessage("บันทึกไปยังรายการโปรด"),
        "scannerCannotScan":
        ...
        "searchInput":
            MessageLookupByLibrary.simpleMessage("โปรดใส่ข้อความในช่องค้นหา"),
        "searchOrderId":
        ...
        "selectFileCancelled":
            MessageLookupByLibrary.simpleMessage("ยกเลิกการเลือกไฟล์แล้ว!"),
        ...
        "sendSMStoVendor":
            MessageLookupByLibrary.simpleMessage("ส่ง SMS ถึงผู้ขาย"),
        ...
        "shareProductData":
            MessageLookupByLibrary.simpleMessage("แบ่งปันข้อมูลผลิตภัณฑ์"),
        "shareProductLink":
            MessageLookupByLibrary.simpleMessage("แชร์ลิงค์ผลิตภัณฑ์"),
        ...
        "shortDescription":
            MessageLookupByLibrary.simpleMessage("คำอธิบายสั้นๆ"),
        "showAllMyOrdered":
            MessageLookupByLibrary.simpleMessage("แสดงคำสั่งซื้อทั้งหมด"),
        ...
        "speechNotAvailable":
            MessageLookupByLibrary.simpleMessage("ไม่สามารถใช้งานการพูดได้"),
        "startExploring": MessageLookupByLibrary.simpleMessage("เริ่มสำรวจ"),
        "startShopping":
            MessageLookupByLibrary.simpleMessage("เริ่มการช้อปปิ้ง"),
        "state": MessageLookupByLibrary.simpleMessage("สถานะ"),
        "stateIsRequired":
            MessageLookupByLibrary.simpleMessage("จำเป็นต้องระบุรัฐ"),
        ...
        "storeMobileBanner":
            MessageLookupByLibrary.simpleMessage("แบนเนอร์มือถือของร้านค้า"),
        "storeSettings": MessageLookupByLibrary.simpleMessage("ตั้งค่าร้านค้า"),
        "storeSliderBanner":
            MessageLookupByLibrary.simpleMessage("แบนเนอร์สไลด์ของร้านค้า"),
        "storeStaticBanner":
            MessageLookupByLibrary.simpleMessage("แบนเนอร์แบบคงที่ของร้านค้า"),
        ...
        "streetIsRequired":
            MessageLookupByLibrary.simpleMessage("จำเป็นต้องระบุชื่อถนน"),
        "streetName": MessageLookupByLibrary.simpleMessage("ชื่อถนน"),
        "streetNameApartment":
            MessageLookupByLibrary.simpleMessage("ชื่ออาคาร"),
        ...
        "tapTheMicToTalk":
            MessageLookupByLibrary.simpleMessage("แตะไมโครโฟนเพื่อพูด"),
        ...
        "thisProductNotSupport":
            MessageLookupByLibrary.simpleMessage("สินค้านี้ไม่รองรับ"),
        ...
        "transactionDetail":
            MessageLookupByLibrary.simpleMessage("รายละเอียดธุรกรรม"),
        "transactionFailded":
            MessageLookupByLibrary.simpleMessage("การทำธุรกรรมล้มเหลว"),
        "transactionFailed":
            MessageLookupByLibrary.simpleMessage("การทำธุรกรรมล้มเหลว"),
        "transactionFee":
            MessageLookupByLibrary.simpleMessage("ค่าธรรมเนียมธุรกรรม"),
        "transactionResult":
        ...
        "typeYourMessage":
            MessageLookupByLibrary.simpleMessage("พิมพ์ข้อความของคุณที่นี่..."),
        ...
        "updateFailed":
            MessageLookupByLibrary.simpleMessage("อัปเดตไม่สำเร็จ!"),
        ...
        "updateUserInfor":
            MessageLookupByLibrary.simpleMessage("อัปเดตโปรไฟล์"),
        ...
        "walletBalance":
            MessageLookupByLibrary.simpleMessage("ยอดเงินในกระเป๋าเงิน"),
        ...
        "weSentAnOTPTo":
            MessageLookupByLibrary.simpleMessage("ส่งรหัสยืนยันไปที่"),
        ...
        "womanCollections":
            MessageLookupByLibrary.simpleMessage("คอลเลกชันผู้หญิง"),
        "writeComment":
            MessageLookupByLibrary.simpleMessage("เขียนความคิดเห็นของคุณ"),
        "writeYourNote":
        ...
        "yourEarningsThisMonth":
            MessageLookupByLibrary.simpleMessage("รายได้ของคุณเดือนนี้"),
