...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m16(day) => "${day} ڕۆژ پێش ئێستا";

  static String m18(timeLeft) => "${timeLeft} تەواو دەبێت";

  static String m20(message) => "هەڵە: ${message}";

  static String m22(time) => "بەسەردەچێت لە ${time}";

  static String m24(hour) => "${hour} کاتژمێر پێش ئێستا";
  ...
  static String m31(minute) => "${minute} خولەك پێش ئێستا";

  static String m35(itemCount) => "${itemCount} ئایتم";

  static String m36(price) => "کۆى گشتى هەڵبژاردنەکان: ${price}";

  static String m42(percent) => "داشکاندن ${percent} %";

  static String m46(second) => "${second} چرکە پێش ئێستا";
  ...
  static String m50(total) => "${total} بەرهەمەکان";

  static String m53(date) => "گونجاوە تا ${date}";

  static String m56(message) => "ئاگاداری: ${message}";

  static String m58(length) => "${length} بەرهەم دۆزرایەوە";

  static String m64(point) => "تۆ هەندێك پۆینتت هەیە";
