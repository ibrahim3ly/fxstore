...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(point) => "Poin yang tersedia: ${point}";

  static String m3(state) => "Adapter Bluetooth ${state}";

  static String m4(author) => "Oleh: ${author}";
  ...
  static String m8(number) => "Tersisa ${number} karakter";

  static String m9(priceRate, pointRate) => "${priceRate} = ${pointRate} Poin";

  static String m10(count) => "${count} barang";

  static String m11(count) => "${count} barang";

  static String m12(count) => "${count} produk";

  static String m13(count) => "${count} produk";

  static String m14(country) => "${country} tidak didukung";

  static String m15(currency) => "${currency} tidak didukung";

  static String m16(day) => "${day} hari yang lalu";

  static String m17(total) => "~${total} km";

  static String m18(timeLeft) => "Berakhir dalam ${timeLeft}";
  ...
  static String m22(time) => "Berakhir dalam ${time}";

  static String m23(total) => ">${total} km";

  static String m24(hour) => "${hour} jam yang lalu";
  ...
  static String m31(minute) => "${minute} menit yang lalu";
  ...
  static String m35(itemCount) => "${itemCount} item";

  static String m36(price) => "Total opsi: ${price}";

  static String m37(amount) => "Bayar ${amount}";

  static String m38(name) => "${name} berhasil ditambahkan ke keranjang";
  ...
  static String m43(keyword) => "Hasil pencarian untuk: \'${keyword}\'";

  static String m44(keyword, count) => "${keyword} (${count} barang)";

  static String m45(keyword, count) => "${keyword} (${count} barang)";

  static String m46(second) => "${second} detik yang lalu";

  static String m47(totalCartQuantity) =>
      "Keranjang Belanja, ${totalCartQuantity} item";

  static String m48(numberOfUnitsSold) => "Terjual: ${numberOfUnitsSold}";
  ...
  static String m53(date) => "Berlaku hingga ${date}";

  static String m54(number) => "Versi ${number}";

  static String m55(balance) => "Saldo dompet: ${balance}";

  static String m56(message) => "Peringatan: ${message}";
  ...
  static String m58(length) => "Kami menemukan ${length} produk";

  static String m59(week) => "Minggu ${week}";

  static String m60(name) => "Selamat datang ${name}";

  static String m61(year) => "${year} tahun yang lalu";

  static String m62(count) => "Anda memilih ${count} item";

  static String m63(total) => "Anda telah ditugaskan untuk pesanan #${total}";

  static String m64(point) => "Anda memiliki ${point} poin";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "accountApprovalTitle":
            MessageLookupByLibrary.simpleMessage("Dalam proses persetujuan"),
        ...
        "addANewPost":
            MessageLookupByLibrary.simpleMessage("Tambah Postingan Baru"),
        ...
        "addNewPost":
            MessageLookupByLibrary.simpleMessage("Buat Postingan Baru"),
        ...
        "approvedRequests":
            MessageLookupByLibrary.simpleMessage("Permintaan Disetujui"),
        ...
        "bannerListType":
            MessageLookupByLibrary.simpleMessage("Jenis Daftar Banner"),
        ...
        "billingAddress":
            MessageLookupByLibrary.simpleMessage("Alamat Penagihan"),
        ...
        "byAppointmentOnly":
            MessageLookupByLibrary.simpleMessage("Hanya dengan Janji"),
        "byAuthor": m4,
        "byBrand": MessageLookupByLibrary.simpleMessage("Berdasarkan Merek"),
        "byCategory":
            MessageLookupByLibrary.simpleMessage("Berdasarkan Kategori"),
        ...
        "cartDiscount":
            MessageLookupByLibrary.simpleMessage("Diskon Keranjang"),
        ...
        "chatViaWhatApp":
            MessageLookupByLibrary.simpleMessage("Mengobrol melalui WhatsApp"),
        ...
        "chineseSimplified":
            MessageLookupByLibrary.simpleMessage("Bahasa Mandarin (Sederhana)"),
        ...
        "cityIsRequired":
            MessageLookupByLibrary.simpleMessage("Kota wajib diisi"),
        ...
        "continueToPayment":
            MessageLookupByLibrary.simpleMessage("Lanjut ke Pembayaran"),
        "continueToReview":
            MessageLookupByLibrary.simpleMessage("Lanjut ke Ulasan"),
        "continueToSelectItem":
            MessageLookupByLibrary.simpleMessage("Lanjutkan memilih item"),
        "continueToShipping":
            MessageLookupByLibrary.simpleMessage("Lanjut ke Pengiriman"),
        ...
        "countryCodeIsRequired":
            MessageLookupByLibrary.simpleMessage("Kode negara wajib diisi"),
        "countryIsNotSupported": m14,
        "countryIsRequired":
            MessageLookupByLibrary.simpleMessage("Negara wajib diisi"),
        ...
        "couponInvalid":
            MessageLookupByLibrary.simpleMessage("Kode kupon tidak valid"),
        ...
        "createNewPostSuccessfully": MessageLookupByLibrary.simpleMessage(
            "Postingan Anda berhasil dibuat sebagai draft. Silakan cek di situs admin Anda."),
        ...
        "dateBooking":
            MessageLookupByLibrary.simpleMessage("Tanggal Pemesanan"),
        ...
        "dateWiseClose":
            MessageLookupByLibrary.simpleMessage("Tutup pada tanggal tertentu"),
        "daysAgo": m16,
        ...
        "deliveryManagement":
            MessageLookupByLibrary.simpleMessage("Manajemen Pengiriman"),
        ...
        "emptyComment":
            MessageLookupByLibrary.simpleMessage("Komentar tidak boleh kosong"),
        ...
        "emptyUsername":
            MessageLookupByLibrary.simpleMessage("Username/Email kosong"),
        "emptyWishlist":
        ...
        "enableForLogin":
            MessageLookupByLibrary.simpleMessage("Aktifkan untuk Login"),
        "enableForWallet":
        ...
        "featureProducts":
            MessageLookupByLibrary.simpleMessage("Produk Unggulan"),
        ...
        "fileUploadFailed":
            MessageLookupByLibrary.simpleMessage("Gagal mengunggah file!"),
        "files": MessageLookupByLibrary.simpleMessage("File"),
        "filter": MessageLookupByLibrary.simpleMessage("Filter"),
        "fingerprintsTouchID":
            MessageLookupByLibrary.simpleMessage("Sidik Jari, Touch ID"),
        "finishSetup":
            MessageLookupByLibrary.simpleMessage("Selesaikan pengaturan"),
        ...
        "firstNameIsRequired":
            MessageLookupByLibrary.simpleMessage("Nama depan wajib diisi"),
        "firstRenewal":
        ...
        "getNotification":
            MessageLookupByLibrary.simpleMessage("Terima Notifikasi"),
        "getNotified":
            MessageLookupByLibrary.simpleMessage("Dapatkan pemberitahuan!"),
        "getPasswordLink":
            MessageLookupByLibrary.simpleMessage("Dapatkan Link Kata Sandi"),
        ...
        "hideAbout":
            MessageLookupByLibrary.simpleMessage("Sembunyikan Tentang"),
        "hideAddress":
        ...
        "instantlyClose":
            MessageLookupByLibrary.simpleMessage("Tutup sekarang"),
        ...
        "lastNameIsRequired":
            MessageLookupByLibrary.simpleMessage("Nama belakang wajib diisi"),
        "lastTransactions":
        ...
        "listBannerType":
            MessageLookupByLibrary.simpleMessage("Jenis Banner Daftar"),
        "listBannerVideo":
            MessageLookupByLibrary.simpleMessage("Daftar Video Banner"),
        "listMessages":
        ...
        "lockScreenAndSecurity":
            MessageLookupByLibrary.simpleMessage("Kunci Layar & Keamanan"),
        "login": MessageLookupByLibrary.simpleMessage("Masuk"),
        "loginCanceled":
            MessageLookupByLibrary.simpleMessage("Login dibatalkan"),
        ...
        "loginRequired":
            MessageLookupByLibrary.simpleMessage("Login Diperlukan"),
        ...
        "markAsRead":
            MessageLookupByLibrary.simpleMessage("Tandai sudah dibaca"),
        "markAsShipped":
            MessageLookupByLibrary.simpleMessage("Tandai telah dikirim"),
        "markAsUnread":
            MessageLookupByLibrary.simpleMessage("Tandai belum dibaca"),
        ...
        "minimumQuantityIs":
            MessageLookupByLibrary.simpleMessage("Jumlah minimum adalah"),
        "minutesAgo": m31,
        "mobile": MessageLookupByLibrary.simpleMessage("Ponsel"),
        "mobileIsRequired":
            MessageLookupByLibrary.simpleMessage("Nomor ponsel wajib diisi"),
        "mobileNumberInUse": MessageLookupByLibrary.simpleMessage(
            "Nomor ponsel sudah digunakan"),
        "mobileVerification":
            MessageLookupByLibrary.simpleMessage("Verifikasi Ponsel"),
        "momentAgo":
        ...
        "noAddressHaveBeenSaved":
            MessageLookupByLibrary.simpleMessage("Belum ada alamat tersimpan"),
        "noBackHistoryItem":
            MessageLookupByLibrary.simpleMessage("Tidak ada riwayat kembali"),
        "noBlog": MessageLookupByLibrary.simpleMessage(
            "Ups, sepertinya blog tidak ada lagi"),
        "noCameraPermissionIsGranted": MessageLookupByLibrary.simpleMessage(
            "Tidak ada izin kamera yang diberikan. Harap berikan izin di Pengaturan perangkat Anda."),
        "noComments":
        ...
        "noForwardHistoryItem":
            MessageLookupByLibrary.simpleMessage("Tidak ada riwayat maju"),
        "noInternetConnection":
            MessageLookupByLibrary.simpleMessage("Tidak Ada Koneksi Internet"),
        "noListingNearby":
            MessageLookupByLibrary.simpleMessage("Tidak ada daftar di dekat!"),
        ...
        "noResultFound":
            MessageLookupByLibrary.simpleMessage("Tidak Ada Hasil Ditemukan"),
        "noReviews": MessageLookupByLibrary.simpleMessage("Belum Ada Ulasan"),
        "noSlotAvailable":
            MessageLookupByLibrary.simpleMessage("Tidak ada slot tersedia"),
        ...
        "ofThisProduct":
            MessageLookupByLibrary.simpleMessage("dari produk ini"),
        ...
        "orderStatusCanceledReversal":
            MessageLookupByLibrary.simpleMessage("Pembatalan Dikembalikan"),
        "orderStatusCancelled":
            MessageLookupByLibrary.simpleMessage("Dibatalkan"),
        "orderStatusChargeBack":
            MessageLookupByLibrary.simpleMessage("Pengembalian Dana"),
        ...
        "phoneHintFormat":
            MessageLookupByLibrary.simpleMessage("Format: +62812345678"),
        "phoneIsRequired":
            MessageLookupByLibrary.simpleMessage("Nomor telepon wajib diisi"),
        ...
        "pleaseFillCode":
            MessageLookupByLibrary.simpleMessage("Mohon isi kode Anda"),
        ...
        "pleaseInput":
            MessageLookupByLibrary.simpleMessage("Mohon isi semua kolom"),
        ...
        "pleaseSelectRequiredOptions":
            MessageLookupByLibrary.simpleMessage("Pilih opsi yang diperlukan!"),
        ...
        "postManagement":
            MessageLookupByLibrary.simpleMessage("Manajemen Postingan"),
        ...
        "printerSelection":
            MessageLookupByLibrary.simpleMessage("Pemilihan Printer"),
        ...
        "productOutOfStock":
            MessageLookupByLibrary.simpleMessage("Stok produk habis"),
        "productOverview":
            MessageLookupByLibrary.simpleMessage("Ringkasan Produk"),
        ...
        "qRCodeMsgSuccess":
            MessageLookupByLibrary.simpleMessage("Kode QR berhasil disimpan."),
        "qRCodeSaveFailure":
        ...
        "rateProduct":
            MessageLookupByLibrary.simpleMessage("Beri Nilai Produk"),
        "rateTheApp":
            MessageLookupByLibrary.simpleMessage("Beri Rating Aplikasi"),
        "rateThisApp":
            MessageLookupByLibrary.simpleMessage("Beri Rating Aplikasi Ini"),
        ...
        "recentSearches":
            MessageLookupByLibrary.simpleMessage("Pencarian Terakhir"),
        ...
        "regenerateResponse":
            MessageLookupByLibrary.simpleMessage("Hasilkan Ulang Respons"),
        "registerAs": MessageLookupByLibrary.simpleMessage("Daftar sebagai"),
        "registerAsVendor":
            MessageLookupByLibrary.simpleMessage("Daftar sebagai Penjual"),
        ...
        "relatedLayoutTitle":
            MessageLookupByLibrary.simpleMessage("Hal yang Mungkin Anda Suka"),
        ...
        "removeFromWishList":
            MessageLookupByLibrary.simpleMessage("Hapus dari Wishlist"),
        "removeWishlist":
        ...
        "reviewApproval":
            MessageLookupByLibrary.simpleMessage("Persetujuan Ulasan"),
        ...
        "searchOrderId":
            MessageLookupByLibrary.simpleMessage("Cari ID Pesanan..."),
        ...
        "showAllMyOrdered":
            MessageLookupByLibrary.simpleMessage("Lihat Semua Pesanan"),
        ...
        "sortCode": MessageLookupByLibrary.simpleMessage("Kode Sort"),
        ...
        "stateIsRequired":
            MessageLookupByLibrary.simpleMessage("Provinsi wajib diisi"),
        ...
        "storeClosed":
            MessageLookupByLibrary.simpleMessage("Toko sedang tutup"),
        "storeEmail": MessageLookupByLibrary.simpleMessage("Email Toko"),
        "storeInformation":
            MessageLookupByLibrary.simpleMessage("Informasi Toko"),
        "storeListBanner":
            MessageLookupByLibrary.simpleMessage("Banner Daftar Toko"),
        ...
        "storeMobileBanner":
            MessageLookupByLibrary.simpleMessage("Banner Mobile Toko"),
        "storeSettings":
            MessageLookupByLibrary.simpleMessage("Pengaturan Toko"),
        "storeSliderBanner":
            MessageLookupByLibrary.simpleMessage("Banner Slider Toko"),
        "storeStaticBanner":
            MessageLookupByLibrary.simpleMessage("Banner Statis Toko"),
        ...
        "streetIsRequired":
            MessageLookupByLibrary.simpleMessage("Nama jalan wajib diisi"),
        "streetName": MessageLookupByLibrary.simpleMessage("Nama Jalan"),
        "streetNameApartment":
            MessageLookupByLibrary.simpleMessage("Apartemen"),
        ...
        "thisIsVendorRole":
            MessageLookupByLibrary.simpleMessage("Ini adalah peran penjual"),
        "thisPlatformNotSupportWebview": MessageLookupByLibrary.simpleMessage(
            "Platform ini tidak mendukung tampilan web"),
        "thisProductNotSupport":
            MessageLookupByLibrary.simpleMessage("Produk ini tidak didukung"),
        ...
        "trackingNumberIs":
            MessageLookupByLibrary.simpleMessage("Nomor Pelacakan"),
        "trackingPage":
        ...
        "typeYourMessage":
            MessageLookupByLibrary.simpleMessage("Ketik pesan Anda di sini..."),
        ...
        "updateFailed":
            MessageLookupByLibrary.simpleMessage("Pembaruan gagal!"),
        ...
        "usernameIsRequired":
            MessageLookupByLibrary.simpleMessage("Nama pengguna wajib diisi"),
        "vacationMessage":
        ...
        "waitForPost":
            MessageLookupByLibrary.simpleMessage("Menunggu posting produk"),
        ...
        "youCanOnlyPurchase":
            MessageLookupByLibrary.simpleMessage("Anda hanya dapat membeli"),
        ...
        "youHaveNoPost":
            MessageLookupByLibrary.simpleMessage("Anda belum memiliki kiriman"),
        "youHavePoints": m64,
        ...
        "yourUsernameEmail":
            MessageLookupByLibrary.simpleMessage("Username atau Email Anda"),
        "zipCode": MessageLookupByLibrary.simpleMessage("Kode Pos"),
        "zipCodeIsRequired":
            MessageLookupByLibrary.simpleMessage("Kode pos wajib diisi")
      };
}
