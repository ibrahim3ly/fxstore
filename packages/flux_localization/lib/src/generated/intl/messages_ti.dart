...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m16(day) => "${day} ቅድሚ ሒደት መዓልትታት";

  static String m17(total) => "~${total} ኪሎሜተር";

  static String m18(timeLeft) => " እብ ${timeLeft} ውሽጢ ከብቅዕ\'ዩ";

  static String m19(captcha) => "ነዚ ንምርግጋጽ ናብ ${captcha} ኣተዉ፦";

  static String m20(message) => "ጌጋ ፦ ${message}";

  static String m22(time) => "ኣብ ${time} ግዜ ክወድቅ\'ዩ";

  static String m23(total) => ">${total} ኪሎሜተር";

  static String m24(hour) => "${hour} ቅድሚ ሰዓታት";

  static String m26(message) =>
      "ነቲ ሓበሬታ ኽትሓትት ከላ ምስታ ኣፕሊኬሽን እተተሓሓዘ ጕዳይ ኣሎ በጃኻ ነቲ ጕዳያት ንምፍታሕ ምስ ኣመሓዳሪ ተራኸብ - ${message}";

  static String m28(size) => "ዝለዓለ መጠን ፋይል፦ ${size} MB";

  static String m31(minute) => "${minute} ቅድሚ ሒደት ደቓይቕ";

  static String m32(month) => "${month} ቅድሚ ኣዋርሕ";

  static String m35(itemCount) => "${itemCount} ኣቕሑት";

  static String m36(price) => "ድምር ኣማራጺታት፦ ${price}";

  static String m39(total) => "ብዝሒ ፦ ${total}";

  static String m42(percent) => "መሸጣ ${percent}%";

  static String m46(second) => "${second} ቅድሚ ኻልኢታት";

  static String m47(totalCartQuantity) =>
      "ዓረብያ ዕድጊ ${totalCartQuantity} ንብረት/ታት";

  static String m48(numberOfUnitsSold) => "እተሸጠ፦ ${numberOfUnitsSold}";

  static String m50(total) => "${total} ፍርያት";

  static String m53(date) => "ቅቡል ክሳብ ${date}";

  static String m56(message) => "መጠንቀቕታ ፦ ${message}";

  static String m57(defaultCurrency) =>
      "እቲ ኣብዚ እዋን እዚ እተመርጸ ባጤራ ነቲ ኣብ ቦርሳ ዘሎ ኣቕሓ ኣይርከብን እዩ:: በጃኻ ናብ ${defaultCurrency} ለወጥዎ";

  static String m58(length) => "ፍርያት ${length} ረኸብና";

  static String m59(week) => "ሰሙን ${week}";

  static String m61(year) => "${year} ቅድሚ ዓመታት";

  static String m63(total) => "ትእዛዝ ክትእዝዝ መዲብካ ኣለኻ #${total}";

  static String m64(point) => "ነጥብታት ኣሎካ";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "bannerYoutubeURL":
            MessageLookupByLibrary.simpleMessage("ናይ ዩቱብ URL ባነር"),
        ...
        "chatViaWhatApp":
            MessageLookupByLibrary.simpleMessage("ብ WhatsApp ዕላል ግበር"),
        "chatWithStoreOwner":
            MessageLookupByLibrary.simpleMessage("ምስ ዋና ድኳን ዕላል ግበር"),
        "checkConfirmLink":
        ...
        "chooseYourPaymentMethod":
            MessageLookupByLibrary.simpleMessage("ኣገባብ ክፍሊት ምረጽ"),
        ...
        "confirmClearTheCart":
            MessageLookupByLibrary.simpleMessage("ዓረብያ ከተጽርዮ ከም እትደሊ ርግጸኛ ዲኻ?"),
        ...
        "continueToPayment":
            MessageLookupByLibrary.simpleMessage("ናብ ምኽፋል ቀጽል"),
        "continueToReview":
            MessageLookupByLibrary.simpleMessage("ናብ ምግምጋም ቀጽል"),
        "continueToShipping":
            MessageLookupByLibrary.simpleMessage("ናብ ምልኣኽ ቀጽል"),
        ...
        "enterYourFirstName":
            MessageLookupByLibrary.simpleMessage("ቀዳማይ ስምካ ኣእቱ"),
        "enterYourLastName":
            MessageLookupByLibrary.simpleMessage("ዳልኣይ ስምካ ኣእቱ"),
        "enterYourMobile":
        ...
        "enterYourPhoneNumber":
            MessageLookupByLibrary.simpleMessage("ቁጽሪ ተሌፎንካ ኣእቱ"),
        "error": m20,
        "errorAmountTransfer": MessageLookupByLibrary.simpleMessage(
            "እቲ ዝኣተወ መጠን ገንዘብ ካብቲ ሕጂ ዘሎ መጠን ቦርሳ ይበዝሕ ። በጃኻ እንደገና ፈትን!"),
        "errorEmailFormat":
            MessageLookupByLibrary.simpleMessage("በጃኻ ቅቡል ኣድራሻ ኢ-መይል ኣእቱ።"),
        ...
        "fileUploadFailed":
            MessageLookupByLibrary.simpleMessage("ፋይል ምስፋሕ ኣይተዓወተን!"),
        ...
        "lastNameIsRequired":
            MessageLookupByLibrary.simpleMessage("ካልኣይ ስም የድሊ"),
        "lastTransactions":
        ...
        "manCollections":
            MessageLookupByLibrary.simpleMessage("ናይ ደቂ ተባዕትዮ ፍርያት"),
        ...
        "mustSelectOneItem":
            MessageLookupByLibrary.simpleMessage("1 ኣቕሓ ክትመርጽ ኣለካ"),
        ...
        "noFavoritesYet":
            MessageLookupByLibrary.simpleMessage("ገና ዝፈተኻዮ ኣቕሓ የልቦን"),
        "noFileToDownload":
        ...
        "noInternetConnection":
            MessageLookupByLibrary.simpleMessage("መስመር ኢንተርነት የለን"),
        "noListingNearby":
            MessageLookupByLibrary.simpleMessage("ኣብ ጥቓኻ ዝርዝር የለን!"),
        ...
        "noStoreNearby":
            MessageLookupByLibrary.simpleMessage("ኣብ ጥቓኻ ድኳን የለን!"),
        ...
        "orderSuccessTitle1":
            MessageLookupByLibrary.simpleMessage("ትእዛዝ ብዕዉት መገዲ ኣመልሰልካ ሕተት!"),
        ...
        "pleaseSelectRequiredOptions":
            MessageLookupByLibrary.simpleMessage("በጃኻ ነቲ ዘድሊ ኣማራጺታት ምረጽ!"),
        ...
        "ratingFirst":
            MessageLookupByLibrary.simpleMessage("ሓሳብካ ቅድሚ ምልኣኽካ በጃኻ ገምግሞ"),
        ...
        "refundOrderFailed":
            MessageLookupByLibrary.simpleMessage("ሕቶ ምምላስ ገንዘብ ኣይተዓወተን"),
        "refundOrderSuccess":
            MessageLookupByLibrary.simpleMessage("ሕቶ ምምላስ ገንዘብካ ብዓወት ቀሪቡ ኣሎ!"),
        ...
        "reviewPendingApproval":
            MessageLookupByLibrary.simpleMessage("ግምገማኻ ተላኢኹ ኣሎ፣ ፍቓድ ይጽበ ኣሎ!"),
        ...
        "saveToWishList":
            MessageLookupByLibrary.simpleMessage("ናብ ዝርዝር ድለታት ዓቅብ"),
        ...
        "selectFileCancelled":
            MessageLookupByLibrary.simpleMessage("ምምራጽ ፋይል ተሰረዘ!"),
        ...
        "stateIsRequired":
            MessageLookupByLibrary.simpleMessage("ስም ክፍለ-ሃገር የድሊ"),
        "stateProvince":
            MessageLookupByLibrary.simpleMessage("ክፍለ-ሃገር/ዞባ/ኣውራጃ"),
        ...
        "storeMobileBanner":
            MessageLookupByLibrary.simpleMessage("ባነር ሞባይል ድኳን"),
        "storeSettings": MessageLookupByLibrary.simpleMessage("ቅጥዕታት ድኳን"),
        "storeSliderBanner":
            MessageLookupByLibrary.simpleMessage("ተንቀሳቓሲ ባነር ድኳን"),
        "storeStaticBanner":
            MessageLookupByLibrary.simpleMessage("ቀዋሚ ባነር ድኳን"),
        ...
        "updateSuccess":
            MessageLookupByLibrary.simpleMessage("ምዕራይ ብዓወት ተፈጺሙ!"),
        "updateUserInfor":
        ...
        "womanCollections":
            MessageLookupByLibrary.simpleMessage("ናይ ደቂ ኣንስትዮ ፍርያት"),
        ...
        "youHaveBeenSaveAddressYourLocal":
            MessageLookupByLibrary.simpleMessage("ኣድራሻኻ ኣብ ሰፈርካ ተዓቂቡልካ ኣሎ"),
        "youHavePoints": m64,
        "youMightAlsoLike":
            MessageLookupByLibrary.simpleMessage("እዚ\'ውን ክትፈትዎ ትኽእል ኢኻ"),
