...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(state) => "ब्लूटूथ एडाप्टर ${state} है";

  static String m4(author) => "लेखक: ${author}";

  static String m5(fieldName) => "${fieldName} खाली नहीं हो सकता।";

  static String m6(fieldName) =>
      "${fieldName} की लंबाई 3 अक्षरों से कम नहीं हो सकती।";

  static String m7(currency) => "मुद्रा को ${currency} में बदल दिया गया";

  static String m8(number) => "${number} अक्षर शेष";

  static String m9(priceRate, pointRate) => "${priceRate} = ${pointRate} अंक";

  static String m10(count) => "${count} आइटम";

  static String m11(count) => "${count} आइटम";

  static String m12(count) => "${count} वस्तु";

  static String m13(count) => "${count} वस्तुएं";

  static String m14(country) => "${country} देश समर्थित नहीं है";

  static String m15(currency) => "${currency} समर्थित नहीं है";

  static String m16(day) => "${day} दिन पहले";

  static String m17(total) => "~${total} किमी";

  static String m18(timeLeft) => "${timeLeft} में समाप्त होता है";

  static String m19(captcha) => "पुष्टि के लिए ${captcha} दर्ज करें:";

  static String m20(message) => "त्रुटि: ${message}";

  static String m21(message) => "त्रुटि: ${message}";

  static String m22(time) => "${time} में समाप्त हो रहा है";

  static String m23(total) => ">${total} किमी";

  static String m24(hour) => "${hour} घंटे पहले";
  ...
  static String m28(size) => "अधिकतम फ़ाइल आकार: ${size} MB";
  ...
  static String m31(minute) => "${minute} मिनट पहले";

  static String m32(month) => "${month} महीने पहले";

  static String m33(store) => "${store} से और";

  static String m34(number) => "${number} के समूह में खरीदा जाना चाहिए";

  static String m35(itemCount) => "${itemCount} आइटम";

  static String m36(price) => "विकल्पों का कुल: ${price}";

  static String m37(amount) => "${amount} का भुगतान करें";

  static String m38(name) => "${name} सफलतापूर्वक कार्ट में जोड़ा गया";

  static String m39(total) => "मात्रा: ${total}";

  static String m40(name) => "${name} से पैसे प्राप्त हुए";

  static String m41(count) =>
      "क्या आप अपनी इच्छा-सूची से ${count} वस्तु हटाना चाहते हैं?";

  static String m42(percent) => "बिक्री ${percent}%";

  static String m43(keyword) => "\'${keyword}\' के लिए खोज परिणाम";

  static String m44(keyword, count) => "${keyword} (${count} आइटम)";

  static String m45(keyword, count) => "${keyword} (${count} आइटम)";

  static String m46(second) => "${second} सेकंड पहले";

  static String m47(totalCartQuantity) =>
      "शॉपिंग कार्ट, ${totalCartQuantity} आइटम";

  static String m48(numberOfUnitsSold) => "बिक गया: ${numberOfUnitsSold}";

  static String m49(fieldName) => "${fieldName} फ़ील्ड आवश्यक है";

  static String m50(total) => "कुल उत्पाद: ${total}";

  static String m51(name) => "${name} को पैसे भेजें";
  ...
  static String m53(date) => "${date} तक मान्य";

  static String m54(number) => "संस्करण ${number}";

  static String m55(balance) => "वॉलेट में शेष: ${balance}";

  static String m56(message) => "चेतावनी: ${message}";
  ...
  static String m58(length) => "हमें ${length} उत्पाद मिले";

  static String m59(week) => "सप्ताह ${week}";

  static String m60(name) => "स्वागत है ${name}";

  static String m61(year) => "${year} साल पहले";

  static String m62(count) => "आप ${count} वस्तु चुन रहे हैं";

  static String m63(total) => "आपको ऑर्डर #${total} असाइन किया गया है";

  static String m64(point) => "आपके पास ${point} अंक हैं";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "accountApprovalTitle":
            MessageLookupByLibrary.simpleMessage("अनुमोदन के लिए लंबित"),
        ...
        "activeFor": m0,
        "activeLongAgo":
            MessageLookupByLibrary.simpleMessage("बहुत पहले से सक्रिय"),
        ...
        "addToQuoteRequest":
            MessageLookupByLibrary.simpleMessage("कोटेशन अनुरोध में जोड़ें"),
        "addToWishlist":
            MessageLookupByLibrary.simpleMessage("विशलिस्ट में जोड़ें"),
        "added": MessageLookupByLibrary.simpleMessage("जोड़ा गया"),
        "addedSuccessfully":
            MessageLookupByLibrary.simpleMessage("सफलतापूर्वक जोड़ा गया"),
        "addingYourImage":
            MessageLookupByLibrary.simpleMessage("अपनी छवि जोड़ें"),
        ...
        "agreeWithPrivacy":
            MessageLookupByLibrary.simpleMessage("गोपनीयता और नियम"),
        ...
        "allowCameraAccess":
            MessageLookupByLibrary.simpleMessage("कैमरा एक्सेस की अनुमति दें?"),
        "almostSoldOut":
            MessageLookupByLibrary.simpleMessage("लगभग बिक चुका है"),
        ...
        "backToShop":
            MessageLookupByLibrary.simpleMessage("दुकान पर वापस जाएं"),
        "backToWallet":
        ...
        "bannerYoutubeURL":
            MessageLookupByLibrary.simpleMessage("बैनर यूट्यूब URL"),
        ...
        "bookingCancelled":
            MessageLookupByLibrary.simpleMessage("बुकिंग रद्द की गई"),
        ...
        "bookingUnavailable":
            MessageLookupByLibrary.simpleMessage("बुकिंग उपलब्ध नहीं है"),
        ...
        "byAppointmentOnly":
            MessageLookupByLibrary.simpleMessage("केवल अपॉइंटमेंट द्वारा"),
        "byAuthor": m4,
        ...
        "callToVendor":
            MessageLookupByLibrary.simpleMessage("स्टोर मालिक को कॉल करें"),
        "canNotCreateOrder":
            MessageLookupByLibrary.simpleMessage("ऑर्डर नहीं बना सकते"),
        "canNotCreateUser":
            MessageLookupByLibrary.simpleMessage("उपयोगकर्ता नहीं बना सकते।"),
        "canNotGetPayments": MessageLookupByLibrary.simpleMessage(
            "भुगतान विधियां नहीं मिल सकतीं"),
        "canNotGetShipping": MessageLookupByLibrary.simpleMessage(
            "शिपिंग विधियां नहीं मिल सकतीं"),
        "canNotGetToken":
            MessageLookupByLibrary.simpleMessage("टोकन जानकारी नहीं मिल सकती।"),
        "canNotLaunch": MessageLookupByLibrary.simpleMessage(
            "यह एप्लिकेशन लॉन्च नहीं हो सकता, कृपया सुनिश्चित करें कि config.dart में आपकी सेटिंग सही है"),
        "canNotLoadThisLink":
            MessageLookupByLibrary.simpleMessage("यह लिंक लोड नहीं हो सकता"),
        ...
        "chatWithStoreOwner":
            MessageLookupByLibrary.simpleMessage("स्टोर मालिक से चैट करें"),
        ...
        "cityIsRequired":
            MessageLookupByLibrary.simpleMessage("शहर का नाम आवश्यक है"),
        ...
        "clearConversation":
            MessageLookupByLibrary.simpleMessage("बातचीत साफ़ करें"),
        ...
        "confirmPasswordIsRequired":
            MessageLookupByLibrary.simpleMessage("पासवर्ड पुष्टि आवश्यक है"),
        ...
        "continueToSelectItem":
            MessageLookupByLibrary.simpleMessage("वस्तु चुनना जारी रखें"),
        "continueToShipping":
            MessageLookupByLibrary.simpleMessage("शिपिंग जारी रखें"),
        ...
        "countryIsRequired":
            MessageLookupByLibrary.simpleMessage("देश का नाम आवश्यक है"),
        ...
        "dateWiseClose":
            MessageLookupByLibrary.simpleMessage("तिथि के अनुसार बंद"),
        "daysAgo": m16,
        ...
        "deleteConversation":
            MessageLookupByLibrary.simpleMessage("बातचीत हटाएं"),
        ...
        "deliveryDetails":
            MessageLookupByLibrary.simpleMessage("डिलीवरी विवरण"),
        ...
        "didntReceiveCode":
            MessageLookupByLibrary.simpleMessage("कोड नहीं मिला?"),
        ...
        "emailIsRequired":
            MessageLookupByLibrary.simpleMessage("ईमेल फ़ील्ड आवश्यक है"),
        "emailSubscription":
        ...
        "emptyComment":
            MessageLookupByLibrary.simpleMessage("टिप्पणी खाली नहीं हो सकती"),
        ...
        "emptyUsername":
            MessageLookupByLibrary.simpleMessage("उपयोगकर्ता नाम/ईमेल खाली है"),
        ...
        "enableVacationMode":
            MessageLookupByLibrary.simpleMessage("छुट्टी मोड सक्षम करें"),
        ...
        "enterSentCode":
            MessageLookupByLibrary.simpleMessage("भेजे गए कोड को दर्ज करें"),
        "enterVoucherCode":
            MessageLookupByLibrary.simpleMessage("वाउचर कोड दर्ज करें"),
        "enterYourEmail":
        ...
        "expectedDeliveryDate":
            MessageLookupByLibrary.simpleMessage("अपेक्षित डिलीवरी तिथि"),
        ...
        "expiringInTime": m22,
        "exploreNow":
            MessageLookupByLibrary.simpleMessage("अभी एक्सप्लोर करें"),
        ...
        "failedToGenerateLink":
            MessageLookupByLibrary.simpleMessage("लिंक जनरेट करने में विफल"),
        ...
        "fileUploadFailed":
            MessageLookupByLibrary.simpleMessage("फ़ाइल अपलोड विफल रही!"),
        ...
        "firstNameIsRequired":
            MessageLookupByLibrary.simpleMessage("पहला नाम फ़ील्ड आवश्यक है"),
        ...
        "fixedProductDiscount":
            MessageLookupByLibrary.simpleMessage("फिक्स्ड प्रोडक्ट डिस्काउंट"),
        "forThisProduct":
        ...
        "generatingLink":
            MessageLookupByLibrary.simpleMessage("लिंक जनरेट हो रहा है..."),
        "german": MessageLookupByLibrary.simpleMessage("जर्मन"),
        "getNotification":
            MessageLookupByLibrary.simpleMessage("सूचनाएं प्राप्त करें"),
        ...
        "goBackToAddress":
            MessageLookupByLibrary.simpleMessage("पते पर वापस जाएं"),
        "goBackToReview":
            MessageLookupByLibrary.simpleMessage("समीक्षा पर वापस जाएं"),
        "goBackToShipping":
        ...
        "hasBeenDeleted":
            MessageLookupByLibrary.simpleMessage("हटा दिया गया है"),
        ...
        "informationTable":
            MessageLookupByLibrary.simpleMessage("जानकारी तालिका"),
        ...
        "invalidPhoneNumber":
            MessageLookupByLibrary.simpleMessage("अमान्य फ़ोन नंबर"),
        "invalidSMSCode":
            MessageLookupByLibrary.simpleMessage("अमान्य एसएमएस सत्यापन कोड"),
        "invalidYearOfBirth":
            MessageLookupByLibrary.simpleMessage("जन्म का वर्ष अमान्य है"),
        "invoice": MessageLookupByLibrary.simpleMessage("बीजक"),
        "isEverythingSet":
            MessageLookupByLibrary.simpleMessage("क्या सब सेट है...?"),
        ...
        "itsOrdered":
            MessageLookupByLibrary.simpleMessage("ऑर्डर कर दिया गया है!"),
        ...
        "loginCanceled":
            MessageLookupByLibrary.simpleMessage("लॉगिन रद्द किया गया"),
        ...
        "loginRequired":
            MessageLookupByLibrary.simpleMessage("लॉगिन आवश्यक है"),
        "loginSuccess":
            MessageLookupByLibrary.simpleMessage("सफलतापूर्वक लॉगिन किया!"),
        ...
        "loginToYourAccount":
            MessageLookupByLibrary.simpleMessage("अपने खाते में लॉग इन करें"),
        ...
        "manageApiKey":
            MessageLookupByLibrary.simpleMessage("API कुंजी प्रबंधित करें"),
        "manageStock":
        ...
        "markAsRead":
            MessageLookupByLibrary.simpleMessage("पढ़ा हुआ चिह्नित करें"),
        "markAsShipped":
            MessageLookupByLibrary.simpleMessage("शिप किया गया चिह्नित करें"),
        "markAsUnread":
            MessageLookupByLibrary.simpleMessage("अपठित चिह्नित करें"),
        ...
        "multipleSellersDetected":
            MessageLookupByLibrary.simpleMessage("कई विक्रेता मिले"),
        ...
        "noBackHistoryItem":
            MessageLookupByLibrary.simpleMessage("कोई पिछला इतिहास आइटम नहीं"),
        "noBlog":
            MessageLookupByLibrary.simpleMessage("उफ़, ब्लॉग अब मौजूद नहीं है"),
        "noCameraPermissionIsGranted": MessageLookupByLibrary.simpleMessage(
            "कैमरा की अनुमति नहीं दी गई है। कृपया इसे अपने डिवाइस की सेटिंग्स में प्रदान करें।"),
        "noComments":
            MessageLookupByLibrary.simpleMessage("कोई टिप्पणी नहीं है"),
        "noConversation":
            MessageLookupByLibrary.simpleMessage("अभी तक कोई बातचीत नहीं"),
        ...
        "noStoreNearby":
            MessageLookupByLibrary.simpleMessage("आस-पास कोई स्टोर नहीं!"),
        "noSuggestionSearch":
            MessageLookupByLibrary.simpleMessage("कोई सुझाव नहीं मिला"),
        ...
        "oneEachRecipient":
            MessageLookupByLibrary.simpleMessage("प्रत्येक प्राप्तकर्ता को एक"),
        ...
        "orLoginWith":
            MessageLookupByLibrary.simpleMessage("या इससे लॉगिन करें"),
        "orderConfirmation":
        ...
        "orderIdWithoutColon":
            MessageLookupByLibrary.simpleMessage("ऑर्डर आईडी"),
        ...
        "orderStatusCanceledReversal":
            MessageLookupByLibrary.simpleMessage("रद्द किया गया रिवर्सल"),
        "orderStatusCancelled":
            MessageLookupByLibrary.simpleMessage("रद्द किया गया"),
        "orderStatusChargeBack":
            MessageLookupByLibrary.simpleMessage("चार्जबैक"),
        "orderStatusCompleted":
            MessageLookupByLibrary.simpleMessage("पूरा किया गया"),
        "orderStatusDenied": MessageLookupByLibrary.simpleMessage("अस्वीकृत"),
        "orderStatusExpired":
            MessageLookupByLibrary.simpleMessage("समाप्त हो गया"),
        ...
        "orderStatusPendingPayment":
            MessageLookupByLibrary.simpleMessage("भुगतान लंबित"),
        "orderStatusProcessed":
            MessageLookupByLibrary.simpleMessage("प्रसंस्कृत"),
        "orderStatusProcessing":
            MessageLookupByLibrary.simpleMessage("प्रसंस्करण"),
        "orderStatusRefunded":
            MessageLookupByLibrary.simpleMessage("धनवापसी की गई"),
        "orderStatusReversed":
            MessageLookupByLibrary.simpleMessage("उलट दिया गया"),
        "orderStatusShipped":
            MessageLookupByLibrary.simpleMessage("भेज दिया गया"),
        "orderStatusVoided":
            MessageLookupByLibrary.simpleMessage("अमान्य कर दिया गया"),
        ...
        "pasteYourImageUrl":
            MessageLookupByLibrary.simpleMessage("अपनी छवि का URL पेस्ट करें"),
        "payByWallet":
        ...
        "pendingReviews":
            MessageLookupByLibrary.simpleMessage("लंबित समीक्षाएं"),
        ...
        "phoneNumberVerification":
            MessageLookupByLibrary.simpleMessage("फ़ोन नंबर सत्यापन"),
        "pickADate": MessageLookupByLibrary.simpleMessage("तिथि और समय चुनें"),
        "picking":
            MessageLookupByLibrary.simpleMessage("पिक करने की प्रतीक्षा में"),
        ...
        "pleaseInputFillAllFields":
            MessageLookupByLibrary.simpleMessage("कृपया सभी फ़ील्ड भरें"),
        "pleaseSelectADate":
            MessageLookupByLibrary.simpleMessage("कृपया बुकिंग तिथि चुनें"),
        ...
        "pleaseSelectImages":
            MessageLookupByLibrary.simpleMessage("कृपया छवियां चुनें"),
        "pleaseSelectRequiredOptions":
            MessageLookupByLibrary.simpleMessage("कृपया आवश्यक विकल्प चुनें!"),
        ...
        "priceLowToHigh":
            MessageLookupByLibrary.simpleMessage("मूल्य: निम्न से उच्च"),
        "prices": MessageLookupByLibrary.simpleMessage("मेनू"),
        "printReceipt":
            MessageLookupByLibrary.simpleMessage("रसीद प्रिंट करें"),
        ...
        "privacyTerms":
            MessageLookupByLibrary.simpleMessage("गोपनीयता और शर्तें"),
        ...
        "productAdded":
            MessageLookupByLibrary.simpleMessage("उत्पाद जोड़ा गया"),
        ...
        "productOverview":
            MessageLookupByLibrary.simpleMessage("उत्पाद अवलोकन"),
        ...
        "promptPayName":
            MessageLookupByLibrary.simpleMessage("प्रॉम्प्टपे नाम:"),
        "promptPayType":
            MessageLookupByLibrary.simpleMessage("प्रॉम्प्टपे प्रकार:"),
        "publish": MessageLookupByLibrary.simpleMessage("प्रकाशित करें"),
        "pullToLoadMore":
            MessageLookupByLibrary.simpleMessage("और लोड करने के लिए खींचें"),
        ...
        "rateThisApp":
            MessageLookupByLibrary.simpleMessage("इस ऐप को रेट करें"),
        ...
        "readyToPick":
            MessageLookupByLibrary.simpleMessage("पिक करने के लिए तैयार"),
        ...
        "recentlyViewed":
            MessageLookupByLibrary.simpleMessage("हाल ही में देखे गए"),
        ...
        "regenerateResponse":
            MessageLookupByLibrary.simpleMessage("प्रतिक्रिया पुनः जनरेट करें"),
        "registerAs":
            MessageLookupByLibrary.simpleMessage("इस रूप में पंजीकृत करें"),
        ...
        "registerSuccess":
            MessageLookupByLibrary.simpleMessage("सफलतापूर्वक पंजीकृत"),
        ...
        "removeFromWishList":
            MessageLookupByLibrary.simpleMessage("विशलिस्ट से हटाएं"),
        "removeWishlist":
            MessageLookupByLibrary.simpleMessage("इच्छा-सूची से हटाएं"),
        ...
        "reviewApproval":
            MessageLookupByLibrary.simpleMessage("समीक्षा अनुमोदन"),
        ...
        "saveForLater":
            MessageLookupByLibrary.simpleMessage("बाद के लिए सहेजें"),
        ...
        "selectFileCancelled":
            MessageLookupByLibrary.simpleMessage("फ़ाइल चयन रद्द किया गया!"),
        ...
        "selectTheQuantity":
            MessageLookupByLibrary.simpleMessage("मात्रा चुनें"),
        ...
        "sendSMStoVendor":
            MessageLookupByLibrary.simpleMessage("स्टोर मालिक को SMS भेजें"),
        ...
        "shareProductData":
            MessageLookupByLibrary.simpleMessage("उत्पाद की जानकारी साझा करें"),
        "shareProductLink":
            MessageLookupByLibrary.simpleMessage("उत्पाद का लिंक साझा करें"),
        ...
        "shortDescription":
            MessageLookupByLibrary.simpleMessage("संक्षिप्त विवरण"),
        "showAllMyOrdered":
            MessageLookupByLibrary.simpleMessage("सभी मेरे आदेश दिखाएं"),
        ...
        "speechNotAvailable":
            MessageLookupByLibrary.simpleMessage("स्पीच उपलब्ध नहीं है"),
        "startExploring":
            MessageLookupByLibrary.simpleMessage("खोजना शुरू करें"),
        "startShopping":
            MessageLookupByLibrary.simpleMessage("खरीदारी शुरू करें"),
        "state": MessageLookupByLibrary.simpleMessage("राज्य"),
        "stateIsRequired":
            MessageLookupByLibrary.simpleMessage("राज्य फ़ील्ड आवश्यक है"),
        ...
        "storeInformation":
            MessageLookupByLibrary.simpleMessage("स्टोर जानकारी"),
        "storeListBanner":
        ...
        "storeLocatorSearchPlaceholder":
            MessageLookupByLibrary.simpleMessage("पता या शहर दर्ज करें"),
        ...
        "storeStaticBanner":
            MessageLookupByLibrary.simpleMessage("स्टोर स्टैटिक बैनर"),
        "storeVacation":
            MessageLookupByLibrary.simpleMessage("स्टोर की छुट्टी"),
        ...
        "submitYourPost":
            MessageLookupByLibrary.simpleMessage("अपनी पोस्ट जमा करें"),
        ...
        "transactionCancelled":
            MessageLookupByLibrary.simpleMessage("लेन-देन रद्द किया गया"),
        "transactionDetail":
            MessageLookupByLibrary.simpleMessage("लेन-देन विवरण"),
        "transactionFailded":
            MessageLookupByLibrary.simpleMessage("लेन-देन विफल रहा"),
        "transactionFailed":
            MessageLookupByLibrary.simpleMessage("लेनदेन विफल"),
        ...
        "transferMoneyTo": m51,
        "transferSuccess":
            MessageLookupByLibrary.simpleMessage("स्थानांतरण सफल"),
        ...
        "typeAMessage":
            MessageLookupByLibrary.simpleMessage("एक संदेश टाइप करें..."),
        "typeYourMessage":
            MessageLookupByLibrary.simpleMessage("अपना संदेश यहां लिखें..."),
        ...
        "updateStatus":
            MessageLookupByLibrary.simpleMessage("स्थिति अपडेट करें"),
        "updateSuccess":
        ...
        "vacationMessage":
            MessageLookupByLibrary.simpleMessage("छुट्टी का संदेश"),
        "vacationType":
        ...
        "viewOnGoogleMaps":
            MessageLookupByLibrary.simpleMessage("Google मैप्स पर देखें"),
        ...
        "weSentAnOTPTo":
            MessageLookupByLibrary.simpleMessage("एक सत्यापन कोड भेजा गया है"),
        ...
        "welcomeBack":
            MessageLookupByLibrary.simpleMessage("वापस आने पर स्वागत है"),
        ...
        "withdrawRequest":
            MessageLookupByLibrary.simpleMessage("निकासी का अनुरोध"),
        "withdrawal": MessageLookupByLibrary.simpleMessage("निकासी"),
        "womanCollections":
            MessageLookupByLibrary.simpleMessage("महिला कलेक्शन"),
        "writeComment":
        ...
        "youHaveNoPost":
            MessageLookupByLibrary.simpleMessage("आपकी कोई पोस्ट नहीं है"),
        "youHavePoints": m64,
        "youMightAlsoLike":
            MessageLookupByLibrary.simpleMessage("शायद आपको यह भी पसंद आए"),
        ...
        "yourEarningsThisMonth":
            MessageLookupByLibrary.simpleMessage("इस महीने की आपकी कमाई"),
        "yourNote": MessageLookupByLibrary.simpleMessage("आपका नोट"),
        "yourOrderHasBeenAdded":
            MessageLookupByLibrary.simpleMessage("आपका ऑर्डर जोड़ दिया गया है"),
