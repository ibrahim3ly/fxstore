...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(state) => "Bluetooth ni ${state}";

  static String m4(author) => "Na: ${author}";

  static String m5(fieldName) => "${fieldName} haiwezi kuwa tupu.";

  static String m6(fieldName) => " Urefu${fieldName} lazima usiwe chini ya 3.";

  static String m7(currency) => "Umebadilisha sarafu kuwa ${currency}";

  static String m8(number) => "Zimebaki herufi ${number}";

  static String m9(priceRate, pointRate) =>
      "${priceRate} = ${pointRate} Pointi";

  static String m10(count) => "Kipengee ${count}";

  static String m11(count) => "Vipengee ${count}";

  static String m12(count) => "Bidhaa ${count}";

  static String m13(count) => "Bidhaa ${count}";

  static String m14(country) => "${country} haitumiki";

  static String m15(currency) => "${currency} haitumiki";

  static String m16(day) => "Siku ${day} zilizopita";

  static String m17(total) => "~${total} kilomita";

  static String m18(timeLeft) => "Inaisha baada ya ${timeLeft}";

  static String m19(captcha) => "Weka ${captcha} ili kuthibitisha:";

  static String m20(message) => "Hitilafu: ${message}";

  static String m21(message) => "Hitilafu: ${message}";

  static String m22(time) => "Inaisha baada ya ${time}";

  static String m23(total) => "> kilomita${total} ";

  static String m24(hour) => "Saa ${hour} zilizopita";
  ...
  static String m28(size) => "Upeo wa ukubwa wa faili: ${size} MB";
  ...
  static String m31(minute) => "Dakika ${minute} zilizopita";

  static String m32(month) => "Miezi ${month} iliyopita";

  static String m33(store) => "Zaidi kutoka ${store}";

  static String m34(number) => "Lazima inunuliwe katika vikundi vya ${number}";

  static String m35(itemCount) => "Vitu ${itemCount}";

  static String m36(price) => "Jumla ya chaguo: ${price}";

  static String m37(amount) => "Lipa ${amount}";

  static String m38(name) => "${name} imeongezwa kwenye kikapu";

  static String m39(total) => "Kiasi: ${total}";

  static String m40(name) => "Umepokea pesa kutoka kwa ${name}";

  static String m41(count) =>
      "Je, ungependa kuondoa vipengee ${count} kutoka kwenye orodha yako ya matamanio?";

  static String m42(percent) => "Punguzo ${percent}%";

  static String m43(keyword) => "Matokeo ya utafutaji wa: \'${keyword}\'";

  static String m44(keyword, count) => "${keyword} (${count} bidhaa)";

  static String m45(keyword, count) => "${keyword} (${count} bidhaa)";

  static String m46(second) => "Sekunde ${second} zilizopita";

  static String m47(totalCartQuantity) =>
      "Kikapu cha ununuzi, vitu ${totalCartQuantity}";

  static String m48(numberOfUnitsSold) => "Imeuzwa: ${numberOfUnitsSold}";

  static String m49(fieldName) => "Sehemu ya ${fieldName} inahitajika";

  static String m50(total) => "Jumla ya Bidhaa: ${total}";

  static String m51(name) => "Hamisha pesa kwa ${name}";
  ...
  static String m53(date) => "Halali hadi ${date}";

  static String m54(number) => "Toleo la ${number}";

  static String m55(balance) => "Salio la Pochi: ${balance}";

  static String m56(message) => "Onyo: ${message}";
  ...
  static String m58(length) => "Tumepata bidhaa ${length}";

  static String m59(week) => "Wiki ${week}";

  static String m60(name) => "Karibu ${name}";

  static String m61(year) => "Miaka ${year} iliyopita";

  static String m62(count) => "Unachagua vipengee ${count} ";

  static String m63(total) => "Umepangiwa agizo #${total}";

  static String m64(point) => "Una pointi ${point}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "accountApprovalTitle":
            MessageLookupByLibrary.simpleMessage("Inasubiri Idhini"),
        ...
        "accountSetup":
            MessageLookupByLibrary.simpleMessage("Kusanidi akaunti"),
        ...
        "addASlug":
            MessageLookupByLibrary.simpleMessage("Ongeza kichwa kifupi"),
        ...
        "addToCart":
            MessageLookupByLibrary.simpleMessage("Ongeza kwenye rukwama"),
        "addToCartMaximum":
            MessageLookupByLibrary.simpleMessage("Umezidi kiwango cha juu"),
        ...
        "addToQuoteRequest":
            MessageLookupByLibrary.simpleMessage("Ongeza kwenye ombi la bei"),
        ...
        "areYouWantToExit":
            MessageLookupByLibrary.simpleMessage("Je, unataka kutoka?"),
        ...
        "availablePoints": m2,
        "averageRating":
            MessageLookupByLibrary.simpleMessage("Wastani wa Ukadiriaji"),
        ...
        "bannerYoutubeURL":
            MessageLookupByLibrary.simpleMessage("URL ya Youtube ya Bango"),
        "basicInformation":
        ...
        "billingAddress":
            MessageLookupByLibrary.simpleMessage("Anwani ya malipo"),
        ...
        "byAppointmentOnly":
            MessageLookupByLibrary.simpleMessage("Kwa Miadi Tu"),
        "byAuthor": m4,
        ...
        "callToVendor":
            MessageLookupByLibrary.simpleMessage("Piga simu kwa Muuzaji"),
        "canNotCreateOrder":
            MessageLookupByLibrary.simpleMessage("Haiwezi kuunda agizo"),
        "canNotCreateUser":
        ...
        "cancelledRequests":
            MessageLookupByLibrary.simpleMessage("Maombi Yalioghairiwa"),
        "cannotBeEmpty": m5,
        "cannotDeleteAccount":
            MessageLookupByLibrary.simpleMessage("Akaunti hii haiwezi kufutwa"),
        ...
        "cartDiscount":
            MessageLookupByLibrary.simpleMessage("Punguzo la Rukwama"),
        ...
        "changePrinter":
            MessageLookupByLibrary.simpleMessage("Badilisha Kichapishaji"),
        ...
        "chatViaWhatApp":
            MessageLookupByLibrary.simpleMessage("Ongea kupitia WhatsApp"),
        ...
        "chineseTraditional":
            MessageLookupByLibrary.simpleMessage("Kichina (cha Jadi)"),
        ...
        "chooseFromServer":
            MessageLookupByLibrary.simpleMessage("Chagua Kutoka kwenye Seva"),
        ...
        "chooseYourPaymentMethod":
            MessageLookupByLibrary.simpleMessage("Chagua njia yako ya malipo"),
        ...
        "clearCartAndAddNew":
            MessageLookupByLibrary.simpleMessage("Futa Kikapu na Ongeza Mpya"),
        "clearConversation":
        ...
        "continueToSelectItem":
            MessageLookupByLibrary.simpleMessage("Endelea kuchagua kipengee"),
        "continueToShipping":
        ...
        "createReviewSuccess":
            MessageLookupByLibrary.simpleMessage("Asante kwa maoni yako"),
        "createReviewSuccessMsg": MessageLookupByLibrary.simpleMessage(
            "Tunashukuru sana kwa mchango wako. Maoni yako yatatusaidia kuboresha huduma zetu"),
        "createVariants":
            MessageLookupByLibrary.simpleMessage("Unda tofauti zote"),
        ...
        "dateBooking":
            MessageLookupByLibrary.simpleMessage("Tarehe ya kuhifadhi"),
        ...
        "dateLatest":
            MessageLookupByLibrary.simpleMessage("Tarehe: Mpya zaidi"),
        "dateOldest":
            MessageLookupByLibrary.simpleMessage("Tarehe: Ya zamani zaidi"),
        ...
        "didntReceiveCode":
            MessageLookupByLibrary.simpleMessage("Hukupokea msimbo?"),
        ...
        "doYouWantToLogout":
            MessageLookupByLibrary.simpleMessage("Je, unataka kuondoka?"),
        ...
        "downloadingImages":
            MessageLookupByLibrary.simpleMessage("Inapakua picha..."),
        ...
        "emailAddressInvalid":
            MessageLookupByLibrary.simpleMessage("Barua pepe si sahihi"),
        ...
        "emptyCart":
            MessageLookupByLibrary.simpleMessage("Kikapu chako ni tupu"),
        ...
        "emptyWishlist":
            MessageLookupByLibrary.simpleMessage("Orodha ya matamanio ni tupu"),
        ...
        "enableForCheckout":
            MessageLookupByLibrary.simpleMessage("Wezesha kwa Malipo"),
        "enableForLogin":
            MessageLookupByLibrary.simpleMessage("Wezesha kwa Kuingia"),
        "enableForWallet":
            MessageLookupByLibrary.simpleMessage("Wezesha kwa Pochi"),
        "enableVacationMode":
        ...
        "enterVoucherCode":
            MessageLookupByLibrary.simpleMessage("Weka nambari ya vocha"),
        "enterYourEmail":
        ...
        "enterYourUsername":
            MessageLookupByLibrary.simpleMessage("Weka jina lako la mtumiaji"),
        "error": m20,
        ...
        "generatingLink":
            MessageLookupByLibrary.simpleMessage("Inatengeneza kiungo..."),
        ...
        "incorrectPassword":
            MessageLookupByLibrary.simpleMessage("Nenosiri si sahihi"),
        "india": MessageLookupByLibrary.simpleMessage("Kihindi"),
        "indonesian": MessageLookupByLibrary.simpleMessage("Kiindonesia"),
        "informationTable":
            MessageLookupByLibrary.simpleMessage("Jedwali la Taarifa"),
        ...
        "instantlyClose":
            MessageLookupByLibrary.simpleMessage("Funga mara moja"),
        ...
        "isEverythingSet":
            MessageLookupByLibrary.simpleMessage("Je, kila kitu kiko sawa...?"),
        ...
        "loginFailed":
            MessageLookupByLibrary.simpleMessage("Imeshindwa kuingia!"),
        "loginInvalid": MessageLookupByLibrary.simpleMessage(
            "Huruhusiwi kutumia programu hii."),
        "loginRequired":
            MessageLookupByLibrary.simpleMessage("Kuingia Kunahitajika"),
        "loginSuccess":
        ...
        "manageApiKey":
            MessageLookupByLibrary.simpleMessage("Simamia Ufunguo wa API"),
        ...
        "moreFromStore": m33,
        "moreInformation":
            MessageLookupByLibrary.simpleMessage("Maelezo zaidi"),
        ...
        "orderConfirmation":
            MessageLookupByLibrary.simpleMessage("Uthibitisho wa Agizo"),
        ...
        "orderIdWithoutColon":
            MessageLookupByLibrary.simpleMessage("Namba ya agizo"),
        ...
        "orderStatusCancelled":
            MessageLookupByLibrary.simpleMessage("Imeghairiwa"),
        "orderStatusChargeBack":
            MessageLookupByLibrary.simpleMessage("Rudisha Malipo"),
        ...
        "orderStatusOnHold":
            MessageLookupByLibrary.simpleMessage("Imesitishwa"),
        ...
        "orderStatusProcessing":
            MessageLookupByLibrary.simpleMessage("Inachakata"),
        "orderStatusRefunded":
        ...
        "orderSuccessTitle1":
            MessageLookupByLibrary.simpleMessage("Umefanikiwa kuagiza"),
        "orderSuccessTitle2":
        ...
        "passwordIsRequired":
            MessageLookupByLibrary.simpleMessage("Nenosiri linahitajika"),
        "passwordsDoNotMatch":
        ...
        "paymentSuccessful":
            MessageLookupByLibrary.simpleMessage("Malipo yamefanikiwa"),
        "pending": MessageLookupByLibrary.simpleMessage("Inasubiri"),
        "pendingReviews":
            MessageLookupByLibrary.simpleMessage("Maoni Yanayosubiri"),
        ...
        "pleaseChooseCategory":
            MessageLookupByLibrary.simpleMessage("Tafadhali chagua jamii"),
        ...
        "postImageFeature":
            MessageLookupByLibrary.simpleMessage("Kipengele cha Picha"),
        "postManagement":
            MessageLookupByLibrary.simpleMessage("Usimamizi wa Machapisho"),
        ...
        "printerSelection":
            MessageLookupByLibrary.simpleMessage("Uchaguzi wa Kichapishaji"),
        ...
        "processing":
            MessageLookupByLibrary.simpleMessage("Inashughulikiwa..."),
        "product": MessageLookupByLibrary.simpleMessage("Bidhaa"),
        "productAddToCart": m38,
        "productAdded":
            MessageLookupByLibrary.simpleMessage("Bidhaa imeongezwa"),
        ...
        "pullToLoadMore":
            MessageLookupByLibrary.simpleMessage("Vuta ili upate zaidi"),
        "qRCodeMsgSuccess":
        ...
        "readyToPick":
            MessageLookupByLibrary.simpleMessage("Tayari kwa kukusanywa"),
        ...
        "recentView":
            MessageLookupByLibrary.simpleMessage("Ulizotazama Hivi Karibuni"),
        "recentlyViewed":
            MessageLookupByLibrary.simpleMessage("Zilizotazamwa Hivi Karibuni"),
        "recommended": MessageLookupByLibrary.simpleMessage("Inapendekezwa"),
        "recurringTotals":
            MessageLookupByLibrary.simpleMessage("Jumla Zinazojirudia"),
        ...
        "refundRequested":
            MessageLookupByLibrary.simpleMessage("Umeomba kurejeshewa pesa"),
        ...
        "registerAsVendor":
            MessageLookupByLibrary.simpleMessage("Jisajili kama Muuzaji"),
        ...
        "registerFailed":
            MessageLookupByLibrary.simpleMessage("Usajili umeshindikana"),
        "registerInvalid": MessageLookupByLibrary.simpleMessage(
            "Usajili si sahihi au umepitwa na wakati. Tafadhali jaribu tena"),
        "registerSuccess":
            MessageLookupByLibrary.simpleMessage("Umejisajili kwa mafanikio"),
        "regularPrice": MessageLookupByLibrary.simpleMessage("Bei ya kawaida"),
        "relatedLayoutTitle":
            MessageLookupByLibrary.simpleMessage("Vitu Unavyoweza Kupenda"),
        "releaseToLoadMore":
            MessageLookupByLibrary.simpleMessage("Achia ili upate zaidi"),
        ...
        "requestBooking":
            MessageLookupByLibrary.simpleMessage("Omba Kuhifadhi"),
        ...
        "saveAddressSuccess":
            MessageLookupByLibrary.simpleMessage("Anwani yako imehifadhiwa"),
        "saveForLater":
        ...
        "scannerCannotScan":
            MessageLookupByLibrary.simpleMessage("Kifaa hiki hakiwezi kusoma"),
        ...
        "selectPrinter":
            MessageLookupByLibrary.simpleMessage("Chagua Kichapishaji"),
        ...
        "selectTheQuantity":
            MessageLookupByLibrary.simpleMessage("Chagua kiasi"),
        ...
        "sendSMStoVendor":
            MessageLookupByLibrary.simpleMessage("Tuma SMS kwa Muuzaji"),
        ...
        "shareProductData":
            MessageLookupByLibrary.simpleMessage("Shiriki Data ya Bidhaa"),
        "shareProductLink":
            MessageLookupByLibrary.simpleMessage("Shiriki Kiungo cha Bidhaa"),
        "shipped": MessageLookupByLibrary.simpleMessage("Imesafirishwa"),
        "shipping": MessageLookupByLibrary.simpleMessage("Usafirishaji"),
        "shippingAddress":
            MessageLookupByLibrary.simpleMessage("Anwani ya Usafirishaji"),
        "shippingFee":
        ...
        "shortDescription":
            MessageLookupByLibrary.simpleMessage("Maelezo Mafupi"),
        "showAllMyOrdered":
            MessageLookupByLibrary.simpleMessage("Onyesha Maagizo Yangu Yote"),
        ...
        "speechNotAvailable":
            MessageLookupByLibrary.simpleMessage("Mazungumzo hayapatikani"),
        "startExploring":
        ...
        "stateIsRequired":
            MessageLookupByLibrary.simpleMessage("Sehemu ya jimbo inahitajika"),
        ...
        "storeInformation":
            MessageLookupByLibrary.simpleMessage("Taarifa za Duka"),
        "storeListBanner":
            MessageLookupByLibrary.simpleMessage("Bango la Orodha ya Duka"),
        "storeLocation": MessageLookupByLibrary.simpleMessage("Mahali pa Duka"),
        "storeLocatorSearchPlaceholder":
            MessageLookupByLibrary.simpleMessage("Weka anwani au jiji"),
        "storeLogo": MessageLookupByLibrary.simpleMessage("Nembo ya Duka"),
        "storeMobileBanner":
            MessageLookupByLibrary.simpleMessage("Bango la Simu la Duka"),
        "storeSettings":
            MessageLookupByLibrary.simpleMessage("Mipangilio ya Duka"),
        "storeSliderBanner":
            MessageLookupByLibrary.simpleMessage("Bango la Slider la Duka"),
        "storeStaticBanner":
            MessageLookupByLibrary.simpleMessage("Bango Tuli la Duka"),
        ...
        "submitYourPost":
            MessageLookupByLibrary.simpleMessage("Wasilisha Chapisho Lako"),
        ...
        "thisIsCustomerRole":
            MessageLookupByLibrary.simpleMessage("Huu ni wajibu wa mteja"),
        "thisIsVendorRole":
            MessageLookupByLibrary.simpleMessage("Huu ni wajibu wa muuzaji"),
        "thisPlatformNotSupportWebview": MessageLookupByLibrary.simpleMessage(
            "Mfumo huu hautumii mwonekano wa wavuti"),
        "thisProductNotSupport":
            MessageLookupByLibrary.simpleMessage("Bidhaa hii haiwezi kutumika"),
        ...
        "trackingNumberIs":
            MessageLookupByLibrary.simpleMessage("Namba ya ufuatiliaji ni"),
        "trackingPage":
            MessageLookupByLibrary.simpleMessage("Ukurasa wa Ufuatiliaji"),
        "transactionCancelled":
            MessageLookupByLibrary.simpleMessage("Muamala umeghairiwa"),
        "transactionDetail":
            MessageLookupByLibrary.simpleMessage("Maelezo ya muamala"),
        "transactionFailded":
            MessageLookupByLibrary.simpleMessage("Muamala umeshindikana"),
        "transactionFailed":
            MessageLookupByLibrary.simpleMessage("Muamala umeshindikana"),
        "transactionFee":
        ...
        "transferConfirm":
            MessageLookupByLibrary.simpleMessage("Uthibitisho wa Uhamishaji"),
        "transferErrorMessage": MessageLookupByLibrary.simpleMessage(
            "Huwezi kuhamishia kwa mtumiaji huyu"),
        "transferFailed":
            MessageLookupByLibrary.simpleMessage("Uhamishaji umeshindikana"),
        "transferMoneyTo": m51,
        "transferSuccess":
            MessageLookupByLibrary.simpleMessage("Uhamishaji umefanikiwa"),
        ...
        "updateUserInfor":
            MessageLookupByLibrary.simpleMessage("Sasisha Wasifu"),
        ...
        "userNotFound":
            MessageLookupByLibrary.simpleMessage("Mtumiaji hajapatikana"),
        ...
        "usernameInvalid":
            MessageLookupByLibrary.simpleMessage("Jina la mtumiaji si sahihi"),
        ...
        "vendorInfo":
            MessageLookupByLibrary.simpleMessage("Taarifa za Muuzaji"),
        ...
        "waitForPost":
            MessageLookupByLibrary.simpleMessage("Inasubiri kupakia bidhaa"),
        ...
        "whichLanguageDoYouPrefer":
            MessageLookupByLibrary.simpleMessage("Unapendelea lugha gani?"),
        ...
        "withdrawAmount":
            MessageLookupByLibrary.simpleMessage("Kiasi cha Kutoa"),
        "withdrawRequest":
            MessageLookupByLibrary.simpleMessage("Ombi la Kutoa"),
        ...
        "yourApplicationIsUnderReview":
            MessageLookupByLibrary.simpleMessage("Maombi yako yanakaguliwa."),
        "yourBagIsEmpty":
            MessageLookupByLibrary.simpleMessage("Kikapu chako ni tupu"),
        "yourBookingDetail":
