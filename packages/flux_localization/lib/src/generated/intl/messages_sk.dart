...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(attribute) => "Akýkoľvek ${attribute}";
  ...
  static String m5(fieldName) => "${fieldName} nemôže byť prázdne.";

  static String m6(fieldName) => " Dĺžka${fieldName} nesmie byť menšia ako 3.";

  static String m7(currency) => "Mena bola zmenená na ${currency}";

  static String m8(number) => "Zostávajúce znaky: ${number}";

  static String m9(priceRate, pointRate) => "${priceRate} = ${pointRate} bodov";

  static String m10(count) => "${count} položka";

  static String m11(count) => "${count} položiek";

  static String m12(count) => "${count} položka";

  static String m13(count) => "${count} položiek";

  static String m14(country) => "Krajina ${country} nie je podporovaná";

  static String m15(currency) => "${currency} nie je podporovaná";

  static String m16(day) => "Pred ${day} dňami";

  static String m17(total) => "~${total} km";

  static String m18(timeLeft) => "Končí za ${timeLeft}";

  static String m19(captcha) => "Pre potvrdenie zadajte ${captcha}:";

  static String m20(message) => "Chyba: ${message}";

  static String m21(message) => "Chyba: ${message}";

  static String m22(time) => "Expiruje za ${time}";

  static String m23(total) => ">${total} km";

  static String m24(hour) => "Pred ${hour} hodinami";
  ...
  static String m28(size) => "Maximálna veľkosť súboru: ${size} MB";
  ...
  static String m31(minute) => "Pred ${minute} minútami";

  static String m32(month) => "Pred ${month} mesiacmi";

  static String m33(store) => "Viac od ${store}";

  static String m34(number) => "Musí sa kúpiť v skupinách po ${number}";

  static String m35(itemCount) => "${itemCount} položiek";

  static String m36(price) => "Celkové možnosti: ${price}";

  static String m37(amount) => "Zaplatiť ${amount}";

  static String m38(name) => "${name} bol úspešne pridaný do košíka";

  static String m39(total) => "Množstvo: ${total}";

  static String m40(name) => "Prijaté peniaze od používateľa ${name}";

  static String m41(count) =>
      "Chcete odstrániť položky (počet: ${count} ) zo zoznamu želaní?";

  static String m42(percent) => "Zľava ${percent}%";

  static String m43(keyword) => "Výsledky vyhľadávania pre: \'${keyword}\'";

  static String m44(keyword, count) => "${keyword} (${count} položka)";

  static String m45(keyword, count) => "${keyword} (${count} položiek)";

  static String m46(second) => "Pred ${second} sekundami";

  static String m47(totalCartQuantity) =>
      "Nákupný košík, ${totalCartQuantity} položiek";

  static String m48(numberOfUnitsSold) => "Predané: ${numberOfUnitsSold}";

  static String m49(fieldName) => "Pole ${fieldName} je povinné";

  static String m50(total) => "${total} produktov";

  static String m51(name) => "Poslať peniaze používateľovi ${name}";
  ...
  static String m54(number) => "Verzia ${number}";

  static String m55(balance) => "Zostatok v peňaženke: ${balance}";

  static String m56(message) => "Upozornenie: ${message}";
  ...
  static String m58(length) => "Našli sme ${length} produktov";

  static String m59(week) => "Týždeň ${week}";

  static String m60(name) => "Vitajte, ${name}";

  static String m61(year) => "Pred ${year} rokmi";

  static String m62(count) => "Vyberáte položky (počet: ${count} )";

  static String m63(total) => "Pridelili ste objednávku #${total}";

  static String m64(point) => "Máte ${point} bodov";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "accountApprovalTitle":
            MessageLookupByLibrary.simpleMessage("Schvaľovanie"),
        ...
        "activeFor": m0,
        "activeLongAgo":
            MessageLookupByLibrary.simpleMessage("Aktívne pred dlhým časom"),
        ...
        "addingYourImage":
            MessageLookupByLibrary.simpleMessage("Pridávanie vášho obrázka"),
        ...
        "areYouWantToExit":
            MessageLookupByLibrary.simpleMessage("Naozaj chcete odísť?"),
        "assigned": MessageLookupByLibrary.simpleMessage("Pridelené"),
        "atLeastThreeCharacters":
            MessageLookupByLibrary.simpleMessage("Minimálne 3 znaky..."),
        ...
        "backToWallet":
            MessageLookupByLibrary.simpleMessage("Späť do peňaženky"),
        "bagsCollections":
            MessageLookupByLibrary.simpleMessage("Kolekcie tašiek"),
        ...
        "bannerYoutubeURL":
            MessageLookupByLibrary.simpleMessage("YouTube URL bannera"),
        "basicInformation":
            MessageLookupByLibrary.simpleMessage("Základné informácie"),
        "becomeAVendor":
            MessageLookupByLibrary.simpleMessage("Stať sa predajcom"),
        ...
        "bleHasNotBeenEnabled":
            MessageLookupByLibrary.simpleMessage("Bluetooth nie je zapnuté"),
        "bleState": m3,
        "block": MessageLookupByLibrary.simpleMessage("Zablokovať"),
        "blockUser":
            MessageLookupByLibrary.simpleMessage("Zablokovať používateľa"),
        ...
        "bookingCancelled":
            MessageLookupByLibrary.simpleMessage("Rezervácia zrušená"),
        "bookingConfirm": MessageLookupByLibrary.simpleMessage("Potvrdené"),
        "bookingError": MessageLookupByLibrary.simpleMessage(
            "Niečo nie je v poriadku. Skúste to prosím neskôr."),
        "bookingHistory":
        ...
        "bookingSummary":
            MessageLookupByLibrary.simpleMessage("Prehľad rezervácie"),
        "bookingUnavailable":
            MessageLookupByLibrary.simpleMessage("Rezervácia nie je dostupná"),
        ...
        "byAppointmentOnly":
            MessageLookupByLibrary.simpleMessage("Len na objednávku"),
        "byAuthor": m4,
        ...
        "callToVendor":
            MessageLookupByLibrary.simpleMessage("Zavolať predajcovi"),
        ...
        "cancelOrder":
            MessageLookupByLibrary.simpleMessage("Zrušiť objednávku"),
        ...
        "chatViaWhatApp":
            MessageLookupByLibrary.simpleMessage("Chatovať cez WhatsApp"),
        ...
        "chineseTraditional":
            MessageLookupByLibrary.simpleMessage("Tradičná čínština"),
        ...
        "chooseFromServer":
            MessageLookupByLibrary.simpleMessage("Vybrať zo servera"),
        ...
        "chooseYourPaymentMethod":
            MessageLookupByLibrary.simpleMessage("Vyberte spôsob platby"),
        ...
        "clearConversation":
            MessageLookupByLibrary.simpleMessage("Vymazať konverzáciu"),
        ...
        "codExtraFee":
            MessageLookupByLibrary.simpleMessage("Poplatok za dobierku"),
        ...
        "confirmAccountDeletion":
            MessageLookupByLibrary.simpleMessage("Potvrďte odstránenie účtu"),
        ...
        "continueToPayment":
            MessageLookupByLibrary.simpleMessage("Pokračovať k platbe"),
        "continueToReview":
            MessageLookupByLibrary.simpleMessage("Pokračovať k recenzii"),
        "continueToSelectItem":
            MessageLookupByLibrary.simpleMessage("Pokračujte výberom položky"),
        "continueToShipping":
            MessageLookupByLibrary.simpleMessage("Pokračovať k doručeniu"),
        ...
        "countryIsRequired":
            MessageLookupByLibrary.simpleMessage("Krajina je povinná"),
        ...
        "couponInvalid":
            MessageLookupByLibrary.simpleMessage("Váš kód kupónu je neplatný"),
        ...
        "createVariants":
            MessageLookupByLibrary.simpleMessage("Vytvoriť všetky varianty"),
        ...
        "currentlyWeOnlyHave":
            MessageLookupByLibrary.simpleMessage("Momentálne máme len"),
        ...
        "disablePurchase":
            MessageLookupByLibrary.simpleMessage("Zakázať nákup"),
        ...
        "downloadApp":
            MessageLookupByLibrary.simpleMessage("Stiahnuť aplikáciu"),
        "downloadingImages":
            MessageLookupByLibrary.simpleMessage("Sťahujú sa obrázky..."),
        "draft": MessageLookupByLibrary.simpleMessage("Koncept"),
        "driverAssigned":
            MessageLookupByLibrary.simpleMessage("Vodič priradený"),
        ...
        "emailIsRequired":
            MessageLookupByLibrary.simpleMessage("E-mail je povinný"),
        "emailSubscription":
            MessageLookupByLibrary.simpleMessage("Odber e-mailov"),
        ...
        "enableForCheckout":
            MessageLookupByLibrary.simpleMessage("Povoliť pre pokladňu"),
        "enableForLogin":
        ...
        "enterVoucherCode":
            MessageLookupByLibrary.simpleMessage("Zadajte kód kupónu"),
        "enterYourEmail":
        ...
        "featureNotAvailable":
            MessageLookupByLibrary.simpleMessage("Funkcia nie je dostupná"),
        "featureProducts":
            MessageLookupByLibrary.simpleMessage("Odporúčané produkty"),
        ...
        "generalSetting":
            MessageLookupByLibrary.simpleMessage("Všeobecné nastavenia"),
        "generatingLink":
            MessageLookupByLibrary.simpleMessage("Generuje sa odkaz..."),
        "german": MessageLookupByLibrary.simpleMessage("nemecký"),
        "getNotification":
            MessageLookupByLibrary.simpleMessage("Dostávať upozornenia"),
        "getNotified":
            MessageLookupByLibrary.simpleMessage("Dostávať upozornenia!"),
        ...
        "goBackToShipping":
            MessageLookupByLibrary.simpleMessage("Späť na doručenie"),
        ...
        "historyTransaction":
            MessageLookupByLibrary.simpleMessage("História transakcií"),
        ...
        "imageFeature":
            MessageLookupByLibrary.simpleMessage("Obrázková funkcia"),
        "imageGallery":
        ...
        "instantlyClose":
            MessageLookupByLibrary.simpleMessage("Okamžite zavrieť"),
        ...
        "lastNameIsRequired":
            MessageLookupByLibrary.simpleMessage("Priezvisko je povinné"),
        "lastTransactions":
        ...
        "listBannerType":
            MessageLookupByLibrary.simpleMessage("Typ zoznamu bannerov"),
        "listBannerVideo":
            MessageLookupByLibrary.simpleMessage("Zoznam bannerových videí"),
        "listMessages":
            MessageLookupByLibrary.simpleMessage("Upozornenia na správy"),
        ...
        "loginRequired":
            MessageLookupByLibrary.simpleMessage("Vyžaduje sa prihlásenie"),
        "loginSuccess":
        ...
        "manCollections":
            MessageLookupByLibrary.simpleMessage("Pánske kolekcie"),
        "manageApiKey":
            MessageLookupByLibrary.simpleMessage("Spravovať API kľúč"),
        ...
        "mobileIsRequired":
            MessageLookupByLibrary.simpleMessage("Vyžaduje sa mobilné číslo"),
        ...
        "multipleSellersDetected":
            MessageLookupByLibrary.simpleMessage("Zistení viacerí predajcovia"),
        ...
        "noBlog": MessageLookupByLibrary.simpleMessage(
            "Ops, zdá sa, že blog už neexistuje"),
        ...
        "noForwardHistoryItem":
            MessageLookupByLibrary.simpleMessage("Žiadna história dopredu"),
        ...
        "noPost": MessageLookupByLibrary.simpleMessage(
            "Ops, zdá sa, že táto stránka už neexistuje!"),
        ...
        "noSlotAvailable":
            MessageLookupByLibrary.simpleMessage("Žiadny dostupný slot"),
        "noStoreNearby": MessageLookupByLibrary.simpleMessage(
            "V okolí nie je žiadny obchod!"),
        "noSuggestionSearch":
            MessageLookupByLibrary.simpleMessage("Žiadne návrhy"),
        ...
        "oneEachRecipient":
            MessageLookupByLibrary.simpleMessage("1 pre každého príjemcu"),
        ...
        "openingHours":
            MessageLookupByLibrary.simpleMessage("Otváracie hodiny"),
        ...
        "orderIdWithoutColon":
            MessageLookupByLibrary.simpleMessage("ID objednávky"),
        ...
        "orderStatusCanceledReversal":
            MessageLookupByLibrary.simpleMessage("Zrušené storno"),
        ...
        "orderStatusCompleted":
            MessageLookupByLibrary.simpleMessage("Dokončené"),
        "orderStatusDenied": MessageLookupByLibrary.simpleMessage("Zamietnuté"),
        "orderStatusExpired":
            MessageLookupByLibrary.simpleMessage("Expirované"),
        "orderStatusFailed": MessageLookupByLibrary.simpleMessage("Zlyhalo"),
        "orderStatusOnHold":
            MessageLookupByLibrary.simpleMessage("Pozastavené"),
        ...
        "orderStatusProcessed":
            MessageLookupByLibrary.simpleMessage("Spracované"),
        "orderStatusProcessing":
            MessageLookupByLibrary.simpleMessage("Spracováva sa"),
        ...
        "orderSuccessMsg1": MessageLookupByLibrary.simpleMessage(
            "Stav svojej objednávky môžete skontrolovať pomocou našej funkcie stavu doručenia. Dostanete e-mail s potvrdením objednávky s podrobnosťami o vašej objednávke a odkazom na sledovanie jej priebehu."),
        "orderSuccessMsg2": MessageLookupByLibrary.simpleMessage(
            "Do svojho účtu sa môžete prihlásiť pomocou e-mailu a hesla definovaného skôr. Na svojom účte môžete upravovať údaje svojho profilu, kontrolovať históriu transakcií, upravovať odber newslettera."),
        "orderSuccessTitle1": MessageLookupByLibrary.simpleMessage(
            "Úspešne ste zadali objednávku"),
        "orderSuccessTitle2": MessageLookupByLibrary.simpleMessage("Váš účet"),
        "orderSummary":
            MessageLookupByLibrary.simpleMessage("Prehľad objednávky"),
        "orderTotal":
        ...
        "otpVerification":
            MessageLookupByLibrary.simpleMessage("Overenie OTP kódom"),
        "ourBankDetails":
        ...
        "passwordIsRequired":
            MessageLookupByLibrary.simpleMessage("Vyžaduje sa heslo"),
        "passwordsDoNotMatch":
            MessageLookupByLibrary.simpleMessage("Heslá sa nezhodujú"),
        "pasteYourImageUrl":
            MessageLookupByLibrary.simpleMessage("Vložte URL adresu obrázka"),
        "payByWallet":
            MessageLookupByLibrary.simpleMessage("Zaplatiť peňaženkou"),
        ...
        "pendingReviews":
            MessageLookupByLibrary.simpleMessage("Čakajúce recenzie"),
        ...
        "pleaseAddPrice":
            MessageLookupByLibrary.simpleMessage("Prosím pridajte cenu"),
        ...
        "pleaseChooseBranch":
            MessageLookupByLibrary.simpleMessage("Prosím, vyberte pobočku"),
        ...
        "pleaseFillCode":
            MessageLookupByLibrary.simpleMessage("Prosím vyplňte svoj kód"),
        ...
        "pointMsgEnter":
            MessageLookupByLibrary.simpleMessage("Prosím zadajte zľavové body"),
        ...
        "postImageFeature":
            MessageLookupByLibrary.simpleMessage("Obrázková funkcia"),
        "postManagement":
            MessageLookupByLibrary.simpleMessage("Správa príspevkov"),
        ...
        "priceHighToLow":
            MessageLookupByLibrary.simpleMessage("Cena: od najvyššej"),
        "priceLowToHigh":
            MessageLookupByLibrary.simpleMessage("Cena: od najnižšej"),
        ...
        "productAdded":
            MessageLookupByLibrary.simpleMessage("Produkt bol pridaný"),
        ...
        "productOverview":
            MessageLookupByLibrary.simpleMessage("Prehľad produktu"),
        "productRating":
        ...
        "rateProduct":
            MessageLookupByLibrary.simpleMessage("Ohodnotiť produkt"),
        "rateTheApp":
        ...
        "rateThisAppDescription": MessageLookupByLibrary.simpleMessage(
            "Ak sa vám táto aplikácia páči, venujte jej chvíľu svojho času a ohodnoťte ju!\nNaozaj nám to pomáha a nemalo by vám to zabrať viac ako minútu."),
        ...
        "readyToPick":
            MessageLookupByLibrary.simpleMessage("Pripravené na vyzdvihnutie"),
        "receivedMoney":
        ...
        "recentSearches":
            MessageLookupByLibrary.simpleMessage("História vyhľadávania"),
        "recentView":
        ...
        "refundRequest":
            MessageLookupByLibrary.simpleMessage("Žiadosť o vrátenie peňazí"),
        ...
        "regenerateResponse":
            MessageLookupByLibrary.simpleMessage("Vygenerovať odpoveď znova"),
        "registerAs":
            MessageLookupByLibrary.simpleMessage("Zaregistrovať sa ako"),
        ...
        "releaseToLoadMore":
            MessageLookupByLibrary.simpleMessage("Uvoľnením načítate viac"),
        ...
        "requestBooking":
            MessageLookupByLibrary.simpleMessage("Požiadať o rezerváciu"),
        "requestTooMany": MessageLookupByLibrary.simpleMessage(
            "Požiadali ste o príliš veľa kódov v krátkom čase. Skúste to neskôr prosím."),
        ...
        "saveAddressSuccess":
            MessageLookupByLibrary.simpleMessage("Vaša adresa existuje"),
        "saveForLater":
        ...
        "searchForItems":
            MessageLookupByLibrary.simpleMessage("Hľadať položky"),
        ...
        "searchingAddress":
            MessageLookupByLibrary.simpleMessage("Vyhľadávanie adresy"),
        "secondsAgo": m46,
        ...
        "selectPrinter":
            MessageLookupByLibrary.simpleMessage("Vybrať tlačiareň"),
        ...
        "selectTheQuantity":
            MessageLookupByLibrary.simpleMessage("Vyberte množstvo"),
        "selectTheSize":
            MessageLookupByLibrary.simpleMessage("Vyberte veľkosť"),
        ...
        "sendSMStoVendor":
            MessageLookupByLibrary.simpleMessage("Poslať SMS predajcovi"),
        "sendTo":
            MessageLookupByLibrary.simpleMessage("Poslať na účet (e-mail)"),
        ...
        "shareProductData":
            MessageLookupByLibrary.simpleMessage("Zdieľajte údaje o produkte"),
        "shareProductLink":
            MessageLookupByLibrary.simpleMessage("Zdieľať odkaz na produkt"),
        ...
        "shortDescription":
            MessageLookupByLibrary.simpleMessage("Krátky popis"),
        ...
        "somethingWrong": MessageLookupByLibrary.simpleMessage(
            "Niečo sa pokazilo. Skúste to neskôr prosím."),
        ...
        "startExploring":
            MessageLookupByLibrary.simpleMessage("Začnite objavovať"),
        "startShopping":
        ...
        "stockQuantity":
            MessageLookupByLibrary.simpleMessage("Množstvo na sklade"),
        ...
        "storeClosed":
            MessageLookupByLibrary.simpleMessage("Obchod je teraz zatvorený"),
        "storeEmail": MessageLookupByLibrary.simpleMessage("E-mail obchodu"),
        "storeInformation":
            MessageLookupByLibrary.simpleMessage("Informácie o obchode"),
        "storeListBanner":
            MessageLookupByLibrary.simpleMessage("Banner zoznamu obchodov"),
        "storeLocation":
            MessageLookupByLibrary.simpleMessage("Lokalita obchodu"),
        "storeLocatorSearchPlaceholder":
            MessageLookupByLibrary.simpleMessage("Zadajte adresu alebo mesto"),
        "storeLogo": MessageLookupByLibrary.simpleMessage("Logo obchodu"),
        "storeMobileBanner":
            MessageLookupByLibrary.simpleMessage("Mobilný banner obchodu"),
        "storeSettings":
            MessageLookupByLibrary.simpleMessage("Nastavenia obchodu"),
        "storeSliderBanner":
            MessageLookupByLibrary.simpleMessage("Posuvný banner"),
        "storeStaticBanner":
            MessageLookupByLibrary.simpleMessage("Statický banner"),
        "storeVacation":
            MessageLookupByLibrary.simpleMessage("Dovolenka obchodu"),
        ...
        "streetIsRequired":
            MessageLookupByLibrary.simpleMessage("Pole názov ulice je povinné"),
        ...
        "submitYourPost":
            MessageLookupByLibrary.simpleMessage("Odoslať váš príspevok"),
        ...
        "thailand": MessageLookupByLibrary.simpleMessage("Thajský"),
        ...
        "thisIsCustomerRole":
            MessageLookupByLibrary.simpleMessage("Toto je rola zákazníka"),
        "thisIsVendorRole":
        ...
        "transactionFailed":
            MessageLookupByLibrary.simpleMessage("Transakcia zlyhala"),
        "transactionFee":
            MessageLookupByLibrary.simpleMessage("Transakčný poplatok"),
        "transactionResult":
        ...
        "transferMoneyTo": m51,
        "transferSuccess":
            MessageLookupByLibrary.simpleMessage("Prevod úspešný"),
        ...
        "typeYourMessage":
            MessageLookupByLibrary.simpleMessage("Napíšte svoju správu tu..."),
        ...
        "updateFailed":
            MessageLookupByLibrary.simpleMessage("Aktualizácia zlyhala!"),
        "updateInfo":
        ...
        "useThisImage":
            MessageLookupByLibrary.simpleMessage("Použiť tento obrázok"),
        "userExists": MessageLookupByLibrary.simpleMessage(
            "Toto používateľské meno/e-mail nie je dostupný."),
        "userHasBeenBlocked":
            MessageLookupByLibrary.simpleMessage("Používateľ bol zablokovaný"),
        "userNameInCorrect": MessageLookupByLibrary.simpleMessage(
            "Nesprávne používateľské meno alebo heslo"),
        "userNotFound":
            MessageLookupByLibrary.simpleMessage("Používateľ nebol nájdený"),
        ...
        "usernameInvalid":
            MessageLookupByLibrary.simpleMessage("Neplatné používateľské meno"),
        ...
        "viewOrder":
            MessageLookupByLibrary.simpleMessage("Zobraziť objednávku"),
        "viewRecentTransactions":
            MessageLookupByLibrary.simpleMessage("Zobraziť nedávne transakcie"),
        ...
        "weFoundBlogs":
            MessageLookupByLibrary.simpleMessage("Našli sme blog(y)"),
        "weFoundProducts": m58,
        ...
        "withdrawRequest":
            MessageLookupByLibrary.simpleMessage("Žiadosť o výber"),
        ...
        "writeComment":
            MessageLookupByLibrary.simpleMessage("Napíšte svoj komentár"),
        "writeYourNote":
            MessageLookupByLibrary.simpleMessage("Napíšte svoju poznámku"),
        "yearsAgo": m61,
        ...
        "youCanOnlyPurchase":
            MessageLookupByLibrary.simpleMessage("Môžete kúpiť iba"),
        ...
        "yourApplicationIsUnderReview":
            MessageLookupByLibrary.simpleMessage("Vaša žiadosť sa kontroluje"),
        "yourBagIsEmpty":
            MessageLookupByLibrary.simpleMessage("Váš košík je prázdny"),
        "yourBookingDetail":
            MessageLookupByLibrary.simpleMessage("Detaily vašej rezervácie"),
        "yourEarningsThisMonth":
            MessageLookupByLibrary.simpleMessage("Vaše zárobky tento mesiac"),
        ...
        "yourProductIsUnderReview":
            MessageLookupByLibrary.simpleMessage("Váš produkt sa kontroluje"),
