...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(currency) => "S\'ha canviat la moneda a ${currency}";

  static String m8(number) => " Queden${number} caràcters";

  static String m9(priceRate, pointRate) => "${priceRate} = ${pointRate} Punts";
  ...
  static String m13(count) => "${count} elements";

  static String m14(country) => "El país ${country} no està suportat";

  static String m15(currency) => "${currency} no està suportat";

  static String m16(day) => "fa ${day} dies";

  static String m17(total) => "~${total} km";

  static String m18(timeLeft) => "Acaba en ${timeLeft}";

  static String m19(captcha) => "Introdueix ${captcha} per confirmar:";

  static String m20(message) => "Error: ${message}";

  static String m21(message) => "Error: ${message}";

  static String m22(time) => "Caduca en ${time}";

  static String m23(total) => "Més de ${total} km";

  static String m24(hour) => "fa ${hour} hores";
  ...
  static String m28(size) => "Mida màxima del fitxer: ${size} MB";

  static String m30(currency, amount) =>
      "L’import mínim per utilitzar aquest pagament és ${currency} ${amount}";

  static String m31(minute) => "fa ${minute} minuts";

  static String m32(month) => "Fa ${month} mesos";

  static String m33(store) => "Més de ${store}";

  static String m34(number) => "s\'ha de comprar en grups de ${number}";

  static String m35(itemCount) => "${itemCount} articles";

  static String m36(price) => "Total d\'opcions: ${price}";

  static String m37(amount) => "Pagar ${amount}";

  static String m38(name) => " S\'han afegit${name} al carretó correctament";

  static String m39(total) => "Quantitat: ${total}";

  static String m40(name) => "S\'ha rebut diners de ${name}";

  static String m42(percent) => "${percent}% de descompte";

  static String m43(keyword) => "Resultats de la cerca per a: \"${keyword}\"";

  static String m44(keyword, count) => "${keyword} (${count} element)";

  static String m45(keyword, count) => "${keyword} (${count} elements)";

  static String m46(second) => "fa ${second} segons";

  static String m47(totalCartQuantity) =>
      "Carret de compra, ${totalCartQuantity} articles";

  static String m48(numberOfUnitsSold) => "Venut: ${numberOfUnitsSold}";

  static String m49(fieldName) => "El camp ${fieldName} és obligatori";

  static String m50(total) => "${total} productes";

  static String m51(name) => "Transfereix diners a ${name}";
  ...
  static String m53(date) => "Vàlid fins al ${date}";

  static String m55(balance) => "Saldo de Wallet: ${balance}";

  static String m56(message) => "Avís: ${message}";
  ...
  static String m58(length) => "Hem trobat ${length} productes";

  static String m59(week) => "Setmana ${week}";

  static String m60(name) => "Benvingut/da ${name}";

  static String m61(year) => "Fa ${year} anys";

  static String m63(total) => "T\'han assignat la comanda #${total}";

  static String m64(point) => "Tens ${point} punts";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addANewPost":
            MessageLookupByLibrary.simpleMessage("Afegeix una nova publicació"),
        "addASlug":
            MessageLookupByLibrary.simpleMessage("Afegeix una URL amigable"),
        ...
        "addNewBlog":
            MessageLookupByLibrary.simpleMessage("Afegeix un nou blog"),
        "addNewPost":
            MessageLookupByLibrary.simpleMessage("Crea una nova publicació"),
        ...
        "addToOrder":
            MessageLookupByLibrary.simpleMessage("Afegeix a la comanda"),
        ...
        "almostSoldOut":
            MessageLookupByLibrary.simpleMessage("Gairebé esgotat"),
        ...
        "backToWallet":
            MessageLookupByLibrary.simpleMessage("Torna a la cartera"),
        "bagsCollections":
            MessageLookupByLibrary.simpleMessage("Col·leccions de bosses"),
        "balance": MessageLookupByLibrary.simpleMessage("Saldo"),
        "bank": MessageLookupByLibrary.simpleMessage("Banc"),
        "bannerListType":
            MessageLookupByLibrary.simpleMessage("Tipus de llista de bàners"),
        "bannerType": MessageLookupByLibrary.simpleMessage("Tipus de bàner"),
        "bannerYoutubeURL":
            MessageLookupByLibrary.simpleMessage("URL de Youtube del bàner"),
        "basicInformation":
        ...
        "bookingSuccess":
            MessageLookupByLibrary.simpleMessage("Reservat correctament"),
        "bookingSummary":
        ...
        "cartDiscount":
            MessageLookupByLibrary.simpleMessage("Descompte del carret"),
        ...
        "changePrinter":
            MessageLookupByLibrary.simpleMessage("Canvia la impressora"),
        ...
        "checking":
            MessageLookupByLibrary.simpleMessage("S\'està comprovant..."),
        ...
        "chooseFromGallery":
            MessageLookupByLibrary.simpleMessage("Triar de la galeria"),
        "chooseFromServer":
            MessageLookupByLibrary.simpleMessage("Triar del servidor"),
        ...
        "cityIsRequired":
            MessageLookupByLibrary.simpleMessage("La ciutat és obligatòria"),
        ...
        "clearConversation":
            MessageLookupByLibrary.simpleMessage("Neteja la conversa"),
        ...
        "continueToPayment":
            MessageLookupByLibrary.simpleMessage("Continuar amb el pagament"),
        "continueToReview":
            MessageLookupByLibrary.simpleMessage("Continuar amb la revisió"),
        "continueToShipping":
            MessageLookupByLibrary.simpleMessage("Continuar amb l\'enviament"),
        ...
        "countryIsRequired":
            MessageLookupByLibrary.simpleMessage("El país és obligatori"),
        ...
        "createPost":
            MessageLookupByLibrary.simpleMessage("Crea una publicació"),
        ...
        "createVariants":
            MessageLookupByLibrary.simpleMessage("Crea totes les variants"),
        ...
        "deliveryDetails":
            MessageLookupByLibrary.simpleMessage("Detalls del lliurament"),
        "deliveryManagement":
            MessageLookupByLibrary.simpleMessage("Gestió de lliuraments"),
        ...
        "disablePurchase":
            MessageLookupByLibrary.simpleMessage("Desactiva la compra"),
        ...
        "enableForCheckout":
            MessageLookupByLibrary.simpleMessage("Activa per al pagament"),
        "enableForLogin": MessageLookupByLibrary.simpleMessage(
            "Activa per a l\'inici de sessió"),
        "enableForWallet":
            MessageLookupByLibrary.simpleMessage("Activa per a la cartera"),
        "enableVacationMode":
            MessageLookupByLibrary.simpleMessage("Activa el mode vacances"),
        ...
        "expectedDeliveryDate":
            MessageLookupByLibrary.simpleMessage("Data prevista de lliurament"),
        ...
        "finishSetup":
            MessageLookupByLibrary.simpleMessage("Finalitza la configuració"),
        ...
        "fixedCartDiscount":
            MessageLookupByLibrary.simpleMessage("Descompte fix al carret"),
        "fixedProductDiscount":
            MessageLookupByLibrary.simpleMessage("Descompte fix al producte"),
        "forThisProduct":
        ...
        "getNotified":
            MessageLookupByLibrary.simpleMessage("Rep notificacions!"),
        ...
        "hasBeenDeleted":
            MessageLookupByLibrary.simpleMessage("s\'ha suprimit"),
        "hebrew": MessageLookupByLibrary.simpleMessage("Hebreu"),
        "hideAbout":
            MessageLookupByLibrary.simpleMessage("Amaga l\'apartat \'Sobre\'"),
        "hideAddress": MessageLookupByLibrary.simpleMessage("Amaga l\'adreça"),
        "hideEmail":
            MessageLookupByLibrary.simpleMessage("Amaga el correu electrònic"),
        ...
        "imageNetwork":
            MessageLookupByLibrary.simpleMessage("Xarxa d\'imatges"),
        ...
        "itemTotal":
            MessageLookupByLibrary.simpleMessage("Total d\'articles: "),
        "items": MessageLookupByLibrary.simpleMessage("articles"),
        "itsOrdered":
            MessageLookupByLibrary.simpleMessage("Comanda realitzada!"),
        ...
        "lastNameIsRequired":
            MessageLookupByLibrary.simpleMessage("Els cognoms són obligatoris"),
        "lastTransactions":
            MessageLookupByLibrary.simpleMessage("Últimes transaccions"),
        "latestProducts":
            MessageLookupByLibrary.simpleMessage("Últims productes"),
        ...
        "loadFail":
            MessageLookupByLibrary.simpleMessage("Ha fallat la càrrega!"),
        ...
        "markAsRead":
            MessageLookupByLibrary.simpleMessage("Marca com a llegit"),
        "markAsShipped":
            MessageLookupByLibrary.simpleMessage("Marca com a enviat"),
        "markAsUnread":
            MessageLookupByLibrary.simpleMessage("Marca com a no llegit"),
        ...
        "messageTo":
            MessageLookupByLibrary.simpleMessage("Envia un missatge a"),
        ...
        "noFavoritesYet":
            MessageLookupByLibrary.simpleMessage("Encara no tens preferits"),
        ...
        "noSlotAvailable":
            MessageLookupByLibrary.simpleMessage("No hi ha places disponibles"),
        "noStoreNearby":
        ...
        "orderStatusChargeBack":
            MessageLookupByLibrary.simpleMessage("Càrrec retornat"),
        ...
        "orderStatusProcessing":
            MessageLookupByLibrary.simpleMessage("En procés"),
        "orderStatusRefunded":
        ...
        "payByWallet":
            MessageLookupByLibrary.simpleMessage("Paga amb la cartera"),
        ...
        "phoneHintFormat":
            MessageLookupByLibrary.simpleMessage("Format: +34123456789"),
        ...
        "pointMsgMaximumDiscountPoint":
            MessageLookupByLibrary.simpleMessage("Punt màxim de descompte"),
        ...
        "priceHighToLow":
            MessageLookupByLibrary.simpleMessage("Preu: De major a menor"),
        "priceLowToHigh":
            MessageLookupByLibrary.simpleMessage("Preu: De menor a major"),
        "prices": MessageLookupByLibrary.simpleMessage("Preus"),
        "printReceipt":
            MessageLookupByLibrary.simpleMessage("Imprimeix el rebut"),
        ...
        "printing":
            MessageLookupByLibrary.simpleMessage("S\'està imprimint..."),
        "privacyAndTerm":
            MessageLookupByLibrary.simpleMessage("Privacitat i termes"),
        "privacyPolicy":
            MessageLookupByLibrary.simpleMessage("Política de privadesa"),
        "privacyTerms":
            MessageLookupByLibrary.simpleMessage("Privadesa i condicions"),
        ...
        "productReview":
            MessageLookupByLibrary.simpleMessage("Ressenya del producte"),
        "productType":
        ...
        "regenerateResponse":
            MessageLookupByLibrary.simpleMessage("Regenera la resposta"),
        ...
        "relatedLayoutTitle":
            MessageLookupByLibrary.simpleMessage("Blogs relacionats"),
        "releaseToLoadMore":
            MessageLookupByLibrary.simpleMessage("Deixa anar per carregar més"),
        ...
        "saveForLater":
            MessageLookupByLibrary.simpleMessage("Desar per més tard"),
        ...
        "searchForItems":
            MessageLookupByLibrary.simpleMessage("Cercar articles"),
        "searchInput": MessageLookupByLibrary.simpleMessage(
            "Si us plau, escriu la teva cerca"),
        "searchOrderId":
            MessageLookupByLibrary.simpleMessage("Cercar per ID de comanda..."),
        ...
        "selectAddress":
            MessageLookupByLibrary.simpleMessage("Selecciona l\'adreça"),
        ...
        "selectImage":
            MessageLookupByLibrary.simpleMessage("Seleccionar imatge"),
        "selectNone":
            MessageLookupByLibrary.simpleMessage("No seleccionis res"),
        "selectPrinter":
            MessageLookupByLibrary.simpleMessage("Selecciona la impressora"),
        ...
        "selectTheFile":
            MessageLookupByLibrary.simpleMessage("Selecciona el fitxer"),
        "selectThePoint":
            MessageLookupByLibrary.simpleMessage("Selecciona els punts"),
        "selectTheQuantity":
        ...
        "shopSlug":
            MessageLookupByLibrary.simpleMessage("URL amigable de la botiga"),
        "shoppingCartItems": m47,
        "shortDescription":
            MessageLookupByLibrary.simpleMessage("Descripció breu"),
        ...
        "speechNotAvailable":
            MessageLookupByLibrary.simpleMessage("La parla no està disponible"),
        "startExploring":
            MessageLookupByLibrary.simpleMessage("Comença a explorar"),
        "startShopping":
            MessageLookupByLibrary.simpleMessage("Començar a comprar"),
        "state": MessageLookupByLibrary.simpleMessage("Estat"),
        "stateIsRequired":
            MessageLookupByLibrary.simpleMessage("La província és obligatòria"),
        ...
        "storeSliderBanner":
            MessageLookupByLibrary.simpleMessage("Bàner lliscant de la botiga"),
        "storeStaticBanner":
        ...
        "turnOnBle":
            MessageLookupByLibrary.simpleMessage("Activa el Bluetooth"),
        "typeAMessage":
        ...
        "updateFailed":
            MessageLookupByLibrary.simpleMessage("Ha fallat l\'actualització!"),
        "updateInfo":
            MessageLookupByLibrary.simpleMessage("Actualitzar informació"),
        "updatePassword":
            MessageLookupByLibrary.simpleMessage("Actualitza la contrasenya"),
        "updateStatus":
        ...
        "viaWallet":
            MessageLookupByLibrary.simpleMessage("Mitjançant la cartera"),
        ...
        "weFoundBlogs":
            MessageLookupByLibrary.simpleMessage("Hem trobat blog(s)"),
        "weFoundProducts": m58,
        ...
        "youHavePoints": m64,
        "youMightAlsoLike":
            MessageLookupByLibrary.simpleMessage("També et podria agradar"),
        ...
        "yourBagIsEmpty":
            MessageLookupByLibrary.simpleMessage("El teu carret està buit"),
        "yourBookingDetail":
            MessageLookupByLibrary.simpleMessage("Detalls de la teva reserva"),
        ...
        "zipCodeIsRequired":
            MessageLookupByLibrary.simpleMessage("El codi postal és obligatori")
      };
}
