...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(fieldName) => "${fieldName} får inte vara tomt.";

  static String m6(fieldName) =>
      "${fieldName} får inte vara kortare än 3 tecken.";

  static String m7(currency) => "Ändrade valuta till ${currency}";

  static String m8(number) => "${number} tecken kvar";

  static String m9(priceRate, pointRate) => "${priceRate} = ${pointRate} poäng";

  static String m10(count) => "${count} artikel";

  static String m11(count) => "${count} artiklar";

  static String m12(count) => "${count} artikel";

  static String m13(count) => "${count} artiklar";

  static String m14(country) => "${country} stöds inte";

  static String m15(currency) => "${currency} stöds inte";

  static String m16(day) => "${day} dagar sedan";

  static String m17(total) => "~${total} km";

  static String m18(timeLeft) => "Slutar om ${timeLeft}";

  static String m19(captcha) => "Ange ${captcha} för att bekräfta:";

  static String m20(message) => "Fel: ${message}";

  static String m21(message) => "Fel: ${message}";

  static String m22(time) => "Går ut om ${time}";

  static String m23(total) => ">${total} km";

  static String m24(hour) => "${hour} timmar sedan";
  ...
  static String m28(size) => "Maximal filstorlek: ${size} MB";
  ...
  static String m31(minute) => "För ${minute} minuter sedan";

  static String m32(month) => "För ${month} månader sedan";

  static String m33(store) => "Mer från ${store}";

  static String m34(number) => "Måste köpas i grupper om ${number}";

  static String m35(itemCount) => "${itemCount} artiklar";

  static String m36(price) => "Totalt antal alternativ: ${price}";

  static String m37(amount) => "Betala ${amount}";

  static String m38(name) => "${name} har lagts till i kundvagnen";

  static String m39(total) => "Antal: ${total}";

  static String m40(name) => "Tog emot pengar från ${name}";

  static String m41(count) =>
      "Vill du ta bort ${count} artikel/artiklar från din önskelista?";

  static String m42(percent) => "Rea ${percent}%";

  static String m43(keyword) => "Sökresultat för: \'${keyword}\'";

  static String m44(keyword, count) => "${keyword} (${count} objekt)";

  static String m45(keyword, count) => "${keyword} (${count} objekt)";

  static String m46(second) => "För ${second} sekunder sedan";

  static String m47(totalCartQuantity) =>
      "Kundvagn, ${totalCartQuantity} artiklar";

  static String m48(numberOfUnitsSold) => "Såld: ${numberOfUnitsSold}";

  static String m49(fieldName) => "Fältet ${fieldName} är obligatoriskt";

  static String m50(total) => "${total} produkter";

  static String m51(name) => "Överför pengar till ${name}";
  ...
  static String m53(date) => "Giltig till ${date}";

  static String m54(number) => "Version ${number}";

  static String m55(balance) => "Plånbokssaldo: ${balance}";

  static String m56(message) => "Varning: ${message}";
  ...
  static String m58(length) => "Vi hittade ${length} produkter";

  static String m59(week) => "Vecka ${week}";

  static String m60(name) => "Välkommen ${name}";

  static String m61(year) => "För ${year} år sedan";

  static String m62(count) => "Du väljer ${count} artikel/artiklar";

  static String m63(total) => "Du har tilldelats order nr${total}";

  static String m64(point) => "Du har ${point} poäng";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "accountApprovalTitle":
            MessageLookupByLibrary.simpleMessage("Under granskning"),
        ...
        "addMessage":
            MessageLookupByLibrary.simpleMessage("Lägg till meddelande"),
        ...
        "addToCartSuccessfully":
            MessageLookupByLibrary.simpleMessage("Har lagts till i kundvagnen"),
        "addToOrder": MessageLookupByLibrary.simpleMessage("Lägg till i order"),
        "addToQuoteRequest":
            MessageLookupByLibrary.simpleMessage("Lägg till i offertförfrågan"),
        "addToWishlist":
        ...
        "addingYourImage":
            MessageLookupByLibrary.simpleMessage("Lägger till din bild"),
        ...
        "attributeAlreadyExists":
            MessageLookupByLibrary.simpleMessage("Attributet finns redan"),
        ...
        "backToShop":
            MessageLookupByLibrary.simpleMessage("Tillbaka till butiken"),
        "backToWallet":
            MessageLookupByLibrary.simpleMessage("Tillbaka till plånboken"),
        "bagsCollections":
            MessageLookupByLibrary.simpleMessage("Väskkollektion"),
        ...
        "bookingCancelled":
            MessageLookupByLibrary.simpleMessage("Bokning avbokad"),
        ...
        "bookingSuccess":
            MessageLookupByLibrary.simpleMessage("Bokning genomförd"),
        "bookingSummary":
        ...
        "byAppointmentOnly":
            MessageLookupByLibrary.simpleMessage("Endast efter tidsbokning"),
        "byAuthor": m4,
        ...
        "canNotCreateOrder":
            MessageLookupByLibrary.simpleMessage("Kan inte skapa order"),
        "canNotCreateUser":
        ...
        "cancelOrder":
            MessageLookupByLibrary.simpleMessage("Avbryt beställning"),
        ...
        "chineseTraditional":
            MessageLookupByLibrary.simpleMessage("Traditionell kinesiska"),
        ...
        "clearConversation":
            MessageLookupByLibrary.simpleMessage("Rensa konversation"),
        ...
        "codExtraFee":
            MessageLookupByLibrary.simpleMessage("Postförskottsavgift"),
        ...
        "continueToReview":
            MessageLookupByLibrary.simpleMessage("Fortsätt till granskning"),
        "continueToSelectItem":
            MessageLookupByLibrary.simpleMessage("Fortsätt välja artiklar"),
        "continueToShipping":
        ...
        "couponHasBeenSavedSuccessfully":
            MessageLookupByLibrary.simpleMessage("Kupongen har sparats."),
        "couponInvalid":
        ...
        "dateWiseClose":
            MessageLookupByLibrary.simpleMessage("Stänger datumvis"),
        "daysAgo": m16,
        ...
        "deleteConversation":
            MessageLookupByLibrary.simpleMessage("Radera konversation"),
        ...
        "didntReceiveCode":
            MessageLookupByLibrary.simpleMessage("Fick du ingen kod?"),
        ...
        "downloadingImages":
            MessageLookupByLibrary.simpleMessage("Laddar ner bilder..."),
        ...
        "emailIsRequired":
            MessageLookupByLibrary.simpleMessage("E-postadress krävs"),
        "emailSubscription":
        ...
        "emptyUsername":
            MessageLookupByLibrary.simpleMessage("Användarnamn/e-post är tomt"),
        ...
        "enableForWallet":
            MessageLookupByLibrary.simpleMessage("Aktivera för plånbok"),
        "enableVacationMode":
        ...
        "enterYourFirstName":
            MessageLookupByLibrary.simpleMessage("Ange ditt förnamn"),
        "enterYourLastName":
        ...
        "featureProducts":
            MessageLookupByLibrary.simpleMessage("Utvalda produkter"),
        ...
        "firstNameIsRequired":
            MessageLookupByLibrary.simpleMessage("Förnamn krävs"),
        "firstRenewal":
            MessageLookupByLibrary.simpleMessage("Första förnyelsen"),
        "fixedCartDiscount":
            MessageLookupByLibrary.simpleMessage("Fast kundvagnsrabatt"),
        ...
        "generalSetting":
            MessageLookupByLibrary.simpleMessage("Allmänna inställningar"),
        "generatingLink":
            MessageLookupByLibrary.simpleMessage("Genererar länk..."),
        "german": MessageLookupByLibrary.simpleMessage("tyska"),
        "getNotification":
            MessageLookupByLibrary.simpleMessage("Få aviseringar"),
        ...
        "goBackToAddress":
            MessageLookupByLibrary.simpleMessage("Gå tillbaka till adress"),
        "goBackToReview":
            MessageLookupByLibrary.simpleMessage("Gå tillbaka till granskning"),
        "goBackToShipping":
        ...
        "instantlyClose":
            MessageLookupByLibrary.simpleMessage("Stäng omedelbart"),
        ...
        "lastNameIsRequired":
            MessageLookupByLibrary.simpleMessage("Efternamn krävs"),
        "lastTransactions":
        ...
        "listBannerVideo":
            MessageLookupByLibrary.simpleMessage("Lista bannervideo"),
        ...
        "loginRequired":
            MessageLookupByLibrary.simpleMessage("Inloggning krävs"),
        "loginSuccess":
            MessageLookupByLibrary.simpleMessage("Inloggningen lyckades!"),
        "loginToComment":
            MessageLookupByLibrary.simpleMessage("Logga in för att kommentera"),
        "loginToContinue":
            MessageLookupByLibrary.simpleMessage("Logga in för att fortsätta"),
        "loginToReview":
            MessageLookupByLibrary.simpleMessage("Logga in för att recensera"),
        "loginToYourAccount":
        ...
        "manCollections":
            MessageLookupByLibrary.simpleMessage("Herrkollektion"),
        "manageApiKey":
        ...
        "markAsShipped":
            MessageLookupByLibrary.simpleMessage("Markera som skickad"),
        "markAsUnread":
        ...
        "mobileIsRequired":
            MessageLookupByLibrary.simpleMessage("Mobilnummer krävs"),
        "mobileNumberInUse":
            MessageLookupByLibrary.simpleMessage("Mobilnumret används redan!"),
        "mobileVerification":
            MessageLookupByLibrary.simpleMessage("Mobilverifiering"),
        "momentAgo":
            MessageLookupByLibrary.simpleMessage("Ett ögonblick sedan"),
        ...
        "multipleSellersDetected":
            MessageLookupByLibrary.simpleMessage("Flera säljare upptäckta"),
        ...
        "noBackHistoryItem":
            MessageLookupByLibrary.simpleMessage("Ingen historik tillbaka"),
        ...
        "noConversation":
            MessageLookupByLibrary.simpleMessage("Ingen konversation än"),
        ...
        "noForwardHistoryItem":
            MessageLookupByLibrary.simpleMessage("Ingen historik framåt"),
        "noInternetConnection":
            MessageLookupByLibrary.simpleMessage("Ingen internetanslutning"),
        "noListingNearby":
            MessageLookupByLibrary.simpleMessage("Inga annonser i närheten!"),
        ...
        "noSuggestionSearch":
            MessageLookupByLibrary.simpleMessage("Inga förslag hittades"),
        ...
        "noteTransfer":
            MessageLookupByLibrary.simpleMessage("Notering (valfritt)"),
        ...
        "open24Hours":
            MessageLookupByLibrary.simpleMessage("Öppet dygnet runt"),
        ...
        "orderDetail":
            MessageLookupByLibrary.simpleMessage("Beställningsdetaljer"),
        ...
        "orderIdWithoutColon":
            MessageLookupByLibrary.simpleMessage("Ordernummer"),
        ...
        "orderStatusChargeBack":
            MessageLookupByLibrary.simpleMessage("Återdebitering"),
        "orderStatusCompleted":
            MessageLookupByLibrary.simpleMessage("Slutförd"),
        ...
        "orderStatusProcessed":
            MessageLookupByLibrary.simpleMessage("Bearbetad"),
        "orderStatusProcessing":
            MessageLookupByLibrary.simpleMessage("Bearbetar"),
        "orderStatusRefunded":
            MessageLookupByLibrary.simpleMessage("Återbetald"),
        ...
        "orderStatusVoided":
            MessageLookupByLibrary.simpleMessage("Ogiltigförklarad"),
        ...
        "passwordIsRequired":
            MessageLookupByLibrary.simpleMessage("Lösenord krävs"),
        "passwordsDoNotMatch":
        ...
        "pendingReviews":
            MessageLookupByLibrary.simpleMessage("Väntande recensioner"),
        "persian": MessageLookupByLibrary.simpleMessage("persiska"),
        "phone": MessageLookupByLibrary.simpleMessage("Telefon"),
        "phoneEmpty":
            MessageLookupByLibrary.simpleMessage("Telefonnumret är tomt"),
        "phoneHintFormat":
            MessageLookupByLibrary.simpleMessage("Format: +46701234567"),
        "phoneIsRequired":
        ...
        "placeMyOrder":
            MessageLookupByLibrary.simpleMessage("Lägg min beställning"),
        ...
        "pleaseFillCode":
            MessageLookupByLibrary.simpleMessage("Fyll i din kod"),
        "pleaseFillUpAllCellsProperly":
            MessageLookupByLibrary.simpleMessage("* Fyll i alla fält korrekt"),
        ...
        "pleaseInputFillAllFields":
            MessageLookupByLibrary.simpleMessage("Fyll i alla fält"),
        "pleaseSelectADate":
            MessageLookupByLibrary.simpleMessage("Välj ett bokningsdatum"),
        "pleaseSelectALocation":
            MessageLookupByLibrary.simpleMessage("Välj en plats"),
        ...
        "pointMsgMaximumDiscountPoint":
            MessageLookupByLibrary.simpleMessage("Maximal rabattpunkt"),
        ...
        "postManagement":
            MessageLookupByLibrary.simpleMessage("Inläggshantering"),
        "postProduct": MessageLookupByLibrary.simpleMessage("Lägg upp produkt"),
        "postSuccessfully":
            MessageLookupByLibrary.simpleMessage("Ditt inlägg har skapats"),
        ...
        "productAdded":
            MessageLookupByLibrary.simpleMessage("Produkten läggs till"),
        ...
        "receivedMoney":
            MessageLookupByLibrary.simpleMessage("Mottagna pengar"),
        ...
        "recentlyViewed":
            MessageLookupByLibrary.simpleMessage("Nyligen visade"),
        ...
        "regenerateResponse":
            MessageLookupByLibrary.simpleMessage("Generera nytt svar"),
        "registerAs": MessageLookupByLibrary.simpleMessage("Registrera som"),
        "registerAsVendor":
            MessageLookupByLibrary.simpleMessage("Registrera dig som säljare"),
        ...
        "registerSuccess":
            MessageLookupByLibrary.simpleMessage("Registreringen lyckades"),
        "regularPrice": MessageLookupByLibrary.simpleMessage("Ordinarie pris"),
        "relatedLayoutTitle":
            MessageLookupByLibrary.simpleMessage("Saker du kanske gillar"),
        "releaseToLoadMore":
        ...
        "removeWishlist":
            MessageLookupByLibrary.simpleMessage("Ta bort från önskelista"),
        ...
        "searchInput":
            MessageLookupByLibrary.simpleMessage("Skriv input i sökfältet"),
        "searchOrderId":
        ...
        "sendTo":
            MessageLookupByLibrary.simpleMessage("Skicka till konto (e-post)"),
        "separateMultipleEmailWithComma": MessageLookupByLibrary.simpleMessage(
            "Separera flera e-postadresser med kommatecken."),
        "serbian": MessageLookupByLibrary.simpleMessage("serbiska"),
        "sessionExpired":
            MessageLookupByLibrary.simpleMessage("Sessionen har gått ut"),
        ...
        "shareProductData":
            MessageLookupByLibrary.simpleMessage("Dela produktdata"),
        "shareProductLink":
            MessageLookupByLibrary.simpleMessage("Dela produktlänk"),
        ...
        "shopOrders":
            MessageLookupByLibrary.simpleMessage("Butiksbeställningar"),
        ...
        "showAllMyOrdered":
            MessageLookupByLibrary.simpleMessage("Visa alla mina beställda"),
        ...
        "stateIsRequired":
            MessageLookupByLibrary.simpleMessage("Stat/region krävs"),
        ...
        "storeListBanner":
            MessageLookupByLibrary.simpleMessage("Butikslistbanner"),
        ...
        "storeMobileBanner":
            MessageLookupByLibrary.simpleMessage("Butiksmobilbanner"),
        "storeSettings":
            MessageLookupByLibrary.simpleMessage("Butiksinställningar"),
        "storeSliderBanner":
            MessageLookupByLibrary.simpleMessage("Butikssliderbanner"),
        "storeStaticBanner":
        ...
        "streetIsRequired":
            MessageLookupByLibrary.simpleMessage("Gatunamn krävs"),
        ...
        "tagNotExist":
            MessageLookupByLibrary.simpleMessage("Denna tagg finns inte"),
        ...
        "thisIsVendorRole":
            MessageLookupByLibrary.simpleMessage("Detta är säljarrollen"),
        ...
        "transferMoneyTo": m51,
        "transferSuccess":
            MessageLookupByLibrary.simpleMessage("Överföringen lyckades"),
        ...
        "updateFailed":
            MessageLookupByLibrary.simpleMessage("Uppdatering misslyckades!"),
        "updateInfo":
        ...
        "weFoundBlogs":
            MessageLookupByLibrary.simpleMessage("Vi hittade bloggar"),
        "weFoundProducts": m58,
        ...
        "womanCollections":
            MessageLookupByLibrary.simpleMessage("Damkollektion"),
        "writeComment":
            MessageLookupByLibrary.simpleMessage("Skriv din kommentar"),
        "writeYourNote":
        ...
        "yourApplicationIsUnderReview":
            MessageLookupByLibrary.simpleMessage("Din ansökan granskas."),
        "yourBagIsEmpty":
            MessageLookupByLibrary.simpleMessage("Din kundvagn är tom"),
        "yourBookingDetail":
            MessageLookupByLibrary.simpleMessage("Din bokningsinformation"),
        "yourEarningsThisMonth":
            MessageLookupByLibrary.simpleMessage("Dina intäkter denna månad"),
        "yourNote": MessageLookupByLibrary.simpleMessage("Din anteckning"),
        "yourOrderHasBeenAdded":
            MessageLookupByLibrary.simpleMessage("Din order har lagts till"),
        ...
        "yourProductIsUnderReview":
            MessageLookupByLibrary.simpleMessage("Din produkt granskas"),
        "yourUsernameEmail": MessageLookupByLibrary.simpleMessage(
            "Ditt användarnamn eller e-post"),
        "zipCode": MessageLookupByLibrary.simpleMessage("Postnummer"),
        "zipCodeIsRequired":
            MessageLookupByLibrary.simpleMessage("Postnummer krävs")
      };
}
