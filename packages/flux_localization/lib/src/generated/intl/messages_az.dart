...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(point) => "Mövcud xallarınız: ${point}";

  static String m3(state) => "Bluetooth adapteri: ${state}";

  static String m4(author) => "Müəllif: ${author}";

  static String m5(fieldName) => "${fieldName} boş ola bilməz.";

  static String m6(fieldName) => "${fieldName} uzunluğu 3-dən az olmamalıdır.";

  static String m7(currency) => "Valyuta ${currency} olaraq dəyişdirildi";

  static String m8(number) => "${number} simvol qalıb";

  static String m9(priceRate, pointRate) => "${priceRate} = ${pointRate} Xal";

  static String m10(count) => "${count} element";

  static String m11(count) => "${count} element";

  static String m12(count) => "${count} element";

  static String m13(count) => "${count} element";

  static String m14(country) => "${country} ölkə dəstəklənmir";

  static String m15(currency) => "${currency} dəstəklənmir";

  static String m16(day) => "${day} gün əvvəl";

  static String m17(total) => "~${total} km";

  static String m18(timeLeft) => "${timeLeft} müddətində bitir";

  static String m19(captcha) => "Təsdiqləmək üçün ${captcha} daxil edin:";

  static String m20(message) => "Xəta: ${message}";

  static String m21(message) => "Xəta: ${message}";

  static String m22(time) => "${time} müddətində başa çatır";

  static String m23(total) => "${total} km-dən çox";

  static String m24(hour) => "${hour} saat əvvəl";
  ...
  static String m28(size) => "Maksimum fayl ölçüsü: ${size} MB";
  ...
  static String m31(minute) => "${minute} dəqiqə əvvəl";

  static String m32(month) => "${month} ay əvvəl";

  static String m33(store) => "${store} mağazasından daha çox";

  static String m34(number) => " ${number}qruplarında alınmalıdır ";

  static String m35(itemCount) => "${itemCount} məhsul";

  static String m36(price) => "Cəmi seçimlər: ${price}";

  static String m37(amount) => " ${amount}ödəyin ";

  static String m38(name) => "${name} səbətə uğurla əlavə edildi";

  static String m39(total) => "Miqdar: ${total}";

  static String m40(name) => " ${name}tərəfindən pul alındı ";

  static String m41(count) =>
      "İstək siyahınızdan ${count} elementi silmək istəyirsiniz?";

  static String m42(percent) => "${percent}% endirim";

  static String m43(keyword) => "Axtarış nəticələri: \'${keyword}\'";

  static String m44(keyword, count) => "${keyword} (${count} element)";

  static String m45(keyword, count) => "${keyword} (${count} element)";

  static String m46(second) => "${second} saniyə əvvəl";

  static String m47(totalCartQuantity) => "Səbət, ${totalCartQuantity} məhsul";

  static String m48(numberOfUnitsSold) => "Satıldı: ${numberOfUnitsSold}";

  static String m49(fieldName) => " ${fieldName} sahəsi tələb olunur";

  static String m50(total) => "${total} məhsul";

  static String m51(name) => " ${name}hesabına pul köçürün ";
  ...
  static String m53(date) => " ${date}tarixinə qədər etibarlıdır ";

  static String m54(number) => "Versiya ${number}";

  static String m55(balance) => "Pulqabı balansı: ${balance}";

  static String m56(message) => "Xəbərdarlıq: ${message}";
  ...
  static String m58(length) => "${length} məhsul tapıldı";

  static String m59(week) => "Həftə ${week}";

  static String m60(name) => "Xoş gəldiniz ${name}";

  static String m61(year) => "${year} il əvvəl";

  static String m62(count) => "Siz ${count} element(lər) seçirsiniz";

  static String m63(total) => "Siz №${total}sifariş üçün təyin olundunuz ";

  static String m64(point) => "${point} xalınız var";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "accountIsPendingApproval":
            MessageLookupByLibrary.simpleMessage("Hesab təsdiq gözləyir."),
        "accountNumber": MessageLookupByLibrary.simpleMessage("Hesab nömrəsi"),
        "accountSetup":
            MessageLookupByLibrary.simpleMessage("Hesab quraşdırması"),
        ...
        "addingYourImage":
            MessageLookupByLibrary.simpleMessage("Şəkil əlavə edilir"),
        ...
        "backToWallet":
            MessageLookupByLibrary.simpleMessage("Pul kisəsinə qayıt"),
        ...
        "billingAddress":
            MessageLookupByLibrary.simpleMessage("Faktura ünvanı"),
        ...
        "bookingCancelled":
            MessageLookupByLibrary.simpleMessage("Rezervasiya ləğv edildi"),
        "bookingConfirm": MessageLookupByLibrary.simpleMessage("Təsdiqləndi"),
        "bookingError": MessageLookupByLibrary.simpleMessage(
            "Nəsə səhvdir. Zəhmət olmasa bir az sonra yenə cəhd edin."),
        "bookingHistory":
            MessageLookupByLibrary.simpleMessage("Rezervasiya tarixçəsi"),
        "bookingNow": MessageLookupByLibrary.simpleMessage("İndi rezerv et"),
        "bookingSuccess":
            MessageLookupByLibrary.simpleMessage("Uğurla rezerv edildi"),
        "bookingSummary":
            MessageLookupByLibrary.simpleMessage("Rezervasiya xülasəsi"),
        "bookingUnavailable":
            MessageLookupByLibrary.simpleMessage("Rezervasiya mümkün deyil"),
        ...
        "cantPickDateInThePast":
            MessageLookupByLibrary.simpleMessage("Keçmiş tarix icazə verilmir"),
        ...
        "changePrinter":
            MessageLookupByLibrary.simpleMessage("Printeri dəyişdir"),
        ...
        "chatViaWhatApp":
            MessageLookupByLibrary.simpleMessage("WhatsApp ilə söhbət"),
        "chatWithBot":
            MessageLookupByLibrary.simpleMessage("Bot ilə söhbət edin"),
        "chatWithStoreOwner":
            MessageLookupByLibrary.simpleMessage("Mağaza sahibi ilə söhbət"),
        "checkConfirmLink": MessageLookupByLibrary.simpleMessage(
            "E-poçtunuzu təsdiq linki üçün yoxlayın"),
        "checking": MessageLookupByLibrary.simpleMessage("Yoxlanılır..."),
        "checkout":
            MessageLookupByLibrary.simpleMessage("Sifarişi rəsmiləşdir"),
        "chinese": MessageLookupByLibrary.simpleMessage("Çincə"),
        "chineseSimplified":
            MessageLookupByLibrary.simpleMessage("Çincə (Sadələşdirilmiş)"),
        "chineseTraditional":
        ...
        "chooseFromGallery":
            MessageLookupByLibrary.simpleMessage("Qalereyadan seç"),
        "chooseFromServer":
            MessageLookupByLibrary.simpleMessage("Serverdən seç"),
        ...
        "chooseYourPaymentMethod":
            MessageLookupByLibrary.simpleMessage("Ödəniş üsulunu seçin"),
        "city": MessageLookupByLibrary.simpleMessage("Şəhər"),
        "cityIsRequired":
            MessageLookupByLibrary.simpleMessage("Şəhər tələb olunur"),
        ...
        "continueToPayment":
            MessageLookupByLibrary.simpleMessage("Ödənişə keç"),
        "continueToReview": MessageLookupByLibrary.simpleMessage("Baxışa keç"),
        "continueToSelectItem":
            MessageLookupByLibrary.simpleMessage("Elementi seçməyə davam edin"),
        "continueToShipping":
            MessageLookupByLibrary.simpleMessage("Çatdırılmaya keç"),
        ...
        "countryIsRequired":
            MessageLookupByLibrary.simpleMessage("Ölkə tələb olunur"),
        ...
        "couponInvalid":
            MessageLookupByLibrary.simpleMessage("Kupon kodunuz etibarsızdır"),
        "couponMsgSuccess":
            MessageLookupByLibrary.simpleMessage("Kupon uğurla tətbiq edildi"),
        ...
        "createVariants":
            MessageLookupByLibrary.simpleMessage("Bütün variantları yarat"),
        ...
        "currentlyWeOnlyHave":
            MessageLookupByLibrary.simpleMessage("Hal-hazırda yalnız"),
        ...
        "dateBooking":
            MessageLookupByLibrary.simpleMessage("Tarix rezervasiyası"),
        ...
        "dateWiseClose":
            MessageLookupByLibrary.simpleMessage("Tarixə görə bağlı"),
        "daysAgo": m16,
        ...
        "disablePurchase":
            MessageLookupByLibrary.simpleMessage("Alışı deaktiv et"),
        ...
        "downloadingImages":
            MessageLookupByLibrary.simpleMessage("Şəkillər endirilir..."),
        ...
        "emailIsRequired":
            MessageLookupByLibrary.simpleMessage("E-poçt tələb olunur"),
        "emailSubscription":
        ...
        "failedToGenerateLink":
            MessageLookupByLibrary.simpleMessage("Link yaratmaq mümkün olmadı"),
        ...
        "featureProducts":
            MessageLookupByLibrary.simpleMessage("Seçilmiş məhsullar"),
        ...
        "firstNameIsRequired":
            MessageLookupByLibrary.simpleMessage("Ad tələb olunur"),
        "firstRenewal": MessageLookupByLibrary.simpleMessage("İlk Yenilənmə"),
        "fixedCartDiscount":
            MessageLookupByLibrary.simpleMessage("Sabit Səbət Endirimi"),
        ...
        "goBackToShipping":
            MessageLookupByLibrary.simpleMessage("Çatdırılmaya qayıt"),
        ...
        "hideAbout":
            MessageLookupByLibrary.simpleMessage("Haqqında bölməsini gizlət"),
        ...
        "historyTransaction":
            MessageLookupByLibrary.simpleMessage("Əməliyyat tarixçəsi"),
        ...
        "imageGallery":
            MessageLookupByLibrary.simpleMessage("Şəkil Qalereyası"),
        ...
        "invalidSMSCode":
            MessageLookupByLibrary.simpleMessage("Yanlış SMS kodu"),
        "invalidYearOfBirth":
            MessageLookupByLibrary.simpleMessage("Yanlış doğum ili"),
        ...
        "itsOrdered":
            MessageLookupByLibrary.simpleMessage("Sifariş qəbul edildi!"),
        "iwantToCreateAccount":
            MessageLookupByLibrary.simpleMessage("Hesab yaratmaq istəyirəm"),
        ...
        "languageSuccess":
            MessageLookupByLibrary.simpleMessage("Dil uğurla dəyişdirildi"),
        "lao": MessageLookupByLibrary.simpleMessage("Laos"),
        "lastName": MessageLookupByLibrary.simpleMessage("Soyad"),
        "lastNameIsRequired":
            MessageLookupByLibrary.simpleMessage("Soyad tələb olunur"),
        "lastTransactions":
        ...
        "listBannerType":
            MessageLookupByLibrary.simpleMessage("Banner siyahısı növü"),
        "listBannerVideo":
            MessageLookupByLibrary.simpleMessage("Banner video siyahısı"),
        ...
        "loadingLink":
            MessageLookupByLibrary.simpleMessage("Keçid yüklənir..."),
        ...
        "loginCanceled":
            MessageLookupByLibrary.simpleMessage("Giriş ləğv edildi"),
        ...
        "loginRequired":
            MessageLookupByLibrary.simpleMessage("Giriş Tələb olunur"),
        "loginSuccess":
            MessageLookupByLibrary.simpleMessage("Uğurla daxil oldunuz!"),
        "loginToComment":
        ...
        "manCollections":
            MessageLookupByLibrary.simpleMessage("Kişi geyimləri"),
        "manageApiKey":
        ...
        "markAsRead":
            MessageLookupByLibrary.simpleMessage("Oxunmuş kimi qeyd et"),
        "markAsShipped":
            MessageLookupByLibrary.simpleMessage("Göndərilmiş kimi qeyd et"),
        "markAsUnread":
            MessageLookupByLibrary.simpleMessage("Oxunmamış kimi qeyd et"),
        ...
        "minimumQuantityIs":
            MessageLookupByLibrary.simpleMessage("Minimum miqdar"),
        "minutesAgo": m31,
        ...
        "mobileVerification":
            MessageLookupByLibrary.simpleMessage("Mobil nömrə təsdiqi"),
        ...
        "noBackHistoryItem":
            MessageLookupByLibrary.simpleMessage("Keçmiş element yoxdur"),
        ...
        "noData":
            MessageLookupByLibrary.simpleMessage("Daha çox məlumat yoxdur"),
        "noFavoritesYet":
            MessageLookupByLibrary.simpleMessage("İstək siyahınız boşdur"),
        "noFileToDownload":
            MessageLookupByLibrary.simpleMessage("Yükləmək üçün fayl yoxdur."),
        "noForwardHistoryItem":
            MessageLookupByLibrary.simpleMessage("İrəli element yoxdur"),
        "noInternetConnection":
            MessageLookupByLibrary.simpleMessage("İnternet bağlantısı yoxdur"),
        ...
        "noSlotAvailable":
            MessageLookupByLibrary.simpleMessage("Boş yer yoxdur"),
        "noStoreNearby":
            MessageLookupByLibrary.simpleMessage("Yaxınlıqda mağaza yoxdur!"),
        "noSuggestionSearch":
            MessageLookupByLibrary.simpleMessage("Heç bir təklif tapılmadı"),
        "noThanks":
            MessageLookupByLibrary.simpleMessage("Xeyr, təşəkkür edirəm"),
        ...
        "noteTransfer":
            MessageLookupByLibrary.simpleMessage("Qeyd (istəyə bağlı)"),
        ...
        "orderStatusExpired":
            MessageLookupByLibrary.simpleMessage("İstifadə müddəti bitdi"),
        "orderStatusFailed":
            MessageLookupByLibrary.simpleMessage("Uğursuz oldu"),
        ...
        "orderStatusProcessing":
            MessageLookupByLibrary.simpleMessage("Emal edilir"),
        "orderStatusRefunded":
            MessageLookupByLibrary.simpleMessage("Geri qaytarıldı"),
        "orderStatusReversed":
            MessageLookupByLibrary.simpleMessage("Ters çevrildi"),
        "orderStatusShipped":
            MessageLookupByLibrary.simpleMessage("Göndərilib"),
        "orderStatusVoided":
            MessageLookupByLibrary.simpleMessage("Ləğv edilib"),
        ...
        "orderSummary":
            MessageLookupByLibrary.simpleMessage("Sifariş Xülasəsi"),
        ...
        "pasteYourImageUrl":
            MessageLookupByLibrary.simpleMessage("Şəklin URL-ni yapışdırın"),
        "payByWallet":
        ...
        "paymentMethods":
            MessageLookupByLibrary.simpleMessage("Ödəniş üsulları"),
        "paymentSettings":
        ...
        "pendingReviews":
            MessageLookupByLibrary.simpleMessage("Gözləyən Baxışlar"),
        "persian": MessageLookupByLibrary.simpleMessage("fars"),
        "phone": MessageLookupByLibrary.simpleMessage("Telefon"),
        "phoneEmpty":
            MessageLookupByLibrary.simpleMessage("Telefon nömrəsi boşdur"),
        "phoneHintFormat":
        ...
        "pickADate":
            MessageLookupByLibrary.simpleMessage("Tarix və vaxtı seçin"),
        "picking": MessageLookupByLibrary.simpleMessage("Seçim"),
        "placeMyOrder":
            MessageLookupByLibrary.simpleMessage("Sifarişi təsdiqlə"),
        ...
        "pleaseInput":
            MessageLookupByLibrary.simpleMessage("Bütün sahələri doldurun"),
        ...
        "pointMsgRemove":
            MessageLookupByLibrary.simpleMessage("Endirim nöqtəsi silindi"),
        ...
        "postImageFeature":
            MessageLookupByLibrary.simpleMessage("Seçilmiş Şəkil"),
        "postManagement":
        ...
        "productNameCanNotEmpty":
            MessageLookupByLibrary.simpleMessage("Məhsul adı boş ola bilməz"),
        ...
        "productOverview":
            MessageLookupByLibrary.simpleMessage("Məhsula Baxış"),
        "productRating":
            MessageLookupByLibrary.simpleMessage("Məhsul reytinqi"),
        ...
        "rateTheApp":
            MessageLookupByLibrary.simpleMessage("Tətbiqi qiymətləndir"),
        "rateThisApp":
            MessageLookupByLibrary.simpleMessage("Bu tətbiqi qiymətləndirin"),
        ...
        "refundRequest":
            MessageLookupByLibrary.simpleMessage("Geri qaytarma tələbi"),
        ...
        "registerInvalid":
            MessageLookupByLibrary.simpleMessage("Qeydiyyat etibarsızdır"),
        "registerSuccess":
            MessageLookupByLibrary.simpleMessage("Qeydiyyat uğurlu oldu"),
        ...
        "resetYourPassword":
            MessageLookupByLibrary.simpleMessage("Şifrənizi sıfırlayın"),
        ...
        "saveAddress":
            MessageLookupByLibrary.simpleMessage("Ünvanı yadda saxla"),
        "saveAddressSuccess": MessageLookupByLibrary.simpleMessage(
            "Ünvan uğurla yadda saxlanıldı"),
        "saveForLater":
            MessageLookupByLibrary.simpleMessage("Sonra üçün Saxla"),
        "saveQRCode":
            MessageLookupByLibrary.simpleMessage("QR kodunu yadda saxla"),
        "saveToWishList":
            MessageLookupByLibrary.simpleMessage("İstək siyahısına əlavə et"),
        ...
        "searchForItems":
            MessageLookupByLibrary.simpleMessage("Məhsul axtar..."),
        "searchInput":
            MessageLookupByLibrary.simpleMessage("Axtarış sözünü daxil edin"),
        "searchOrderId":
        ...
        "searchingAddress":
            MessageLookupByLibrary.simpleMessage("Ünvan axtarılır"),
        "secondsAgo": m46,
        ...
        "selectThePoint":
            MessageLookupByLibrary.simpleMessage("Nöqtələri seçin"),
        "selectTheQuantity":
            MessageLookupByLibrary.simpleMessage("Miqdar seçin"),
        ...
        "sessionExpired":
            MessageLookupByLibrary.simpleMessage("Sessiyanın vaxtı bitdi"),
        ...
        "shareProductLink":
            MessageLookupByLibrary.simpleMessage("Məhsul Linkini Paylaşın"),
        ...
        "showAllMyOrdered":
            MessageLookupByLibrary.simpleMessage("Bütün sifarişlərimə bax"),
        "showDetails":
            MessageLookupByLibrary.simpleMessage("Təfərrüatları göstərin"),
        ...
        "signInWithEmail":
            MessageLookupByLibrary.simpleMessage("E-poçt ilə daxil ol"),
        ...
        "startShopping":
            MessageLookupByLibrary.simpleMessage("Alış-verişə başla"),
        "state": MessageLookupByLibrary.simpleMessage("dövlət"),
        "stateIsRequired":
            MessageLookupByLibrary.simpleMessage("Rayon/Şəhər tələb olunur"),
        ...
        "storeStaticBanner":
            MessageLookupByLibrary.simpleMessage("Statik Banner saxla"),
        ...
        "streetIsRequired":
            MessageLookupByLibrary.simpleMessage("Küçə adı tələb olunur"),
        ...
        "trackingNumberIs":
            MessageLookupByLibrary.simpleMessage("İzləmə nömrəsi"),
        ...
        "transferMoneyTo": m51,
        "transferSuccess":
            MessageLookupByLibrary.simpleMessage("Transfer uğurlu oldu"),
        ...
        "updateFailed":
            MessageLookupByLibrary.simpleMessage("Yeniləmə alınmadı!"),
        "updateInfo":
            MessageLookupByLibrary.simpleMessage("Məlumatı yeniləyin"),
        "updatePassword":
            MessageLookupByLibrary.simpleMessage("Parolu yeniləyin"),
        "updateStatus":
            MessageLookupByLibrary.simpleMessage("Statusu yeniləyin"),
        "updateSuccess":
            MessageLookupByLibrary.simpleMessage("Güncəlləmə uğurlu oldu!"),
        "updateUserInfor":
            MessageLookupByLibrary.simpleMessage("Profili yenilə"),
        ...
        "womanCollections":
            MessageLookupByLibrary.simpleMessage("Qadın geyimləri"),
        "writeComment": MessageLookupByLibrary.simpleMessage("Şərhiniz"),
        "writeYourNote":
            MessageLookupByLibrary.simpleMessage("Qeydinizi yazın"),
        "yearsAgo": m61,
        ...
        "yourAddressExistYourLocal":
            MessageLookupByLibrary.simpleMessage("Ünvanınız artıq mövcuddur"),
        ...
        "yourBookingDetail":
            MessageLookupByLibrary.simpleMessage("Rezervasiya məlumatlarınız"),
        ...
        "zipCodeIsRequired":
            MessageLookupByLibrary.simpleMessage("Poçt indeksi tələb olunur")
      };
}
